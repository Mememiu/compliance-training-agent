...
var AdjustmentFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(AdjustmentFilledIcon, _IconBase);
  var _super = _createSuper(AdjustmentFilledIcon);
  function AdjustmentFilledIcon() {
    var _this;
    _classCallCheck(this, AdjustmentFilledIcon);
  ...
  return _createClass(AdjustmentFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
AdjustmentFilledIcon = __decorateClass([Q("t-icon-adjustment-filled")], AdjustmentFilledIcon);
