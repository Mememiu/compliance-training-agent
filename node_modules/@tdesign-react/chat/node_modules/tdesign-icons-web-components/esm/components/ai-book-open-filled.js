...
var AiBookOpenFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(AiBookOpenFilledIcon, _IconBase);
  var _super = _createSuper(AiBookOpenFilledIcon);
  function AiBookOpenFilledIcon() {
    var _this;
    _classCallCheck(this, AiBookOpenFilledIcon);
    _this = _super.call(this);
    _this.props = _objectSpread(_objectSpread({}, _this.props), {}, {
      id: "ai-book-open-filled"
    });
    return _this;
  }
  return _createClass(AiBookOpenFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
AiBookOpenFilledIcon = __decorateClass([Q("t-icon-ai-book-open-filled")], AiBookOpenFilledIcon);

export default AiBookOpenFilledIcon;
