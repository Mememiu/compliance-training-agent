...
var AiEdit1FilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(AiEdit1FilledIcon, _IconBase);
  var _super = _createSuper(AiEdit1FilledIcon);
  function AiEdit1FilledIcon() {
    var _this;
    _classCallCheck(this, AiEdit1FilledIcon);
  ...
  return _createClass(AiEdit1FilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
AiEdit1FilledIcon = __decorateClass([Q("t-icon-ai-edit-1-filled")], AiEdit1FilledIcon);

export default AiEdit1FilledIcon;
