...
var AiGitBranchFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(AiGitBranchFilledIcon, _IconBase);
  var _super = _createSuper(AiGitBranchFilledIcon);
  function AiGitBranchFilledIcon() {
    var _this;
    _classCallCheck(this, AiGitBranchFilledIcon);
    _this = _super.call(this);
    _this.props = _objectSpread(_objectSpread({}, _this.props), {}, {
      id: "ai-git-branch-filled"
    });
    return _this;
  }
  return _createClass(AiGitBranchFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
AiGitBranchFilledIcon = __decorateClass([Q("t-icon-ai-git-branch-filled")], AiGitBranchFilledIcon);

export default AiGitBranchFilledIcon;
