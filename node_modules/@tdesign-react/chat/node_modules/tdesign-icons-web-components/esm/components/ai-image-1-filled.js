...
var AiImage1FilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(AiImage1FilledIcon, _IconBase);
  var _super = _createSuper(AiImage1FilledIcon);
  function AiImage1FilledIcon() {
    var _this;
    _classCallCheck(this, AiImage1FilledIcon);
    _this = _super.call(this);
    _this.props = _objectSpread(_objectSpread({}, _this.props), {}, {
      id: "ai-image-1-filled"
    });
    return _this;
  }
  return _createClass(AiImage1FilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
AiImage1FilledIcon = __decorateClass([Q("t-icon-ai-image-1-filled")], AiImage1FilledIcon);

export default AiImage1FilledIcon;
