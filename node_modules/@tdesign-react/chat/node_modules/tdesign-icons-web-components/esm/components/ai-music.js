...
var AiMusicIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(AiMusicIcon, _IconBase);
  var _super = _createSuper(AiMusicIcon);
  function AiMusicIcon() {
    var _this;
    _classCallCheck(this, AiMusicIcon);
  ...
  return _createClass(AiMusicIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
AiMusicIcon = __decorateClass([Q("t-icon-ai-music")], AiMusicIcon);

export default AiMusicIcon;
