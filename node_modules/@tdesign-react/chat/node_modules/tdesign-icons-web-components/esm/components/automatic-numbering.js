...
var AutomaticNumberingIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(AutomaticNumberingIcon, _IconBase);
  var _super = _createSuper(AutomaticNumberingIcon);
  function AutomaticNumberingIcon() {
    var _this;
    _classCallCheck(this, AutomaticNumberingIcon);
  ...
  return _createClass(AutomaticNumberingIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
AutomaticNumberingIcon = __decorateClass([Q("t-icon-automatic-numbering")], AutomaticNumberingIcon);

export default AutomaticNumberingIcon;
