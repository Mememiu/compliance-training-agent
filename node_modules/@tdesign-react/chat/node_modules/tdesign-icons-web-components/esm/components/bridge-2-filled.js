...
var Bridge2FilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Bridge2FilledIcon, _IconBase);
  var _super = _createSuper(Bridge2FilledIcon);
  function Bridge2FilledIcon() {
    var _this;
    _classCallCheck(this, Bridge2FilledIcon);
  ...
  return _createClass(Bridge2FilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Bridge2FilledIcon = __decorateClass([Q("t-icon-bridge-2-filled")], Bridge2FilledIcon);
