...
var Castle4FilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Castle4FilledIcon, _IconBase);
  var _super = _createSuper(Castle4FilledIcon);
  function Castle4FilledIcon() {
    var _this;
    _classCallCheck(this, Castle4FilledIcon);
  ...
  return _createClass(Castle4FilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Castle4FilledIcon = __decorateClass([Q("t-icon-castle-4-filled")], Castle4FilledIcon);
