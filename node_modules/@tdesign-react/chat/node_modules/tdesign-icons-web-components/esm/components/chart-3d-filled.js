...
var Chart3DFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Chart3DFilledIcon, _IconBase);
  var _super = _createSuper(Chart3DFilledIcon);
  function Chart3DFilledIcon() {
    var _this;
    _classCallCheck(this, Chart3DFilledIcon);
  ...
  return _createClass(Chart3DFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Chart3DFilledIcon = __decorateClass([Q("t-icon-chart-3d-filled")], Chart3DFilledIcon);
