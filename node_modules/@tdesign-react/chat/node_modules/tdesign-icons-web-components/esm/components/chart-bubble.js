...
var ChartBubbleIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ChartBubbleIcon, _IconBase);
  var _super = _createSuper(ChartBubbleIcon);
  function ChartBubbleIcon() {
    var _this;
    _classCallCheck(this, ChartBubbleIcon);
  ...
  return _createClass(ChartBubbleIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ChartBubbleIcon = __decorateClass([Q("t-icon-chart-bubble")], ChartBubbleIcon);
