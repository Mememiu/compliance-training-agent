...
var Dividers1Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Dividers1Icon, _IconBase);
  var _super = _createSuper(Dividers1Icon);
  function Dividers1Icon() {
    var _this;
    _classCallCheck(this, Dividers1Icon);
  ...
  return _createClass(Dividers1Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Dividers1Icon = __decorateClass([Q("t-icon-dividers-1")], Dividers1Icon);
