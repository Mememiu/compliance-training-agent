...
var EditIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(EditIcon, _IconBase);
  ...
  return _createClass(EditIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
EditIcon = __decorateClass([Q("t-icon-edit")], EditIcon);
