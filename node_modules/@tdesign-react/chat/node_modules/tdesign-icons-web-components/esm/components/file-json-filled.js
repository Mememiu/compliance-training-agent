...
var FileJsonFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FileJsonFilledIcon, _IconBase);
  var _super = _createSuper(FileJsonFilledIcon);
  function FileJsonFilledIcon() {
    var _this;
    _classCallCheck(this, FileJsonFilledIcon);
  ...
  return _createClass(FileJsonFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FileJsonFilledIcon = __decorateClass([Q("t-icon-file-json-filled")], FileJsonFilledIcon);

export default FileJsonFilledIcon;
