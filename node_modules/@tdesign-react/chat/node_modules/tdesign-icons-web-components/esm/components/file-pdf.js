...
var FilePdfIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FilePdfIcon, _IconBase);
  var _super = _createSuper(FilePdfIcon);
  function FilePdfIcon() {
    var _this;
    _classCallCheck(this, FilePdfIcon);
  ...
  return _createClass(FilePdfIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FilePdfIcon = __decorateClass([Q("t-icon-file-pdf")], FilePdfIcon);
