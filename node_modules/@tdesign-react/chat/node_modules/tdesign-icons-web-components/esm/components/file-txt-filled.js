...
var FileTxtFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FileTxtFilledIcon, _IconBase);
  var _super = _createSuper(FileTxtFilledIcon);
  function FileTxtFilledIcon() {
    var _this;
    _classCallCheck(this, FileTxtFilledIcon);
  ...
  return _createClass(FileTxtFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FileTxtFilledIcon = __decorateClass([Q("t-icon-file-txt-filled")], FileTxtFilledIcon);

export default FileTxtFilledIcon;
