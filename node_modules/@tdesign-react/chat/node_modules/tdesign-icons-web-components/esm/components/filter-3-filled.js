...
var Filter3FilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Filter3FilledIcon, _IconBase);
  var _super = _createSuper(Filter3FilledIcon);
  function Filter3FilledIcon() {
    var _this;
    _classCallCheck(this, Filter3FilledIcon);
  ...
  return _createClass(Filter3FilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Filter3FilledIcon = __decorateClass([Q("t-icon-filter-3-filled")], Filter3FilledIcon);
