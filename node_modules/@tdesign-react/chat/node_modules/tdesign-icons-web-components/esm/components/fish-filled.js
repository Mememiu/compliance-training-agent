...
var FishFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FishFilledIcon, _IconBase);
  var _super = _createSuper(FishFilledIcon);
  function FishFilledIcon() {
    var _this;
    _classCallCheck(this, FishFilledIcon);
  ...
  return _createClass(FishFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FishFilledIcon = __decorateClass([Q("t-icon-fish-filled")], FishFilledIcon);
