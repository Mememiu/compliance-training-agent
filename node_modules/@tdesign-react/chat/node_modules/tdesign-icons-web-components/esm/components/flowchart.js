...
var FlowchartIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FlowchartIcon, _IconBase);
  var _super = _createSuper(FlowchartIcon);
  function FlowchartIcon() {
    var _this;
    _classCallCheck(this, FlowchartIcon);
  ...
  return _createClass(FlowchartIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FlowchartIcon = __decorateClass([Q("t-icon-flowchart")], FlowchartIcon);
