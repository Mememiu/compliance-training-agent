...
var ForumFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ForumFilledIcon, _IconBase);
  var _super = _createSuper(ForumFilledIcon);
  function ForumFilledIcon() {
    var _this;
    _classCallCheck(this, ForumFilledIcon);
  ...
  return _createClass(ForumFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ForumFilledIcon = __decorateClass([Q("t-icon-forum-filled")], ForumFilledIcon);

export default ForumFilledIcon;
