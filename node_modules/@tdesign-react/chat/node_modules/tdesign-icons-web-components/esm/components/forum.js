...
var ForumIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ForumIcon, _IconBase);
  var _super = _createSuper(ForumIcon);
  function ForumIcon() {
    var _this;
    _classCallCheck(this, ForumIcon);
  ...
  return _createClass(ForumIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ForumIcon = __decorateClass([Q("t-icon-forum")], ForumIcon);
