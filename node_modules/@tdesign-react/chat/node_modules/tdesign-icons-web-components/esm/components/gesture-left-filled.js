...
var GestureLeftFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GestureLeftFilledIcon, _IconBase);
  var _super = _createSuper(GestureLeftFilledIcon);
  function GestureLeftFilledIcon() {
    var _this;
    _classCallCheck(this, GestureLeftFilledIcon);
  ...
  return _createClass(GestureLeftFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GestureLeftFilledIcon = __decorateClass([Q("t-icon-gesture-left-filled")], GestureLeftFilledIcon);
