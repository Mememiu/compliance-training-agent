...
var GesturePressFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GesturePressFilledIcon, _IconBase);
  var _super = _createSuper(GesturePressFilledIcon);
  function GesturePressFilledIcon() {
    var _this;
    _classCallCheck(this, GesturePressFilledIcon);
  ...
  return _createClass(GesturePressFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GesturePressFilledIcon = __decorateClass([Q("t-icon-gesture-press-filled")], GesturePressFilledIcon);

export default GesturePressFilledIcon;
