...
var GestureSlideLeftAndRightFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GestureSlideLeftAndRightFilledIcon, _IconBase);
  var _super = _createSuper(GestureSlideLeftAndRightFilledIcon);
  function GestureSlideLeftAndRightFilledIcon() {
    var _this;
    _classCallCheck(this, GestureSlideLeftAndRightFilledIcon);
  ...
  return _createClass(GestureSlideLeftAndRightFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GestureSlideLeftAndRightFilledIcon = __decorateClass([Q("t-icon-gesture-slide-left-and-right-filled")], GestureSlideLeftAndRightFilledIcon);
