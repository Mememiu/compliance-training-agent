...
var HighLevelFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(HighLevelFilledIcon, _IconBase);
  var _super = _createSuper(HighLevelFilledIcon);
  function HighLevelFilledIcon() {
    var _this;
    _classCallCheck(this, HighLevelFilledIcon);
    _this = _super.call(this);
    _this.props = _objectSpread(_objectSpread({}, _this.props), {}, {
      id: "high-level-filled"
    });
    return _this;
  }
  return _createClass(HighLevelFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
HighLevelFilledIcon = __decorateClass([Q("t-icon-high-level-filled")], HighLevelFilledIcon);

export default HighLevelFilledIcon;
