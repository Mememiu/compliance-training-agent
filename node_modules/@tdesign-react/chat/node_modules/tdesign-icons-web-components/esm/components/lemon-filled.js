...
var LemonFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LemonFilledIcon, _IconBase);
  var _super = _createSuper(LemonFilledIcon);
  function LemonFilledIcon() {
    var _this;
    _classCallCheck(this, LemonFilledIcon);
  ...
  return _createClass(LemonFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LemonFilledIcon = __decorateClass([Q("t-icon-lemon-filled")], LemonFilledIcon);
