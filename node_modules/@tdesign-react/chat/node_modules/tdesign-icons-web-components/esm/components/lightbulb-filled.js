...
var LightbulbFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LightbulbFilledIcon, _IconBase);
  var _super = _createSuper(LightbulbFilledIcon);
  function LightbulbFilledIcon() {
    var _this;
    _classCallCheck(this, LightbulbFilledIcon);
  ...
  return _createClass(LightbulbFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LightbulbFilledIcon = __decorateClass([Q("t-icon-lightbulb-filled")], LightbulbFilledIcon);
