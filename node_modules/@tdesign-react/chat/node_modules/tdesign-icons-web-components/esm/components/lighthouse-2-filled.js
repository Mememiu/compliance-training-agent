...
var Lighthouse2FilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Lighthouse2FilledIcon, _IconBase);
  var _super = _createSuper(Lighthouse2FilledIcon);
  function Lighthouse2FilledIcon() {
    var _this;
    _classCallCheck(this, Lighthouse2FilledIcon);
  ...
  return _createClass(Lighthouse2FilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Lighthouse2FilledIcon = __decorateClass([Q("t-icon-lighthouse-2-filled")], Lighthouse2FilledIcon);
