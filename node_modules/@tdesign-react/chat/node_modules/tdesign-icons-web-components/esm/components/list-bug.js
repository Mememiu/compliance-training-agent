...
var ListBugIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ListBugIcon, _IconBase);
  var _super = _createSuper(ListBugIcon);
  function ListBugIcon() {
    var _this;
    _classCallCheck(this, ListBugIcon);
  ...
  return _createClass(ListBugIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ListBugIcon = __decorateClass([Q("t-icon-list-bug")], ListBugIcon);

export default ListBugIcon;
