...
var LogoChromeFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LogoChromeFilledIcon, _IconBase);
  var _super = _createSuper(LogoChromeFilledIcon);
  function LogoChromeFilledIcon() {
    var _this;
    _classCallCheck(this, LogoChromeFilledIcon);
  ...
  return _createClass(LogoChromeFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LogoChromeFilledIcon = __decorateClass([Q("t-icon-logo-chrome-filled")], LogoChromeFilledIcon);
