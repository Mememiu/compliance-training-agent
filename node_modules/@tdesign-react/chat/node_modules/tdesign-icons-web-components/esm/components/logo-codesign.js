...
var LogoCodesignIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LogoCodesignIcon, _IconBase);
  var _super = _createSuper(LogoCodesignIcon);
  function LogoCodesignIcon() {
    var _this;
    _classCallCheck(this, LogoCodesignIcon);
  ...
  return _createClass(LogoCodesignIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LogoCodesignIcon = __decorateClass([Q("t-icon-logo-codesign")], LogoCodesignIcon);

export default LogoCodesignIcon;
