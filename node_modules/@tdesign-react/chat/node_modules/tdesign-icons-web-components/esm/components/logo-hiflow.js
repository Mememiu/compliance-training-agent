...
var LogoHiflowIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LogoHiflowIcon, _IconBase);
  var _super = _createSuper(LogoHiflowIcon);
  function LogoHiflowIcon() {
    var _this;
    _classCallCheck(this, LogoHiflowIcon);
  ...
  return _createClass(LogoHiflowIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LogoHiflowIcon = __decorateClass([Q("t-icon-logo-hiflow")], LogoHiflowIcon);

export default LogoHiflowIcon;
