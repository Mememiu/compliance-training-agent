...
var LogoInstagramFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LogoInstagramFilledIcon, _IconBase);
  var _super = _createSuper(LogoInstagramFilledIcon);
  function LogoInstagramFilledIcon() {
    var _this;
    _classCallCheck(this, LogoInstagramFilledIcon);
  ...
  return _createClass(LogoInstagramFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LogoInstagramFilledIcon = __decorateClass([Q("t-icon-logo-instagram-filled")], LogoInstagramFilledIcon);
