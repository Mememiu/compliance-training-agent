...
var LogoTbeaconFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LogoTbeaconFilledIcon, _IconBase);
  var _super = _createSuper(LogoTbeaconFilledIcon);
  function LogoTbeaconFilledIcon() {
    var _this;
    _classCallCheck(this, LogoTbeaconFilledIcon);
    _this = _super.call(this);
    _this.props = _objectSpread(_objectSpread({}, _this.props), {}, {
      id: "logo-tbeacon-filled"
    });
    return _this;
  }
  return _createClass(LogoTbeaconFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LogoTbeaconFilledIcon = __decorateClass([Q("t-icon-logo-tbeacon-filled")], LogoTbeaconFilledIcon);

export default LogoTbeaconFilledIcon;
