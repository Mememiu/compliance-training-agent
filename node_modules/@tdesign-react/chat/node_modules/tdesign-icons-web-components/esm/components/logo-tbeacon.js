...
var LogoTbeaconIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LogoTbeaconIcon, _IconBase);
  var _super = _createSuper(LogoTbeaconIcon);
  function LogoTbeaconIcon() {
    var _this;
    _classCallCheck(this, LogoTbeaconIcon);
  ...
  return _createClass(LogoTbeaconIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LogoTbeaconIcon = __decorateClass([Q("t-icon-logo-tbeacon")], LogoTbeaconIcon);

export default LogoTbeaconIcon;
