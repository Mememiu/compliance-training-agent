...
var LogoWechatpayFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LogoWechatpayFilledIcon, _IconBase);
  var _super = _createSuper(LogoWechatpayFilledIcon);
  function LogoWechatpayFilledIcon() {
    var _this;
    _classCallCheck(this, LogoWechatpayFilledIcon);
  ...
  return _createClass(LogoWechatpayFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LogoWechatpayFilledIcon = __decorateClass([Q("t-icon-logo-wechatpay-filled")], LogoWechatpayFilledIcon);
