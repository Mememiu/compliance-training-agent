...
var MapUnlockedFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MapUnlockedFilledIcon, _IconBase);
  var _super = _createSuper(MapUnlockedFilledIcon);
  function MapUnlockedFilledIcon() {
    var _this;
    _classCallCheck(this, MapUnlockedFilledIcon);
  ...
  return _createClass(MapUnlockedFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MapUnlockedFilledIcon = __decorateClass([Q("t-icon-map-unlocked-filled")], MapUnlockedFilledIcon);
