...
var MarkupIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MarkupIcon, _IconBase);
  var _super = _createSuper(MarkupIcon);
  function MarkupIcon() {
    var _this;
    _classCallCheck(this, MarkupIcon);
  ...
  return _createClass(MarkupIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MarkupIcon = __decorateClass([Q("t-icon-markup")], MarkupIcon);
