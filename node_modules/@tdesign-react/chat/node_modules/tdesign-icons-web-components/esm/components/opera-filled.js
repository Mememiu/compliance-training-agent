...
var OperaFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(OperaFilledIcon, _IconBase);
  var _super = _createSuper(OperaFilledIcon);
  function OperaFilledIcon() {
    var _this;
    _classCallCheck(this, OperaFilledIcon);
  ...
  return _createClass(OperaFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
OperaFilledIcon = __decorateClass([Q("t-icon-opera-filled")], OperaFilledIcon);
