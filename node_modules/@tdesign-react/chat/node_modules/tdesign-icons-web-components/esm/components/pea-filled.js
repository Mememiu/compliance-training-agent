...
var PeaFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(PeaFilledIcon, _IconBase);
  var _super = _createSuper(PeaFilledIcon);
  function PeaFilledIcon() {
    var _this;
    _classCallCheck(this, PeaFilledIcon);
  ...
  return _createClass(PeaFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
PeaFilledIcon = __decorateClass([Q("t-icon-pea-filled")], PeaFilledIcon);
