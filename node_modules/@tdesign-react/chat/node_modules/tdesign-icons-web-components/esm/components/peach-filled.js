...
var PeachFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(PeachFilledIcon, _IconBase);
  var _super = _createSuper(PeachFilledIcon);
  function PeachFilledIcon() {
    var _this;
    _classCallCheck(this, PeachFilledIcon);
  ...
  return _createClass(PeachFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
PeachFilledIcon = __decorateClass([Q("t-icon-peach-filled")], PeachFilledIcon);
