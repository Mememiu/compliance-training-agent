...
var RainHeavyIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(RainHeavyIcon, _IconBase);
  var _super = _createSuper(RainHeavyIcon);
  function RainHeavyIcon() {
    var _this;
    _classCallCheck(this, RainHeavyIcon);
  ...
  return _createClass(RainHeavyIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
RainHeavyIcon = __decorateClass([Q("t-icon-rain-heavy")], RainHeavyIcon);
