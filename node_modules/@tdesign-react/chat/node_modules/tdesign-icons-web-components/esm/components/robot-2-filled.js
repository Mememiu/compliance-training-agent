...
var Robot2FilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Robot2FilledIcon, _IconBase);
  var _super = _createSuper(Robot2FilledIcon);
  function Robot2FilledIcon() {
    var _this;
    _classCallCheck(this, Robot2FilledIcon);
  ...
  return _createClass(Robot2FilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Robot2FilledIcon = __decorateClass([Q("t-icon-robot-2-filled")], Robot2FilledIcon);

export default Robot2FilledIcon;
