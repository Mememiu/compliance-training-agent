...
var Robot2Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Robot2Icon, _IconBase);
  var _super = _createSuper(Robot2Icon);
  function Robot2Icon() {
    var _this;
    _classCallCheck(this, Robot2Icon);
  ...
  return _createClass(Robot2Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Robot2Icon = __decorateClass([Q("t-icon-robot-2")], Robot2Icon);
