...
var RocketFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(RocketFilledIcon, _IconBase);
  var _super = _createSuper(RocketFilledIcon);
  function RocketFilledIcon() {
    var _this;
    _classCallCheck(this, RocketFilledIcon);
  ...
  return _createClass(RocketFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
RocketFilledIcon = __decorateClass([Q("t-icon-rocket-filled")], RocketFilledIcon);
