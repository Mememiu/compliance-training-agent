...
var SausageIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SausageIcon, _IconBase);
  var _super = _createSuper(SausageIcon);
  function SausageIcon() {
    var _this;
    _classCallCheck(this, SausageIcon);
  ...
  return _createClass(SausageIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SausageIcon = __decorateClass([Q("t-icon-sausage")], SausageIcon);
