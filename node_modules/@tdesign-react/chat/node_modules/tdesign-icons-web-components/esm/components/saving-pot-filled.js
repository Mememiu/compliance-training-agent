...
var SavingPotFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SavingPotFilledIcon, _IconBase);
  var _super = _createSuper(SavingPotFilledIcon);
  function SavingPotFilledIcon() {
    var _this;
    _classCallCheck(this, SavingPotFilledIcon);
  ...
  return _createClass(SavingPotFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SavingPotFilledIcon = __decorateClass([Q("t-icon-saving-pot-filled")], SavingPotFilledIcon);
