...
var ServiceIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ServiceIcon, _IconBase);
  var _super = _createSuper(ServiceIcon);
  function ServiceIcon() {
    var _this;
    _classCallCheck(this, ServiceIcon);
  ...
  return _createClass(ServiceIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ServiceIcon = __decorateClass([Q("t-icon-service")], ServiceIcon);
