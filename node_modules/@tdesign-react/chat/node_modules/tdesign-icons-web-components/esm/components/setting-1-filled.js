...
var Setting1FilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Setting1FilledIcon, _IconBase);
  var _super = _createSuper(Setting1FilledIcon);
  function Setting1FilledIcon() {
    var _this;
    _classCallCheck(this, Setting1FilledIcon);
  ...
  return _createClass(Setting1FilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Setting1FilledIcon = __decorateClass([Q("t-icon-setting-1-filled")], Setting1FilledIcon);
