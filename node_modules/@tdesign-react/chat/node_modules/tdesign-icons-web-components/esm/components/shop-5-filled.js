...
var Shop5FilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Shop5FilledIcon, _IconBase);
  var _super = _createSuper(Shop5FilledIcon);
  function Shop5FilledIcon() {
    var _this;
    _classCallCheck(this, Shop5FilledIcon);
  ...
  return _createClass(Shop5FilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Shop5FilledIcon = __decorateClass([Q("t-icon-shop-5-filled")], Shop5FilledIcon);
