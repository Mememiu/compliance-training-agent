...
var SupportFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SupportFilledIcon, _IconBase);
  var _super = _createSuper(SupportFilledIcon);
  function SupportFilledIcon() {
    var _this;
    _classCallCheck(this, SupportFilledIcon);
  ...
  return _createClass(SupportFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SupportFilledIcon = __decorateClass([Q("t-icon-support-filled")], SupportFilledIcon);
