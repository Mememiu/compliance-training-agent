...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(AbilityOpenIcon, _IconBase);
  var _super = _createSuper(AbilityOpenIcon);
  function AbilityOpenIcon() {
    var _this;
    omi_module._classCallCheck(this, AbilityOpenIcon);
  ...
  return omi_module._createClass(AbilityOpenIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-ability-open")], exports['default']);
