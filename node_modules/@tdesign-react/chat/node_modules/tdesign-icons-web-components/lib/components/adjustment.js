...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(AdjustmentIcon, _IconBase);
  var _super = _createSuper(AdjustmentIcon);
  function AdjustmentIcon() {
    var _this;
    omi_module._classCallCheck(this, AdjustmentIcon);
  ...
  return omi_module._createClass(AdjustmentIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-adjustment")], exports['default']);
