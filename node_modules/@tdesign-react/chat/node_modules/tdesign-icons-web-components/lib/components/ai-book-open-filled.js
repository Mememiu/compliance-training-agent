...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(AiBookOpenFilledIcon, _IconBase);
  var _super = _createSuper(AiBookOpenFilledIcon);
  function AiBookOpenFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, AiBookOpenFilledIcon);
  ...
  return omi_module._createClass(AiBookOpenFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-ai-book-open-filled")], exports['default']);
