...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(AiImage1FilledIcon, _IconBase);
  var _super = _createSuper(AiImage1FilledIcon);
  function AiImage1FilledIcon() {
    var _this;
    omi_module._classCallCheck(this, AiImage1FilledIcon);
  ...
  return omi_module._createClass(AiImage1FilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-ai-image-1-filled")], exports['default']);
