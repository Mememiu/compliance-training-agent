...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(AiScreenshotIcon, _IconBase);
  var _super = _createSuper(AiScreenshotIcon);
  function AiScreenshotIcon() {
    var _this;
    omi_module._classCallCheck(this, AiScreenshotIcon);
  ...
  return omi_module._createClass(AiScreenshotIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-ai-screenshot")], exports['default']);
