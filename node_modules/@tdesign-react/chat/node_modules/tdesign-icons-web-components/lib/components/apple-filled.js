...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(AppleFilledIcon, _IconBase);
  var _super = _createSuper(AppleFilledIcon);
  function AppleFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, AppleFilledIcon);
  ...
  return omi_module._createClass(AppleFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-apple-filled")], exports['default']);
