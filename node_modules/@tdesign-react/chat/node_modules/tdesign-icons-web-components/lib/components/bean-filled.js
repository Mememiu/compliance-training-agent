...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(BeanFilledIcon, _IconBase);
  var _super = _createSuper(BeanFilledIcon);
  function BeanFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, BeanFilledIcon);
  ...
  return omi_module._createClass(BeanFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-bean-filled")], exports['default']);
