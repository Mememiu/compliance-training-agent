...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(BeerFilledIcon, _IconBase);
  var _super = _createSuper(BeerFilledIcon);
  function BeerFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, BeerFilledIcon);
  ...
  return omi_module._createClass(BeerFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-beer-filled")], exports['default']);
