...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Call1FilledIcon, _IconBase);
  var _super = _createSuper(Call1FilledIcon);
  function Call1FilledIcon() {
    var _this;
    omi_module._classCallCheck(this, Call1FilledIcon);
  ...
  return omi_module._createClass(Call1FilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-call-1-filled")], exports['default']);
