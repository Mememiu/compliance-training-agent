...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(CandyIcon, _IconBase);
  var _super = _createSuper(CandyIcon);
  function CandyIcon() {
    var _this;
    omi_module._classCallCheck(this, CandyIcon);
  ...
  return omi_module._createClass(CandyIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-candy")], exports['default']);
