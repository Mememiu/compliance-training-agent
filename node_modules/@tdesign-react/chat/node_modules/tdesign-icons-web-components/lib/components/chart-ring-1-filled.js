...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ChartRing1FilledIcon, _IconBase);
  var _super = _createSuper(ChartRing1FilledIcon);
  function ChartRing1FilledIcon() {
    var _this;
    omi_module._classCallCheck(this, ChartRing1FilledIcon);
  ...
  return omi_module._createClass(ChartRing1FilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-chart-ring-1-filled")], exports['default']);
