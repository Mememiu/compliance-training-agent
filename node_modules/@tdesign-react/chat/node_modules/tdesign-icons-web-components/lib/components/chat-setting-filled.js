...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ChatSettingFilledIcon, _IconBase);
  var _super = _createSuper(ChatSettingFilledIcon);
  function ChatSettingFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, ChatSettingFilledIcon);
  ...
  return omi_module._createClass(ChatSettingFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-chat-setting-filled")], exports['default']);
