...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(CloudyDayFilledIcon, _IconBase);
  var _super = _createSuper(CloudyDayFilledIcon);
  function CloudyDayFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, CloudyDayFilledIcon);
  ...
  return omi_module._createClass(CloudyDayFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-cloudy-day-filled")], exports['default']);
