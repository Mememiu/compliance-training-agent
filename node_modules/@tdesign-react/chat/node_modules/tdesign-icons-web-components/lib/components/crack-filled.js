...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(CrackFilledIcon, _IconBase);
  var _super = _createSuper(CrackFilledIcon);
  function CrackFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, CrackFilledIcon);
  ...
  return omi_module._createClass(CrackFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-crack-filled")], exports['default']);
