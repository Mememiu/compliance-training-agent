...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(DataBaseFilledIcon, _IconBase);
  var _super = _createSuper(DataBaseFilledIcon);
  function DataBaseFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, DataBaseFilledIcon);
  ...
  return omi_module._createClass(DataBaseFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-data-base-filled")], exports['default']);
