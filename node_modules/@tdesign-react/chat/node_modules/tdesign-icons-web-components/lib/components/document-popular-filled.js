...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(DocumentPopularFilledIcon, _IconBase);
  var _super = _createSuper(DocumentPopularFilledIcon);
  function DocumentPopularFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, DocumentPopularFilledIcon);
    _this = _super.call(this);
    _this.props = _objectSpread(_objectSpread({}, _this.props), {}, {
      id: "document-popular-filled"
    });
    return _this;
  }
  return omi_module._createClass(DocumentPopularFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-document-popular-filled")], exports['default']);
