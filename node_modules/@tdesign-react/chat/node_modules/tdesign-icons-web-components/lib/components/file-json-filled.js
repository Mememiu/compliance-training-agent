...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(FileJsonFilledIcon, _IconBase);
  var _super = _createSuper(FileJsonFilledIcon);
  function FileJsonFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, FileJsonFilledIcon);
  ...
  return omi_module._createClass(FileJsonFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-file-json-filled")], exports['default']);
