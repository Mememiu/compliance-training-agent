...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(FileTxtFilledIcon, _IconBase);
  var _super = _createSuper(FileTxtFilledIcon);
  function FileTxtFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, FileTxtFilledIcon);
  ...
  return omi_module._createClass(FileTxtFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-file-txt-filled")], exports['default']);
