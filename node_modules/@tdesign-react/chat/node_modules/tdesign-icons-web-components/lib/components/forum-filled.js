...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ForumFilledIcon, _IconBase);
  var _super = _createSuper(ForumFilledIcon);
  function ForumFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, ForumFilledIcon);
  ...
  return omi_module._createClass(ForumFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-forum-filled")], exports['default']);
