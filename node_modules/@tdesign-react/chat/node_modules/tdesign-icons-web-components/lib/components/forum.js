...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ForumIcon, _IconBase);
  var _super = _createSuper(ForumIcon);
  function ForumIcon() {
    var _this;
    omi_module._classCallCheck(this, ForumIcon);
  ...
  return omi_module._createClass(ForumIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-forum")], exports['default']);
