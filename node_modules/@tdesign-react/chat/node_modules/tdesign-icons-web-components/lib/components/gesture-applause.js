...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(GestureApplauseIcon, _IconBase);
  var _super = _createSuper(GestureApplauseIcon);
  function GestureApplauseIcon() {
    var _this;
    omi_module._classCallCheck(this, GestureApplauseIcon);
  ...
  return omi_module._createClass(GestureApplauseIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-gesture-applause")], exports['default']);
