...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(GestureTypingFilledIcon, _IconBase);
  var _super = _createSuper(GestureTypingFilledIcon);
  function GestureTypingFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, GestureTypingFilledIcon);
  ...
  return omi_module._createClass(GestureTypingFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-gesture-typing-filled")], exports['default']);
