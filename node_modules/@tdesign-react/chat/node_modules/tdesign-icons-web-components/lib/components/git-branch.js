...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(GitBranchIcon, _IconBase);
  var _super = _createSuper(GitBranchIcon);
  function GitBranchIcon() {
    var _this;
    omi_module._classCallCheck(this, GitBranchIcon);
  ...
  return omi_module._createClass(GitBranchIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-git-branch")], exports['default']);
