...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(GitMergeIcon, _IconBase);
  var _super = _createSuper(GitMergeIcon);
  function GitMergeIcon() {
    var _this;
    omi_module._classCallCheck(this, GitMergeIcon);
  ...
  return omi_module._createClass(GitMergeIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-git-merge")], exports['default']);
