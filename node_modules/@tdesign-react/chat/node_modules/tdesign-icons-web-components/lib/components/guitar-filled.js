...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(GuitarFilledIcon, _IconBase);
  var _super = _createSuper(GuitarFilledIcon);
  function GuitarFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, GuitarFilledIcon);
  ...
  return omi_module._createClass(GuitarFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-guitar-filled")], exports['default']);
