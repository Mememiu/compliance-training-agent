...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ImageSearchIcon, _IconBase);
  var _super = _createSuper(ImageSearchIcon);
  function ImageSearchIcon() {
    var _this;
    omi_module._classCallCheck(this, ImageSearchIcon);
  ...
  return omi_module._createClass(ImageSearchIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-image-search")], exports['default']);
