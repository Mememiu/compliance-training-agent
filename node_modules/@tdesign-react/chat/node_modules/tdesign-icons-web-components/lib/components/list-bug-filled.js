...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ListBugFilledIcon, _IconBase);
  var _super = _createSuper(ListBugFilledIcon);
  function ListBugFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, ListBugFilledIcon);
  ...
  return omi_module._createClass(ListBugFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-list-bug-filled")], exports['default']);
