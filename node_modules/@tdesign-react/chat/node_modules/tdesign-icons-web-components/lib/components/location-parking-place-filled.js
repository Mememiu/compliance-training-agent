...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(LocationParkingPlaceFilledIcon, _IconBase);
  var _super = _createSuper(LocationParkingPlaceFilledIcon);
  function LocationParkingPlaceFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, LocationParkingPlaceFilledIcon);
  ...
  return omi_module._createClass(LocationParkingPlaceFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-location-parking-place-filled")], exports['default']);
