...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(LogoGithubFilledIcon, _IconBase);
  var _super = _createSuper(LogoGithubFilledIcon);
  function LogoGithubFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, LogoGithubFilledIcon);
  ...
  return omi_module._createClass(LogoGithubFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-logo-github-filled")], exports['default']);
