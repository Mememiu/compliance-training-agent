...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(LogoHiflowIcon, _IconBase);
  var _super = _createSuper(LogoHiflowIcon);
  function LogoHiflowIcon() {
    var _this;
    omi_module._classCallCheck(this, LogoHiflowIcon);
  ...
  return omi_module._createClass(LogoHiflowIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-logo-hiflow")], exports['default']);
