...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(LogoTbeaconIcon, _IconBase);
  var _super = _createSuper(LogoTbeaconIcon);
  function LogoTbeaconIcon() {
    var _this;
    omi_module._classCallCheck(this, LogoTbeaconIcon);
  ...
  return omi_module._createClass(LogoTbeaconIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-logo-tbeacon")], exports['default']);
