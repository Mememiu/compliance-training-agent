...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Map3DFilledIcon, _IconBase);
  var _super = _createSuper(Map3DFilledIcon);
  function Map3DFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, Map3DFilledIcon);
  ...
  return omi_module._createClass(Map3DFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-map-3d-filled")], exports['default']);
