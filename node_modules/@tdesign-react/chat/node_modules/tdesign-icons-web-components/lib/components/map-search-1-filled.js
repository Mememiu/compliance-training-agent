...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(MapSearch1FilledIcon, _IconBase);
  var _super = _createSuper(MapSearch1FilledIcon);
  function MapSearch1FilledIcon() {
    var _this;
    omi_module._classCallCheck(this, MapSearch1FilledIcon);
  ...
  return omi_module._createClass(MapSearch1FilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-map-search-1-filled")], exports['default']);
