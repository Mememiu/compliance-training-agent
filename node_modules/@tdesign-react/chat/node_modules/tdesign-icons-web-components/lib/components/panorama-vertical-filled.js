...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(PanoramaVerticalFilledIcon, _IconBase);
  var _super = _createSuper(PanoramaVerticalFilledIcon);
  function PanoramaVerticalFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, PanoramaVerticalFilledIcon);
  ...
  return omi_module._createClass(PanoramaVerticalFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-panorama-vertical-filled")], exports['default']);
