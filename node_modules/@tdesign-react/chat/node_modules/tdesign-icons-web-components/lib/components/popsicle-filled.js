...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(PopsicleFilledIcon, _IconBase);
  var _super = _createSuper(PopsicleFilledIcon);
  function PopsicleFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, PopsicleFilledIcon);
  ...
  return omi_module._createClass(PopsicleFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-popsicle-filled")], exports['default']);
