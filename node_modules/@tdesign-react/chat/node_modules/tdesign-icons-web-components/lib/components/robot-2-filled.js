...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Robot2FilledIcon, _IconBase);
  var _super = _createSuper(Robot2FilledIcon);
  function Robot2FilledIcon() {
    var _this;
    omi_module._classCallCheck(this, Robot2FilledIcon);
  ...
  return omi_module._createClass(Robot2FilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-robot-2-filled")], exports['default']);
