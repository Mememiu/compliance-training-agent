...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(SoundHighFilledIcon, _IconBase);
  var _super = _createSuper(SoundHighFilledIcon);
  function SoundHighFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, SoundHighFilledIcon);
  ...
  return omi_module._createClass(SoundHighFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-sound-high-filled")], exports['default']);
