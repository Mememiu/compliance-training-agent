...
var _commonjsHelpers = require('../_chunks/dep-33071bd3.js');
...
var getScrollContainer = function getScrollContainer() {
  ...
  if (lodashEs.isString(container)) {
...
var getAttach = function getAttach(node) {
  ...
  if (lodashEs.isString(attachNode)) {
...
exports.setExportparts = setExportparts;
