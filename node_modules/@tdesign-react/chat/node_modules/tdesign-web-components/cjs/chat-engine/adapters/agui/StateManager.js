...
var StateManagerImpl = /*#__PURE__*/function () {
  function StateManagerImpl() {
    createClass._classCallCheck(this, StateManagerImpl);
    defineProperty._defineProperty(this, "states", {});
    defineProperty._defineProperty(this, "currentStateKey", null);
    // 最新状态订阅者（覆盖模式）
    defineProperty._defineProperty(this, "latestSubscribers", /* @__PURE__ */new Set());
    // 绑定状态订阅者（隔离模式）
    defineProperty._defineProperty(this, "boundSubscribers", /* @__PURE__ */new Map());
  }
  return createClass._createClass(StateManagerImpl, [{
    ...
    key: "subscribe",
    value: function subscribe(callback, targetStateKey) {
      if (targetStateKey) {
        return this.subscribeToState(targetStateKey, function (state) {
          return callback(state, targetStateKey);
        });
      }
    ...
    value: function handleStateEvent(event) {
      ...
      if (event.type === "STATE_SNAPSHOT") {
        if (event.snapshot && _typeof._typeof(event.snapshot) === "object") {
        ...
        if (event.delta && Array.isArray(event.delta)) {
          ...
          if (firstDelta && firstDelta.path) {
            ...
            if (pathParts.length > 1) {
              ...
              if (currentState) {
                try {
                  var originalStructure = defineProperty._defineProperty({}, stateKey, currentState);
                  var updatedStructure = chatEngine_utils_index.applyJsonPatch(originalStructure, event.delta);
    ...
    value: function notifySubscribers(stateKey, state) {
