...
import { a as _iterableToArray, _ as _toConsumableArray } from '../../_chunks/dep-44edcc03.js';
import { _ as _arrayWithHoles, a as _nonIterableRest } from '../../_chunks/dep-ce8710fe.js';
import { a as _unsupportedIterableToArray$1 } from '../../_chunks/dep-538a5b49.js';
...
function removeByPath(obj, path) {
  ...
  if (tail.length === 0) {
    ...
    current[head];
      var rest = _objectWithoutProperties(current, [head].map(_toPropertyKey));
    return rest;
  }
  var child = current[head];
