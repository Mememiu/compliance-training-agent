...
import { css as css$5, globalCSS } from 'omi';
...
if (!document.getElementById(tdesignGlobalStyleId)) {
  ...
  style.innerHTML = `${css$2}${css$3}`;
  document.head.appendChild(style);
}

const styleSheet = css$5`
  ${css$4}
  ${css}
  ${css$1}
`;
