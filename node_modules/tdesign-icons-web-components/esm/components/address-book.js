...
var AddressBookIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(AddressBookIcon, _IconBase);
  var _super = _createSuper(AddressBookIcon);
  function AddressBookIcon() {
    var _this;
    _classCallCheck(this, AddressBookIcon);
  ...
  return _createClass(AddressBookIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
AddressBookIcon = __decorateClass([Q("t-icon-address-book")], AddressBookIcon);
