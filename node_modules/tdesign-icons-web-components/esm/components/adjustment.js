...
var AdjustmentIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(AdjustmentIcon, _IconBase);
  var _super = _createSuper(AdjustmentIcon);
  function AdjustmentIcon() {
    var _this;
    _classCallCheck(this, AdjustmentIcon);
  ...
  return _createClass(AdjustmentIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
AdjustmentIcon = __decorateClass([Q("t-icon-adjustment")], AdjustmentIcon);
