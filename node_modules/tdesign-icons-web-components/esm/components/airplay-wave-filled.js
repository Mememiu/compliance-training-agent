...
var AirplayWaveFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(AirplayWaveFilledIcon, _IconBase);
  var _super = _createSuper(AirplayWaveFilledIcon);
  function AirplayWaveFilledIcon() {
    var _this;
    _classCallCheck(this, AirplayWaveFilledIcon);
  ...
  return _createClass(AirplayWaveFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
AirplayWaveFilledIcon = __decorateClass([Q("t-icon-airplay-wave-filled")], AirplayWaveFilledIcon);
