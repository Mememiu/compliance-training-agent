...
var AirplayWaveIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(AirplayWaveIcon, _IconBase);
  var _super = _createSuper(AirplayWaveIcon);
  function AirplayWaveIcon() {
    var _this;
    _classCallCheck(this, AirplayWaveIcon);
  ...
  return _createClass(AirplayWaveIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
AirplayWaveIcon = __decorateClass([Q("t-icon-airplay-wave")], AirplayWaveIcon);
