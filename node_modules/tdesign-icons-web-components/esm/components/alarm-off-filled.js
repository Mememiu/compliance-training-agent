...
var AlarmOffFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(AlarmOffFilledIcon, _IconBase);
  var _super = _createSuper(AlarmOffFilledIcon);
  function AlarmOffFilledIcon() {
    var _this;
    _classCallCheck(this, AlarmOffFilledIcon);
  ...
  return _createClass(AlarmOffFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
AlarmOffFilledIcon = __decorateClass([Q("t-icon-alarm-off-filled")], AlarmOffFilledIcon);

export default AlarmOffFilledIcon;
