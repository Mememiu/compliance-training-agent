...
var AlignVerticalIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(AlignVerticalIcon, _IconBase);
  var _super = _createSuper(AlignVerticalIcon);
  function AlignVerticalIcon() {
    var _this;
    _classCallCheck(this, AlignVerticalIcon);
  ...
  return _createClass(AlignVerticalIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
AlignVerticalIcon = __decorateClass([Q("t-icon-align-vertical")], AlignVerticalIcon);
