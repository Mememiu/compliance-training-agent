...
var AnimationFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(AnimationFilledIcon, _IconBase);
  var _super = _createSuper(AnimationFilledIcon);
  function AnimationFilledIcon() {
    var _this;
    _classCallCheck(this, AnimationFilledIcon);
  ...
  return _createClass(AnimationFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
AnimationFilledIcon = __decorateClass([Q("t-icon-animation-filled")], AnimationFilledIcon);
