...
var AnimationIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(AnimationIcon, _IconBase);
  ...
  return _createClass(AnimationIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
AnimationIcon = __decorateClass([Q("t-icon-animation")], AnimationIcon);
