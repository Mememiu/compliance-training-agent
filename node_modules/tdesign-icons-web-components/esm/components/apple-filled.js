...
var AppleFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(AppleFilledIcon, _IconBase);
  var _super = _createSuper(AppleFilledIcon);
  function AppleFilledIcon() {
    var _this;
    _classCallCheck(this, AppleFilledIcon);
  ...
  return _createClass(AppleFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
AppleFilledIcon = __decorateClass([Q("t-icon-apple-filled")], AppleFilledIcon);
