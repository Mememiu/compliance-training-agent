...
var AppleIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(AppleIcon, _IconBase);
  var _super = _createSuper(AppleIcon);
  function AppleIcon() {
    var _this;
    _classCallCheck(this, AppleIcon);
  ...
  return _createClass(AppleIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
AppleIcon = __decorateClass([Q("t-icon-apple")], AppleIcon);
