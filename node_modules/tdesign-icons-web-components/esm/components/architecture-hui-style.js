...
var ArchitectureHuiStyleIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ArchitectureHuiStyleIcon, _IconBase);
  var _super = _createSuper(ArchitectureHuiStyleIcon);
  function ArchitectureHuiStyleIcon() {
    var _this;
    _classCallCheck(this, ArchitectureHuiStyleIcon);
  ...
  return _createClass(ArchitectureHuiStyleIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ArchitectureHuiStyleIcon = __decorateClass([Q("t-icon-architecture-hui-style")], ArchitectureHuiStyleIcon);
