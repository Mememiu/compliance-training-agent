...
var AssignmentCodeIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(AssignmentCodeIcon, _IconBase);
  var _super = _createSuper(AssignmentCodeIcon);
  function AssignmentCodeIcon() {
    var _this;
    _classCallCheck(this, AssignmentCodeIcon);
  ...
  return _createClass(AssignmentCodeIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
AssignmentCodeIcon = __decorateClass([Q("t-icon-assignment-code")], AssignmentCodeIcon);
