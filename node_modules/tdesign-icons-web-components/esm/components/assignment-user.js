...
var AssignmentUserIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(AssignmentUserIcon, _IconBase);
  var _super = _createSuper(AssignmentUserIcon);
  function AssignmentUserIcon() {
    var _this;
    _classCallCheck(this, AssignmentUserIcon);
  ...
  return _createClass(AssignmentUserIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
AssignmentUserIcon = __decorateClass([Q("t-icon-assignment-user")], AssignmentUserIcon);
