...
var AttachIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(AttachIcon, _IconBase);
  var _super = _createSuper(AttachIcon);
  function AttachIcon() {
    var _this;
    _classCallCheck(this, AttachIcon);
  ...
  return _createClass(AttachIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
AttachIcon = __decorateClass([Q("t-icon-attach")], AttachIcon);
