...
var Attic1FilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Attic1FilledIcon, _IconBase);
  var _super = _createSuper(Attic1FilledIcon);
  function Attic1FilledIcon() {
    var _this;
    _classCallCheck(this, Attic1FilledIcon);
  ...
  return _createClass(Attic1FilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Attic1FilledIcon = __decorateClass([Q("t-icon-attic-1-filled")], Attic1FilledIcon);
