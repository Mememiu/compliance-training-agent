...
var Attic1Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Attic1Icon, _IconBase);
  var _super = _createSuper(Attic1Icon);
  function Attic1Icon() {
    var _this;
    _classCallCheck(this, Attic1Icon);
  ...
  return _createClass(Attic1Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Attic1Icon = __decorateClass([Q("t-icon-attic-1")], Attic1Icon);
