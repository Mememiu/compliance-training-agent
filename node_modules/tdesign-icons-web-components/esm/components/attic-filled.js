...
var AtticFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(AtticFilledIcon, _IconBase);
  var _super = _createSuper(AtticFilledIcon);
  function AtticFilledIcon() {
    var _this;
    _classCallCheck(this, AtticFilledIcon);
  ...
  return _createClass(AtticFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
AtticFilledIcon = __decorateClass([Q("t-icon-attic-filled")], AtticFilledIcon);
