...
var AtticIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(AtticIcon, _IconBase);
  var _super = _createSuper(AtticIcon);
  function AtticIcon() {
    var _this;
    _classCallCheck(this, AtticIcon);
  ...
  return _createClass(AtticIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
AtticIcon = __decorateClass([Q("t-icon-attic")], AtticIcon);
