...
var AudioIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(AudioIcon, _IconBase);
  ...
  return _createClass(AudioIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
AudioIcon = __decorateClass([Q("t-icon-audio")], AudioIcon);
