...
var BackupIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(BackupIcon, _IconBase);
  var _super = _createSuper(BackupIcon);
  function BackupIcon() {
    var _this;
    _classCallCheck(this, BackupIcon);
  ...
  return _createClass(BackupIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
BackupIcon = __decorateClass([Q("t-icon-backup")], BackupIcon);
