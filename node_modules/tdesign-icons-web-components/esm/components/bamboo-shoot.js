...
var BambooShootIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(BambooShootIcon, _IconBase);
  var _super = _createSuper(BambooShootIcon);
  function BambooShootIcon() {
    var _this;
    _classCallCheck(this, BambooShootIcon);
  ...
  return _createClass(BambooShootIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
BambooShootIcon = __decorateClass([Q("t-icon-bamboo-shoot")], BambooShootIcon);
