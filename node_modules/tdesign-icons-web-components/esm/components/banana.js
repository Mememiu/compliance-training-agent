...
var BananaIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(BananaIcon, _IconBase);
  var _super = _createSuper(BananaIcon);
  function BananaIcon() {
    var _this;
    _classCallCheck(this, BananaIcon);
  ...
  return _createClass(BananaIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
BananaIcon = __decorateClass([Q("t-icon-banana")], BananaIcon);
