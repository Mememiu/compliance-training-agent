...
var BarbecueFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(BarbecueFilledIcon, _IconBase);
  var _super = _createSuper(BarbecueFilledIcon);
  function BarbecueFilledIcon() {
    var _this;
    _classCallCheck(this, BarbecueFilledIcon);
  ...
  return _createClass(BarbecueFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
BarbecueFilledIcon = __decorateClass([Q("t-icon-barbecue-filled")], BarbecueFilledIcon);
