...
var BarbecueIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(BarbecueIcon, _IconBase);
  var _super = _createSuper(BarbecueIcon);
  function BarbecueIcon() {
    var _this;
    _classCallCheck(this, BarbecueIcon);
  ...
  return _createClass(BarbecueIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
BarbecueIcon = __decorateClass([Q("t-icon-barbecue")], BarbecueIcon);
