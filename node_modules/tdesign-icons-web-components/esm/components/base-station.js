...
var BaseStationIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(BaseStationIcon, _IconBase);
  var _super = _createSuper(BaseStationIcon);
  function BaseStationIcon() {
    var _this;
    _classCallCheck(this, BaseStationIcon);
  ...
  return _createClass(BaseStationIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
BaseStationIcon = __decorateClass([Q("t-icon-base-station")], BaseStationIcon);
