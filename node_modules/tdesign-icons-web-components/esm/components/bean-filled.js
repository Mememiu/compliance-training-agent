...
var BeanFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(BeanFilledIcon, _IconBase);
  var _super = _createSuper(BeanFilledIcon);
  function BeanFilledIcon() {
    var _this;
    _classCallCheck(this, BeanFilledIcon);
  ...
  return _createClass(BeanFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
BeanFilledIcon = __decorateClass([Q("t-icon-bean-filled")], BeanFilledIcon);
