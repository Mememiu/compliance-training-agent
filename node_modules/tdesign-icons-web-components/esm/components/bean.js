...
var BeanIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(BeanIcon, _IconBase);
  var _super = _createSuper(BeanIcon);
  function BeanIcon() {
    var _this;
    _classCallCheck(this, BeanIcon);
  ...
  return _createClass(BeanIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
BeanIcon = __decorateClass([Q("t-icon-bean")], BeanIcon);
