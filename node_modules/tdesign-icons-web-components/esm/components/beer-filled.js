...
var BeerFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(BeerFilledIcon, _IconBase);
  var _super = _createSuper(BeerFilledIcon);
  function BeerFilledIcon() {
    var _this;
    _classCallCheck(this, BeerFilledIcon);
  ...
  return _createClass(BeerFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
BeerFilledIcon = __decorateClass([Q("t-icon-beer-filled")], BeerFilledIcon);
