...
var BeerIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(BeerIcon, _IconBase);
  var _super = _createSuper(BeerIcon);
  function BeerIcon() {
    var _this;
    _classCallCheck(this, BeerIcon);
  ...
  return _createClass(BeerIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
BeerIcon = __decorateClass([Q("t-icon-beer")], BeerIcon);
