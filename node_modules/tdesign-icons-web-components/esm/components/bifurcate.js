...
var BifurcateIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(BifurcateIcon, _IconBase);
  var _super = _createSuper(BifurcateIcon);
  function BifurcateIcon() {
    var _this;
    _classCallCheck(this, BifurcateIcon);
  ...
  return _createClass(BifurcateIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
BifurcateIcon = __decorateClass([Q("t-icon-bifurcate")], BifurcateIcon);
