...
var BillIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(BillIcon, _IconBase);
  var _super = _createSuper(BillIcon);
  function BillIcon() {
    var _this;
    _classCallCheck(this, BillIcon);
  ...
  return _createClass(BillIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
BillIcon = __decorateClass([Q("t-icon-bill")], BillIcon);
