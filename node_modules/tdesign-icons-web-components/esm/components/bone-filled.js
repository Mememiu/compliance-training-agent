...
var BoneFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(BoneFilledIcon, _IconBase);
  var _super = _createSuper(BoneFilledIcon);
  function BoneFilledIcon() {
    var _this;
    _classCallCheck(this, BoneFilledIcon);
  ...
  return _createClass(BoneFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
BoneFilledIcon = __decorateClass([Q("t-icon-bone-filled")], BoneFilledIcon);
