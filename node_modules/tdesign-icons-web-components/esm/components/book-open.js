...
var BookOpenIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(BookOpenIcon, _IconBase);
  var _super = _createSuper(BookOpenIcon);
  function BookOpenIcon() {
    var _this;
    _classCallCheck(this, BookOpenIcon);
  ...
  return _createClass(BookOpenIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
BookOpenIcon = __decorateClass([Q("t-icon-book-open")], BookOpenIcon);
