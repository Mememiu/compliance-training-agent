...
var BreadIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(BreadIcon, _IconBase);
  var _super = _createSuper(BreadIcon);
  function BreadIcon() {
    var _this;
    _classCallCheck(this, BreadIcon);
  ...
  return _createClass(BreadIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
BreadIcon = __decorateClass([Q("t-icon-bread")], BreadIcon);
