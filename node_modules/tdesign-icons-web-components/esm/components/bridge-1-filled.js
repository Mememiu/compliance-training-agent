...
var Bridge1FilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Bridge1FilledIcon, _IconBase);
  var _super = _createSuper(Bridge1FilledIcon);
  function Bridge1FilledIcon() {
    var _this;
    _classCallCheck(this, Bridge1FilledIcon);
  ...
  return _createClass(Bridge1FilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Bridge1FilledIcon = __decorateClass([Q("t-icon-bridge-1-filled")], Bridge1FilledIcon);
