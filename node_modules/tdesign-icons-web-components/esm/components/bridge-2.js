...
var Bridge2Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Bridge2Icon, _IconBase);
  var _super = _createSuper(Bridge2Icon);
  function Bridge2Icon() {
    var _this;
    _classCallCheck(this, Bridge2Icon);
  ...
  return _createClass(Bridge2Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Bridge2Icon = __decorateClass([Q("t-icon-bridge-2")], Bridge2Icon);
