...
var Bridge5Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Bridge5Icon, _IconBase);
  var _super = _createSuper(Bridge5Icon);
  function Bridge5Icon() {
    var _this;
    _classCallCheck(this, Bridge5Icon);
  ...
  return _createClass(Bridge5Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Bridge5Icon = __decorateClass([Q("t-icon-bridge-5")], Bridge5Icon);
