...
var BridgeIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(BridgeIcon, _IconBase);
  var _super = _createSuper(BridgeIcon);
  function BridgeIcon() {
    var _this;
    _classCallCheck(this, BridgeIcon);
  ...
  return _createClass(BridgeIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
BridgeIcon = __decorateClass([Q("t-icon-bridge")], BridgeIcon);
