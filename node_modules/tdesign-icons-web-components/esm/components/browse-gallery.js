...
var BrowseGalleryIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(BrowseGalleryIcon, _IconBase);
  var _super = _createSuper(BrowseGalleryIcon);
  function BrowseGalleryIcon() {
    var _this;
    _classCallCheck(this, BrowseGalleryIcon);
  ...
  return _createClass(BrowseGalleryIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
BrowseGalleryIcon = __decorateClass([Q("t-icon-browse-gallery")], BrowseGalleryIcon);
