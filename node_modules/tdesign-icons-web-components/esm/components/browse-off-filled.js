...
var BrowseOffFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(BrowseOffFilledIcon, _IconBase);
  var _super = _createSuper(BrowseOffFilledIcon);
  function BrowseOffFilledIcon() {
    var _this;
    _classCallCheck(this, BrowseOffFilledIcon);
  ...
  return _createClass(BrowseOffFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
BrowseOffFilledIcon = __decorateClass([Q("t-icon-browse-off-filled")], BrowseOffFilledIcon);
