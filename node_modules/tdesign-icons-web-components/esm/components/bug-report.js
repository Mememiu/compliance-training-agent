...
var BugReportIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(BugReportIcon, _IconBase);
  var _super = _createSuper(BugReportIcon);
  function BugReportIcon() {
    var _this;
    _classCallCheck(this, BugReportIcon);
  ...
  return _createClass(BugReportIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
BugReportIcon = __decorateClass([Q("t-icon-bug-report")], BugReportIcon);
