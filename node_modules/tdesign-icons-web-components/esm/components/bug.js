...
var BugIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(BugIcon, _IconBase);
  var _super = _createSuper(BugIcon);
  function BugIcon() {
    var _this;
    _classCallCheck(this, BugIcon);
  ...
  return _createClass(BugIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
BugIcon = __decorateClass([Q("t-icon-bug")], BugIcon);
