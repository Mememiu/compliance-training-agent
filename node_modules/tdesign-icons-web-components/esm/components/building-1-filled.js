...
var Building1FilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Building1FilledIcon, _IconBase);
  var _super = _createSuper(Building1FilledIcon);
  function Building1FilledIcon() {
    var _this;
    _classCallCheck(this, Building1FilledIcon);
  ...
  return _createClass(Building1FilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Building1FilledIcon = __decorateClass([Q("t-icon-building-1-filled")], Building1FilledIcon);
