...
var Building1Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Building1Icon, _IconBase);
  var _super = _createSuper(Building1Icon);
  function Building1Icon() {
    var _this;
    _classCallCheck(this, Building1Icon);
  ...
  return _createClass(Building1Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Building1Icon = __decorateClass([Q("t-icon-building-1")], Building1Icon);
