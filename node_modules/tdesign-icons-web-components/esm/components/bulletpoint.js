...
var BulletpointIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(BulletpointIcon, _IconBase);
  var _super = _createSuper(BulletpointIcon);
  function BulletpointIcon() {
    var _this;
    _classCallCheck(this, BulletpointIcon);
  ...
  return _createClass(BulletpointIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
BulletpointIcon = __decorateClass([Q("t-icon-bulletpoint")], BulletpointIcon);
