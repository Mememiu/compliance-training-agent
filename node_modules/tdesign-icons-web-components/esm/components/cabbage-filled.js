...
var CabbageFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CabbageFilledIcon, _IconBase);
  var _super = _createSuper(CabbageFilledIcon);
  function CabbageFilledIcon() {
    var _this;
    _classCallCheck(this, CabbageFilledIcon);
  ...
  return _createClass(CabbageFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CabbageFilledIcon = __decorateClass([Q("t-icon-cabbage-filled")], CabbageFilledIcon);
