...
var CalculationIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CalculationIcon, _IconBase);
  var _super = _createSuper(CalculationIcon);
  function CalculationIcon() {
    var _this;
    _classCallCheck(this, CalculationIcon);
  ...
  return _createClass(CalculationIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CalculationIcon = __decorateClass([Q("t-icon-calculation")], CalculationIcon);
