...
var Call1Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Call1Icon, _IconBase);
  var _super = _createSuper(Call1Icon);
  function Call1Icon() {
    var _this;
    _classCallCheck(this, Call1Icon);
  ...
  return _createClass(Call1Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Call1Icon = __decorateClass([Q("t-icon-call-1")], Call1Icon);
