...
var CallCancelIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CallCancelIcon, _IconBase);
  var _super = _createSuper(CallCancelIcon);
  function CallCancelIcon() {
    var _this;
    _classCallCheck(this, CallCancelIcon);
  ...
  return _createClass(CallCancelIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CallCancelIcon = __decorateClass([Q("t-icon-call-cancel")], CallCancelIcon);
