...
var CallOffIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CallOffIcon, _IconBase);
  var _super = _createSuper(CallOffIcon);
  function CallOffIcon() {
    var _this;
    _classCallCheck(this, CallOffIcon);
  ...
  return _createClass(CallOffIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CallOffIcon = __decorateClass([Q("t-icon-call-off")], CallOffIcon);
