...
var CallIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CallIcon, _IconBase);
  var _super = _createSuper(CallIcon);
  function CallIcon() {
    var _this;
    _classCallCheck(this, CallIcon);
  ...
  return _createClass(CallIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CallIcon = __decorateClass([Q("t-icon-call")], CallIcon);
