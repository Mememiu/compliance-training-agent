...
var CalmIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CalmIcon, _IconBase);
  var _super = _createSuper(CalmIcon);
  function CalmIcon() {
    var _this;
    _classCallCheck(this, CalmIcon);
  ...
  return _createClass(CalmIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CalmIcon = __decorateClass([Q("t-icon-calm")], CalmIcon);
