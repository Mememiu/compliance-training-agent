...
var Camera1Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Camera1Icon, _IconBase);
  var _super = _createSuper(Camera1Icon);
  function Camera1Icon() {
    var _this;
    _classCallCheck(this, Camera1Icon);
  ...
  return _createClass(Camera1Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Camera1Icon = __decorateClass([Q("t-icon-camera-1")], Camera1Icon);
