...
var CameraIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CameraIcon, _IconBase);
  var _super = _createSuper(CameraIcon);
  function CameraIcon() {
    var _this;
    _classCallCheck(this, CameraIcon);
  ...
  return _createClass(CameraIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CameraIcon = __decorateClass([Q("t-icon-camera")], CameraIcon);
