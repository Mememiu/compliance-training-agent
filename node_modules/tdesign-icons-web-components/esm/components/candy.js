...
var CandyIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CandyIcon, _IconBase);
  var _super = _createSuper(CandyIcon);
  function CandyIcon() {
    var _this;
    _classCallCheck(this, CandyIcon);
  ...
  return _createClass(CandyIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CandyIcon = __decorateClass([Q("t-icon-candy")], CandyIcon);
