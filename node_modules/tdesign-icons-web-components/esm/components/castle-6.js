...
var Castle6Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Castle6Icon, _IconBase);
  var _super = _createSuper(Castle6Icon);
  function Castle6Icon() {
    var _this;
    _classCallCheck(this, Castle6Icon);
  ...
  return _createClass(Castle6Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Castle6Icon = __decorateClass([Q("t-icon-castle-6")], Castle6Icon);
