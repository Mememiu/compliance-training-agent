...
var CatIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CatIcon, _IconBase);
  var _super = _createSuper(CatIcon);
  function CatIcon() {
    var _this;
    _classCallCheck(this, CatIcon);
  ...
  return _createClass(CatIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CatIcon = __decorateClass([Q("t-icon-cat")], CatIcon);
