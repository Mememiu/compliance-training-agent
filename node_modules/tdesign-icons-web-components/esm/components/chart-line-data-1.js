...
var ChartLineData1Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ChartLineData1Icon, _IconBase);
  var _super = _createSuper(ChartLineData1Icon);
  function ChartLineData1Icon() {
    var _this;
    _classCallCheck(this, ChartLineData1Icon);
  ...
  return _createClass(ChartLineData1Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ChartLineData1Icon = __decorateClass([Q("t-icon-chart-line-data-1")], ChartLineData1Icon);
