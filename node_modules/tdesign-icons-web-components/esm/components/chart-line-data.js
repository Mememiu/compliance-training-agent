...
var ChartLineDataIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ChartLineDataIcon, _IconBase);
  var _super = _createSuper(ChartLineDataIcon);
  function ChartLineDataIcon() {
    var _this;
    _classCallCheck(this, ChartLineDataIcon);
  ...
  return _createClass(ChartLineDataIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ChartLineDataIcon = __decorateClass([Q("t-icon-chart-line-data")], ChartLineDataIcon);
