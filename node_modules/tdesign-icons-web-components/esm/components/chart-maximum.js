...
var ChartMaximumIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ChartMaximumIcon, _IconBase);
  var _super = _createSuper(ChartMaximumIcon);
  function ChartMaximumIcon() {
    var _this;
    _classCallCheck(this, ChartMaximumIcon);
  ...
  return _createClass(ChartMaximumIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ChartMaximumIcon = __decorateClass([Q("t-icon-chart-maximum")], ChartMaximumIcon);
