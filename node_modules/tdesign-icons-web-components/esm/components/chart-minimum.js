...
var ChartMinimumIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ChartMinimumIcon, _IconBase);
  var _super = _createSuper(ChartMinimumIcon);
  function ChartMinimumIcon() {
    var _this;
    _classCallCheck(this, ChartMinimumIcon);
  ...
  return _createClass(ChartMinimumIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ChartMinimumIcon = __decorateClass([Q("t-icon-chart-minimum")], ChartMinimumIcon);
