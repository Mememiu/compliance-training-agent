...
var ChartRing1Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ChartRing1Icon, _IconBase);
  var _super = _createSuper(ChartRing1Icon);
  function ChartRing1Icon() {
    var _this;
    _classCallCheck(this, ChartRing1Icon);
  ...
  return _createClass(ChartRing1Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ChartRing1Icon = __decorateClass([Q("t-icon-chart-ring-1")], ChartRing1Icon);
