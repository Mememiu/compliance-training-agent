...
var ChartScatterIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ChartScatterIcon, _IconBase);
  var _super = _createSuper(ChartScatterIcon);
  function ChartScatterIcon() {
    var _this;
    _classCallCheck(this, ChartScatterIcon);
  ...
  return _createClass(ChartScatterIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ChartScatterIcon = __decorateClass([Q("t-icon-chart-scatter")], ChartScatterIcon);
