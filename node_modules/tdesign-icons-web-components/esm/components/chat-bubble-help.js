...
var ChatBubbleHelpIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ChatBubbleHelpIcon, _IconBase);
  var _super = _createSuper(ChatBubbleHelpIcon);
  function ChatBubbleHelpIcon() {
    var _this;
    _classCallCheck(this, ChatBubbleHelpIcon);
  ...
  return _createClass(ChatBubbleHelpIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ChatBubbleHelpIcon = __decorateClass([Q("t-icon-chat-bubble-help")], ChatBubbleHelpIcon);
