...
var ChatBubbleSmileIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ChatBubbleSmileIcon, _IconBase);
  var _super = _createSuper(ChatBubbleSmileIcon);
  function ChatBubbleSmileIcon() {
    var _this;
    _classCallCheck(this, ChatBubbleSmileIcon);
  ...
  return _createClass(ChatBubbleSmileIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ChatBubbleSmileIcon = __decorateClass([Q("t-icon-chat-bubble-smile")], ChatBubbleSmileIcon);
