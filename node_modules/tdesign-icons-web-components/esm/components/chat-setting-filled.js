...
var ChatSettingFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ChatSettingFilledIcon, _IconBase);
  var _super = _createSuper(ChatSettingFilledIcon);
  function ChatSettingFilledIcon() {
    var _this;
    _classCallCheck(this, ChatSettingFilledIcon);
  ...
  return _createClass(ChatSettingFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ChatSettingFilledIcon = __decorateClass([Q("t-icon-chat-setting-filled")], ChatSettingFilledIcon);
