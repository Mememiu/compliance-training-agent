...
var ChatSettingIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ChatSettingIcon, _IconBase);
  var _super = _createSuper(ChatSettingIcon);
  function ChatSettingIcon() {
    var _this;
    _classCallCheck(this, ChatSettingIcon);
  ...
  return _createClass(ChatSettingIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ChatSettingIcon = __decorateClass([Q("t-icon-chat-setting")], ChatSettingIcon);
