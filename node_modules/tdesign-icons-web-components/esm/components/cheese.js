...
var CheeseIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CheeseIcon, _IconBase);
  var _super = _createSuper(CheeseIcon);
  function CheeseIcon() {
    var _this;
    _classCallCheck(this, CheeseIcon);
  ...
  return _createClass(CheeseIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CheeseIcon = __decorateClass([Q("t-icon-cheese")], CheeseIcon);
