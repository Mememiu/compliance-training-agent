...
var CherryFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CherryFilledIcon, _IconBase);
  var _super = _createSuper(CherryFilledIcon);
  function CherryFilledIcon() {
    var _this;
    _classCallCheck(this, CherryFilledIcon);
  ...
  return _createClass(CherryFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CherryFilledIcon = __decorateClass([Q("t-icon-cherry-filled")], CherryFilledIcon);
