...
var CherryIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CherryIcon, _IconBase);
  var _super = _createSuper(CherryIcon);
  function CherryIcon() {
    var _this;
    _classCallCheck(this, CherryIcon);
  ...
  return _createClass(CherryIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CherryIcon = __decorateClass([Q("t-icon-cherry")], CherryIcon);
