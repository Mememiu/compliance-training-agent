...
var ChiliIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ChiliIcon, _IconBase);
  var _super = _createSuper(ChiliIcon);
  function ChiliIcon() {
    var _this;
    _classCallCheck(this, ChiliIcon);
  ...
  return _createClass(ChiliIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ChiliIcon = __decorateClass([Q("t-icon-chili")], ChiliIcon);
