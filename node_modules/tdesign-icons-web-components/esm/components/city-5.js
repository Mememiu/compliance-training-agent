...
var City5Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(City5Icon, _IconBase);
  var _super = _createSuper(City5Icon);
  function City5Icon() {
    var _this;
    _classCallCheck(this, City5Icon);
  ...
  return _createClass(City5Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
City5Icon = __decorateClass([Q("t-icon-city-5")], City5Icon);
