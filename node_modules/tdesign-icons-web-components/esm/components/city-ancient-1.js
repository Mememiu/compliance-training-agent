...
var CityAncient1Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CityAncient1Icon, _IconBase);
  var _super = _createSuper(CityAncient1Icon);
  function CityAncient1Icon() {
    var _this;
    _classCallCheck(this, CityAncient1Icon);
  ...
  return _createClass(CityAncient1Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CityAncient1Icon = __decorateClass([Q("t-icon-city-ancient-1")], CityAncient1Icon);
