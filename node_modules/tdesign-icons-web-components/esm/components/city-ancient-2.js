...
var CityAncient2Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CityAncient2Icon, _IconBase);
  var _super = _createSuper(CityAncient2Icon);
  function CityAncient2Icon() {
    var _this;
    _classCallCheck(this, CityAncient2Icon);
  ...
  return _createClass(CityAncient2Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CityAncient2Icon = __decorateClass([Q("t-icon-city-ancient-2")], CityAncient2Icon);
