...
var CityAncientIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CityAncientIcon, _IconBase);
  var _super = _createSuper(CityAncientIcon);
  function CityAncientIcon() {
    var _this;
    _classCallCheck(this, CityAncientIcon);
  ...
  return _createClass(CityAncientIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CityAncientIcon = __decorateClass([Q("t-icon-city-ancient")], CityAncientIcon);
