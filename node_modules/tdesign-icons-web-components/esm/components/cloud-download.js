...
var CloudDownloadIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CloudDownloadIcon, _IconBase);
  var _super = _createSuper(CloudDownloadIcon);
  function CloudDownloadIcon() {
    var _this;
    _classCallCheck(this, CloudDownloadIcon);
  ...
  return _createClass(CloudDownloadIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CloudDownloadIcon = __decorateClass([Q("t-icon-cloud-download")], CloudDownloadIcon);
