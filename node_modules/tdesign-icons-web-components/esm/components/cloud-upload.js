...
var CloudUploadIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CloudUploadIcon, _IconBase);
  var _super = _createSuper(CloudUploadIcon);
  function CloudUploadIcon() {
    var _this;
    _classCallCheck(this, CloudUploadIcon);
  ...
  return _createClass(CloudUploadIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CloudUploadIcon = __decorateClass([Q("t-icon-cloud-upload")], CloudUploadIcon);
