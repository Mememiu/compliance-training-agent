...
var CloudyDayFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CloudyDayFilledIcon, _IconBase);
  var _super = _createSuper(CloudyDayFilledIcon);
  function CloudyDayFilledIcon() {
    var _this;
    _classCallCheck(this, CloudyDayFilledIcon);
  ...
  return _createClass(CloudyDayFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CloudyDayFilledIcon = __decorateClass([Q("t-icon-cloudy-day-filled")], CloudyDayFilledIcon);
