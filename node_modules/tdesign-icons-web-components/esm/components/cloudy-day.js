...
var CloudyDayIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CloudyDayIcon, _IconBase);
  var _super = _createSuper(CloudyDayIcon);
  function CloudyDayIcon() {
    var _this;
    _classCallCheck(this, CloudyDayIcon);
  ...
  return _createClass(CloudyDayIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CloudyDayIcon = __decorateClass([Q("t-icon-cloudy-day")], CloudyDayIcon);
