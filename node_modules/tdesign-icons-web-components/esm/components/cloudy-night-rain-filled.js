...
var CloudyNightRainFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CloudyNightRainFilledIcon, _IconBase);
  var _super = _createSuper(CloudyNightRainFilledIcon);
  function CloudyNightRainFilledIcon() {
    var _this;
    _classCallCheck(this, CloudyNightRainFilledIcon);
  ...
  return _createClass(CloudyNightRainFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CloudyNightRainFilledIcon = __decorateClass([Q("t-icon-cloudy-night-rain-filled")], CloudyNightRainFilledIcon);
