...
var CloudyNightRainIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CloudyNightRainIcon, _IconBase);
  var _super = _createSuper(CloudyNightRainIcon);
  function CloudyNightRainIcon() {
    var _this;
    _classCallCheck(this, CloudyNightRainIcon);
  ...
  return _createClass(CloudyNightRainIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CloudyNightRainIcon = __decorateClass([Q("t-icon-cloudy-night-rain")], CloudyNightRainIcon);
