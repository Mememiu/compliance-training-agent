...
var CloudyNightIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CloudyNightIcon, _IconBase);
  var _super = _createSuper(CloudyNightIcon);
  function CloudyNightIcon() {
    var _this;
    _classCallCheck(this, CloudyNightIcon);
  ...
  return _createClass(CloudyNightIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CloudyNightIcon = __decorateClass([Q("t-icon-cloudy-night")], CloudyNightIcon);
