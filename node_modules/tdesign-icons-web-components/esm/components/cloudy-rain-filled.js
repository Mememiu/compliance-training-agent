...
var CloudyRainFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CloudyRainFilledIcon, _IconBase);
  var _super = _createSuper(CloudyRainFilledIcon);
  function CloudyRainFilledIcon() {
    var _this;
    _classCallCheck(this, CloudyRainFilledIcon);
  ...
  return _createClass(CloudyRainFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CloudyRainFilledIcon = __decorateClass([Q("t-icon-cloudy-rain-filled")], CloudyRainFilledIcon);
