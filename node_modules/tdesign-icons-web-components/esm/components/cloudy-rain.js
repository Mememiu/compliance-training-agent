...
var CloudyRainIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CloudyRainIcon, _IconBase);
  var _super = _createSuper(CloudyRainIcon);
  function CloudyRainIcon() {
    var _this;
    _classCallCheck(this, CloudyRainIcon);
  ...
  return _createClass(CloudyRainIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CloudyRainIcon = __decorateClass([Q("t-icon-cloudy-rain")], CloudyRainIcon);
