...
var CloudySunnyIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CloudySunnyIcon, _IconBase);
  var _super = _createSuper(CloudySunnyIcon);
  function CloudySunnyIcon() {
    var _this;
    _classCallCheck(this, CloudySunnyIcon);
  ...
  return _createClass(CloudySunnyIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CloudySunnyIcon = __decorateClass([Q("t-icon-cloudy-sunny")], CloudySunnyIcon);
