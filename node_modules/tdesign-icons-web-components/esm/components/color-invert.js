...
var ColorInvertIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ColorInvertIcon, _IconBase);
  var _super = _createSuper(ColorInvertIcon);
  function ColorInvertIcon() {
    var _this;
    _classCallCheck(this, ColorInvertIcon);
  ...
  return _createClass(ColorInvertIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ColorInvertIcon = __decorateClass([Q("t-icon-color-invert")], ColorInvertIcon);
