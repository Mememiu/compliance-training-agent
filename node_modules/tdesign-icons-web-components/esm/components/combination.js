...
var CombinationIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CombinationIcon, _IconBase);
  var _super = _createSuper(CombinationIcon);
  function CombinationIcon() {
    var _this;
    _classCallCheck(this, CombinationIcon);
  ...
  return _createClass(CombinationIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CombinationIcon = __decorateClass([Q("t-icon-combination")], CombinationIcon);
