...
var CommandIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CommandIcon, _IconBase);
  var _super = _createSuper(CommandIcon);
  function CommandIcon() {
    var _this;
    _classCallCheck(this, CommandIcon);
  ...
  return _createClass(CommandIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CommandIcon = __decorateClass([Q("t-icon-command")], CommandIcon);
