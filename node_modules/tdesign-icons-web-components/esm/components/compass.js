...
var CompassIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CompassIcon, _IconBase);
  ...
  return _createClass(CompassIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CompassIcon = __decorateClass([Q("t-icon-compass")], CompassIcon);
