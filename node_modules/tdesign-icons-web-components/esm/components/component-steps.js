...
var ComponentStepsIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ComponentStepsIcon, _IconBase);
  var _super = _createSuper(ComponentStepsIcon);
  function ComponentStepsIcon() {
    var _this;
    _classCallCheck(this, ComponentStepsIcon);
  ...
  return _createClass(ComponentStepsIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ComponentStepsIcon = __decorateClass([Q("t-icon-component-steps")], ComponentStepsIcon);
