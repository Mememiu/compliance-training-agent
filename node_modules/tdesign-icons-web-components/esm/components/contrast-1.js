...
var Contrast1Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Contrast1Icon, _IconBase);
  var _super = _createSuper(Contrast1Icon);
  function Contrast1Icon() {
    var _this;
    _classCallCheck(this, Contrast1Icon);
  ...
  return _createClass(Contrast1Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Contrast1Icon = __decorateClass([Q("t-icon-contrast-1")], Contrast1Icon);
