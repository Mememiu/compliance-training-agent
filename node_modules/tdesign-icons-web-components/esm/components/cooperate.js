...
var CooperateIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CooperateIcon, _IconBase);
  var _super = _createSuper(CooperateIcon);
  function CooperateIcon() {
    var _this;
    _classCallCheck(this, CooperateIcon);
  ...
  return _createClass(CooperateIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CooperateIcon = __decorateClass([Q("t-icon-cooperate")], CooperateIcon);
