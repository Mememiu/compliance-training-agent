...
var CopyrightFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CopyrightFilledIcon, _IconBase);
  var _super = _createSuper(CopyrightFilledIcon);
  function CopyrightFilledIcon() {
    var _this;
    _classCallCheck(this, CopyrightFilledIcon);
  ...
  return _createClass(CopyrightFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CopyrightFilledIcon = __decorateClass([Q("t-icon-copyright-filled")], CopyrightFilledIcon);
