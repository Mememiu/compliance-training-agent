...
var CopyrightIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CopyrightIcon, _IconBase);
  var _super = _createSuper(CopyrightIcon);
  function CopyrightIcon() {
    var _this;
    _classCallCheck(this, CopyrightIcon);
  ...
  return _createClass(CopyrightIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CopyrightIcon = __decorateClass([Q("t-icon-copyright")], CopyrightIcon);
