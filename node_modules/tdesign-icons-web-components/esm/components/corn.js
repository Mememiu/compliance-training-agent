...
var CornIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CornIcon, _IconBase);
  var _super = _createSuper(CornIcon);
  function CornIcon() {
    var _this;
    _classCallCheck(this, CornIcon);
  ...
  return _createClass(CornIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CornIcon = __decorateClass([Q("t-icon-corn")], CornIcon);
