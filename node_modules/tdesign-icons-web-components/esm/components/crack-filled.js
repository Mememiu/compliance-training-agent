...
var CrackFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CrackFilledIcon, _IconBase);
  var _super = _createSuper(CrackFilledIcon);
  function CrackFilledIcon() {
    var _this;
    _classCallCheck(this, CrackFilledIcon);
  ...
  return _createClass(CrackFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CrackFilledIcon = __decorateClass([Q("t-icon-crack-filled")], CrackFilledIcon);
