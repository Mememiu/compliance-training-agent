...
var CrackIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CrackIcon, _IconBase);
  var _super = _createSuper(CrackIcon);
  function CrackIcon() {
    var _this;
    _classCallCheck(this, CrackIcon);
  ...
  return _createClass(CrackIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CrackIcon = __decorateClass([Q("t-icon-crack")], CrackIcon);
