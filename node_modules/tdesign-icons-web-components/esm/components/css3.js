...
var Css3Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Css3Icon, _IconBase);
  var _super = _createSuper(Css3Icon);
  function Css3Icon() {
    var _this;
    _classCallCheck(this, Css3Icon);
  ...
  return _createClass(Css3Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Css3Icon = __decorateClass([Q("t-icon-css3")], Css3Icon);
