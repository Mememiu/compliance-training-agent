...
var CucumberIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CucumberIcon, _IconBase);
  var _super = _createSuper(CucumberIcon);
  function CucumberIcon() {
    var _this;
    _classCallCheck(this, CucumberIcon);
  ...
  return _createClass(CucumberIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CucumberIcon = __decorateClass([Q("t-icon-cucumber")], CucumberIcon);
