...
var CurrencyExchangeIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CurrencyExchangeIcon, _IconBase);
  var _super = _createSuper(CurrencyExchangeIcon);
  function CurrencyExchangeIcon() {
    var _this;
    _classCallCheck(this, CurrencyExchangeIcon);
  ...
  return _createClass(CurrencyExchangeIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CurrencyExchangeIcon = __decorateClass([Q("t-icon-currency-exchange")], CurrencyExchangeIcon);
