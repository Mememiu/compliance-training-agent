...
var CutIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(CutIcon, _IconBase);
  var _super = _createSuper(CutIcon);
  function CutIcon() {
    var _this;
    _classCallCheck(this, CutIcon);
  ...
  return _createClass(CutIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
CutIcon = __decorateClass([Q("t-icon-cut")], CutIcon);
