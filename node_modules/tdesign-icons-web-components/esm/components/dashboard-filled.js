...
var DashboardFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(DashboardFilledIcon, _IconBase);
  var _super = _createSuper(DashboardFilledIcon);
  function DashboardFilledIcon() {
    var _this;
    _classCallCheck(this, DashboardFilledIcon);
  ...
  return _createClass(DashboardFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
DashboardFilledIcon = __decorateClass([Q("t-icon-dashboard-filled")], DashboardFilledIcon);
