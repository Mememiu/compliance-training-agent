...
var DashboardIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(DashboardIcon, _IconBase);
  var _super = _createSuper(DashboardIcon);
  function DashboardIcon() {
    var _this;
    _classCallCheck(this, DashboardIcon);
  ...
  return _createClass(DashboardIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
DashboardIcon = __decorateClass([Q("t-icon-dashboard")], DashboardIcon);
