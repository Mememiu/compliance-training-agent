...
var DataBaseIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(DataBaseIcon, _IconBase);
  var _super = _createSuper(DataBaseIcon);
  function DataBaseIcon() {
    var _this;
    _classCallCheck(this, DataBaseIcon);
  ...
  return _createClass(DataBaseIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
DataBaseIcon = __decorateClass([Q("t-icon-data-base")], DataBaseIcon);
