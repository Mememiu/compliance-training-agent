...
var DataSearchIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(DataSearchIcon, _IconBase);
  var _super = _createSuper(DataSearchIcon);
  function DataSearchIcon() {
    var _this;
    _classCallCheck(this, DataSearchIcon);
  ...
  return _createClass(DataSearchIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
DataSearchIcon = __decorateClass([Q("t-icon-data-search")], DataSearchIcon);
