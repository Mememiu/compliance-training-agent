...
var DeleteTimeIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(DeleteTimeIcon, _IconBase);
  var _super = _createSuper(DeleteTimeIcon);
  function DeleteTimeIcon() {
    var _this;
    _classCallCheck(this, DeleteTimeIcon);
  ...
  return _createClass(DeleteTimeIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
DeleteTimeIcon = __decorateClass([Q("t-icon-delete-time")], DeleteTimeIcon);
