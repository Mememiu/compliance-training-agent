...
var DepressedIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(DepressedIcon, _IconBase);
  var _super = _createSuper(DepressedIcon);
  function DepressedIcon() {
    var _this;
    _classCallCheck(this, DepressedIcon);
  ...
  return _createClass(DepressedIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
DepressedIcon = __decorateClass([Q("t-icon-depressed")], DepressedIcon);
