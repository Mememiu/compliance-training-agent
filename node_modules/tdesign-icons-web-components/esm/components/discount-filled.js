...
var DiscountFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(DiscountFilledIcon, _IconBase);
  var _super = _createSuper(DiscountFilledIcon);
  function DiscountFilledIcon() {
    var _this;
    _classCallCheck(this, DiscountFilledIcon);
  ...
  return _createClass(DiscountFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
DiscountFilledIcon = __decorateClass([Q("t-icon-discount-filled")], DiscountFilledIcon);
