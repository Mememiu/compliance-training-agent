...
var DiscountIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(DiscountIcon, _IconBase);
  var _super = _createSuper(DiscountIcon);
  function DiscountIcon() {
    var _this;
    _classCallCheck(this, DiscountIcon);
  ...
  return _createClass(DiscountIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
DiscountIcon = __decorateClass([Q("t-icon-discount")], DiscountIcon);
