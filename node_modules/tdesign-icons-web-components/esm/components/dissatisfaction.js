...
var DissatisfactionIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(DissatisfactionIcon, _IconBase);
  var _super = _createSuper(DissatisfactionIcon);
  function DissatisfactionIcon() {
    var _this;
    _classCallCheck(this, DissatisfactionIcon);
  ...
  return _createClass(DissatisfactionIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
DissatisfactionIcon = __decorateClass([Q("t-icon-dissatisfaction")], DissatisfactionIcon);
