...
var DogeIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(DogeIcon, _IconBase);
  var _super = _createSuper(DogeIcon);
  function DogeIcon() {
    var _this;
    _classCallCheck(this, DogeIcon);
  ...
  return _createClass(DogeIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
DogeIcon = __decorateClass([Q("t-icon-doge")], DogeIcon);
