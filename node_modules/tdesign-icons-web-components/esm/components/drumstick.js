...
var DrumstickIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(DrumstickIcon, _IconBase);
  var _super = _createSuper(DrumstickIcon);
  function DrumstickIcon() {
    var _this;
    _classCallCheck(this, DrumstickIcon);
  ...
  return _createClass(DrumstickIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
DrumstickIcon = __decorateClass([Q("t-icon-drumstick")], DrumstickIcon);
