...
var DvIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(DvIcon, _IconBase);
  var _super = _createSuper(DvIcon);
  function DvIcon() {
    var _this;
    _classCallCheck(this, DvIcon);
  ...
  return _createClass(DvIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
DvIcon = __decorateClass([Q("t-icon-dv")], DvIcon);
