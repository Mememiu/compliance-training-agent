...
var EarphoneIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(EarphoneIcon, _IconBase);
  var _super = _createSuper(EarphoneIcon);
  function EarphoneIcon() {
    var _this;
    _classCallCheck(this, EarphoneIcon);
  ...
  return _createClass(EarphoneIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
EarphoneIcon = __decorateClass([Q("t-icon-earphone")], EarphoneIcon);
