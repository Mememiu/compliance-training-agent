...
var EarthFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(EarthFilledIcon, _IconBase);
  var _super = _createSuper(EarthFilledIcon);
  function EarthFilledIcon() {
    var _this;
    _classCallCheck(this, EarthFilledIcon);
  ...
  return _createClass(EarthFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
EarthFilledIcon = __decorateClass([Q("t-icon-earth-filled")], EarthFilledIcon);
