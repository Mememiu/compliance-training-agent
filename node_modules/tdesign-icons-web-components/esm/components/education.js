...
var EducationIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(EducationIcon, _IconBase);
  var _super = _createSuper(EducationIcon);
  function EducationIcon() {
    var _this;
    _classCallCheck(this, EducationIcon);
  ...
  return _createClass(EducationIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
EducationIcon = __decorateClass([Q("t-icon-education")], EducationIcon);
