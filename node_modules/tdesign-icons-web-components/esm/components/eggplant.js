...
var EggplantIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(EggplantIcon, _IconBase);
  var _super = _createSuper(EggplantIcon);
  function EggplantIcon() {
    var _this;
    _classCallCheck(this, EggplantIcon);
  ...
  return _createClass(EggplantIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
EggplantIcon = __decorateClass([Q("t-icon-eggplant")], EggplantIcon);
