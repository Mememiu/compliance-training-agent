...
var Excited1Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Excited1Icon, _IconBase);
  var _super = _createSuper(Excited1Icon);
  function Excited1Icon() {
    var _this;
    _classCallCheck(this, Excited1Icon);
  ...
  return _createClass(Excited1Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Excited1Icon = __decorateClass([Q("t-icon-excited-1")], Excited1Icon);
