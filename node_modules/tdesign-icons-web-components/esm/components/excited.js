...
var ExcitedIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ExcitedIcon, _IconBase);
  var _super = _createSuper(ExcitedIcon);
  function ExcitedIcon() {
    var _this;
    _classCallCheck(this, ExcitedIcon);
  ...
  return _createClass(ExcitedIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ExcitedIcon = __decorateClass([Q("t-icon-excited")], ExcitedIcon);
