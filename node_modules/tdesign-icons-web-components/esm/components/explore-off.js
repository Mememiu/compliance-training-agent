...
var ExploreOffIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ExploreOffIcon, _IconBase);
  var _super = _createSuper(ExploreOffIcon);
  function ExploreOffIcon() {
    var _this;
    _classCallCheck(this, ExploreOffIcon);
  ...
  return _createClass(ExploreOffIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ExploreOffIcon = __decorateClass([Q("t-icon-explore-off")], ExploreOffIcon);
