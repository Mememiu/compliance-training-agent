...
var ExploreIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ExploreIcon, _IconBase);
  var _super = _createSuper(ExploreIcon);
  function ExploreIcon() {
    var _this;
    _classCallCheck(this, ExploreIcon);
  ...
  return _createClass(ExploreIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ExploreIcon = __decorateClass([Q("t-icon-explore")], ExploreIcon);
