...
var ExtensionOffIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ExtensionOffIcon, _IconBase);
  var _super = _createSuper(ExtensionOffIcon);
  function ExtensionOffIcon() {
    var _this;
    _classCallCheck(this, ExtensionOffIcon);
  ...
  return _createClass(ExtensionOffIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ExtensionOffIcon = __decorateClass([Q("t-icon-extension-off")], ExtensionOffIcon);
