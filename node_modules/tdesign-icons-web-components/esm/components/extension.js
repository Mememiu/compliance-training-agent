...
var ExtensionIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ExtensionIcon, _IconBase);
  var _super = _createSuper(ExtensionIcon);
  function ExtensionIcon() {
    var _this;
    _classCallCheck(this, ExtensionIcon);
  ...
  return _createClass(ExtensionIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ExtensionIcon = __decorateClass([Q("t-icon-extension")], ExtensionIcon);
