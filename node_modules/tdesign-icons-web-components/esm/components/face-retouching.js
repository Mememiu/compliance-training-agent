...
var FaceRetouchingIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FaceRetouchingIcon, _IconBase);
  var _super = _createSuper(FaceRetouchingIcon);
  function FaceRetouchingIcon() {
    var _this;
    _classCallCheck(this, FaceRetouchingIcon);
  ...
  return _createClass(FaceRetouchingIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FaceRetouchingIcon = __decorateClass([Q("t-icon-face-retouching")], FaceRetouchingIcon);
