...
var FerrisWheelIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FerrisWheelIcon, _IconBase);
  var _super = _createSuper(FerrisWheelIcon);
  function FerrisWheelIcon() {
    var _this;
    _classCallCheck(this, FerrisWheelIcon);
  ...
  return _createClass(FerrisWheelIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FerrisWheelIcon = __decorateClass([Q("t-icon-ferris-wheel")], FerrisWheelIcon);
