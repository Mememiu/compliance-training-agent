...
var FileBlockedFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FileBlockedFilledIcon, _IconBase);
  var _super = _createSuper(FileBlockedFilledIcon);
  function FileBlockedFilledIcon() {
    var _this;
    _classCallCheck(this, FileBlockedFilledIcon);
  ...
  return _createClass(FileBlockedFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FileBlockedFilledIcon = __decorateClass([Q("t-icon-file-blocked-filled")], FileBlockedFilledIcon);
