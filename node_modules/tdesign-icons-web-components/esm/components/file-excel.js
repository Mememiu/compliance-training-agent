...
var FileExcelIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FileExcelIcon, _IconBase);
  var _super = _createSuper(FileExcelIcon);
  function FileExcelIcon() {
    var _this;
    _classCallCheck(this, FileExcelIcon);
  ...
  return _createClass(FileExcelIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FileExcelIcon = __decorateClass([Q("t-icon-file-excel")], FileExcelIcon);
