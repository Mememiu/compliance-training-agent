...
var FileIconIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FileIconIcon, _IconBase);
  var _super = _createSuper(FileIconIcon);
  function FileIconIcon() {
    var _this;
    _classCallCheck(this, FileIconIcon);
  ...
  return _createClass(FileIconIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FileIconIcon = __decorateClass([Q("t-icon-file-icon")], FileIconIcon);
