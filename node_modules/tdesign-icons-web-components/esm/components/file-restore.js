...
var FileRestoreIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FileRestoreIcon, _IconBase);
  var _super = _createSuper(FileRestoreIcon);
  function FileRestoreIcon() {
    var _this;
    _classCallCheck(this, FileRestoreIcon);
  ...
  return _createClass(FileRestoreIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FileRestoreIcon = __decorateClass([Q("t-icon-file-restore")], FileRestoreIcon);
