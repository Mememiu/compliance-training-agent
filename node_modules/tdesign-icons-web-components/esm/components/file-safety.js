...
var FileSafetyIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FileSafetyIcon, _IconBase);
  var _super = _createSuper(FileSafetyIcon);
  function FileSafetyIcon() {
    var _this;
    _classCallCheck(this, FileSafetyIcon);
  ...
  return _createClass(FileSafetyIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FileSafetyIcon = __decorateClass([Q("t-icon-file-safety")], FileSafetyIcon);
