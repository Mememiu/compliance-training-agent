...
var FileSearchIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FileSearchIcon, _IconBase);
  var _super = _createSuper(FileSearchIcon);
  function FileSearchIcon() {
    var _this;
    _classCallCheck(this, FileSearchIcon);
  ...
  return _createClass(FileSearchIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FileSearchIcon = __decorateClass([Q("t-icon-file-search")], FileSearchIcon);
