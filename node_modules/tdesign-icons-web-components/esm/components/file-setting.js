...
var FileSettingIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FileSettingIcon, _IconBase);
  var _super = _createSuper(FileSettingIcon);
  function FileSettingIcon() {
    var _this;
    _classCallCheck(this, FileSettingIcon);
  ...
  return _createClass(FileSettingIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FileSettingIcon = __decorateClass([Q("t-icon-file-setting")], FileSettingIcon);
