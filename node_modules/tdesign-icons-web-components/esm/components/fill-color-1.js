...
var FillColor1Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FillColor1Icon, _IconBase);
  var _super = _createSuper(FillColor1Icon);
  function FillColor1Icon() {
    var _this;
    _classCallCheck(this, FillColor1Icon);
  ...
  return _createClass(FillColor1Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FillColor1Icon = __decorateClass([Q("t-icon-fill-color-1")], FillColor1Icon);
