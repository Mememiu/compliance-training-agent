...
var FilmFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FilmFilledIcon, _IconBase);
  var _super = _createSuper(FilmFilledIcon);
  function FilmFilledIcon() {
    var _this;
    _classCallCheck(this, FilmFilledIcon);
  ...
  return _createClass(FilmFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FilmFilledIcon = __decorateClass([Q("t-icon-film-filled")], FilmFilledIcon);
