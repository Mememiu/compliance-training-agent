...
var FilmIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FilmIcon, _IconBase);
  var _super = _createSuper(FilmIcon);
  function FilmIcon() {
    var _this;
    _classCallCheck(this, FilmIcon);
  ...
  return _createClass(FilmIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FilmIcon = __decorateClass([Q("t-icon-film")], FilmIcon);
