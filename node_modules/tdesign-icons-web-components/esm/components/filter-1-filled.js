...
var Filter1FilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Filter1FilledIcon, _IconBase);
  var _super = _createSuper(Filter1FilledIcon);
  function Filter1FilledIcon() {
    var _this;
    _classCallCheck(this, Filter1FilledIcon);
  ...
  return _createClass(Filter1FilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Filter1FilledIcon = __decorateClass([Q("t-icon-filter-1-filled")], Filter1FilledIcon);
