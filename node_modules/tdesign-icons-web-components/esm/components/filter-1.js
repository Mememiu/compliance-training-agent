...
var Filter1Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Filter1Icon, _IconBase);
  var _super = _createSuper(Filter1Icon);
  function Filter1Icon() {
    var _this;
    _classCallCheck(this, Filter1Icon);
  ...
  return _createClass(Filter1Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Filter1Icon = __decorateClass([Q("t-icon-filter-1")], Filter1Icon);
