...
var FilterClearIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FilterClearIcon, _IconBase);
  var _super = _createSuper(FilterClearIcon);
  function FilterClearIcon() {
    var _this;
    _classCallCheck(this, FilterClearIcon);
  ...
  return _createClass(FilterClearIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FilterClearIcon = __decorateClass([Q("t-icon-filter-clear")], FilterClearIcon);
