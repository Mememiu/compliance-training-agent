...
var Fingerprint3Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Fingerprint3Icon, _IconBase);
  var _super = _createSuper(Fingerprint3Icon);
  function Fingerprint3Icon() {
    var _this;
    _classCallCheck(this, Fingerprint3Icon);
  ...
  return _createClass(Fingerprint3Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Fingerprint3Icon = __decorateClass([Q("t-icon-fingerprint-3")], Fingerprint3Icon);
