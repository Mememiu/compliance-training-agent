...
var FingerprintIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FingerprintIcon, _IconBase);
  var _super = _createSuper(FingerprintIcon);
  function FingerprintIcon() {
    var _this;
    _classCallCheck(this, FingerprintIcon);
  ...
  return _createClass(FingerprintIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FingerprintIcon = __decorateClass([Q("t-icon-fingerprint")], FingerprintIcon);
