...
var FishIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FishIcon, _IconBase);
  var _super = _createSuper(FishIcon);
  function FishIcon() {
    var _this;
    _classCallCheck(this, FishIcon);
  ...
  return _createClass(FishIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FishIcon = __decorateClass([Q("t-icon-fish")], FishIcon);
