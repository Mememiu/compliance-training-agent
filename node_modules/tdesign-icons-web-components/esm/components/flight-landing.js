...
var FlightLandingIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FlightLandingIcon, _IconBase);
  var _super = _createSuper(FlightLandingIcon);
  function FlightLandingIcon() {
    var _this;
    _classCallCheck(this, FlightLandingIcon);
  ...
  return _createClass(FlightLandingIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FlightLandingIcon = __decorateClass([Q("t-icon-flight-landing")], FlightLandingIcon);
