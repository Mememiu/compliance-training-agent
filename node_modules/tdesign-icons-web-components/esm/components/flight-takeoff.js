...
var FlightTakeoffIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FlightTakeoffIcon, _IconBase);
  var _super = _createSuper(FlightTakeoffIcon);
  function FlightTakeoffIcon() {
    var _this;
    _classCallCheck(this, FlightTakeoffIcon);
  ...
  return _createClass(FlightTakeoffIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FlightTakeoffIcon = __decorateClass([Q("t-icon-flight-takeoff")], FlightTakeoffIcon);
