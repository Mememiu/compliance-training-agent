...
var FogNightIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FogNightIcon, _IconBase);
  var _super = _createSuper(FogNightIcon);
  function FogNightIcon() {
    var _this;
    _classCallCheck(this, FogNightIcon);
  ...
  return _createClass(FogNightIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FogNightIcon = __decorateClass([Q("t-icon-fog-night")], FogNightIcon);
