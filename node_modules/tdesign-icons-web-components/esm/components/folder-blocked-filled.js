...
var FolderBlockedFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FolderBlockedFilledIcon, _IconBase);
  var _super = _createSuper(FolderBlockedFilledIcon);
  function FolderBlockedFilledIcon() {
    var _this;
    _classCallCheck(this, FolderBlockedFilledIcon);
  ...
  return _createClass(FolderBlockedFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FolderBlockedFilledIcon = __decorateClass([Q("t-icon-folder-blocked-filled")], FolderBlockedFilledIcon);
