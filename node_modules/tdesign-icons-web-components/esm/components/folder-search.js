...
var FolderSearchIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FolderSearchIcon, _IconBase);
  var _super = _createSuper(FolderSearchIcon);
  function FolderSearchIcon() {
    var _this;
    _classCallCheck(this, FolderSearchIcon);
  ...
  return _createClass(FolderSearchIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FolderSearchIcon = __decorateClass([Q("t-icon-folder-search")], FolderSearchIcon);
