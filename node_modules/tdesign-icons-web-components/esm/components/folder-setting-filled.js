...
var FolderSettingFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FolderSettingFilledIcon, _IconBase);
  var _super = _createSuper(FolderSettingFilledIcon);
  function FolderSettingFilledIcon() {
    var _this;
    _classCallCheck(this, FolderSettingFilledIcon);
  ...
  return _createClass(FolderSettingFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FolderSettingFilledIcon = __decorateClass([Q("t-icon-folder-setting-filled")], FolderSettingFilledIcon);
