...
var FolderSharedIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FolderSharedIcon, _IconBase);
  var _super = _createSuper(FolderSharedIcon);
  function FolderSharedIcon() {
    var _this;
    _classCallCheck(this, FolderSharedIcon);
  ...
  return _createClass(FolderSharedIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FolderSharedIcon = __decorateClass([Q("t-icon-folder-shared")], FolderSharedIcon);
