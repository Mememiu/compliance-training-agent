...
var ForestIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ForestIcon, _IconBase);
  var _super = _createSuper(ForestIcon);
  function ForestIcon() {
    var _this;
    _classCallCheck(this, ForestIcon);
  ...
  return _createClass(ForestIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ForestIcon = __decorateClass([Q("t-icon-forest")], ForestIcon);
