...
var FriesIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FriesIcon, _IconBase);
  var _super = _createSuper(FriesIcon);
  function FriesIcon() {
    var _this;
    _classCallCheck(this, FriesIcon);
  ...
  return _createClass(FriesIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FriesIcon = __decorateClass([Q("t-icon-fries")], FriesIcon);
