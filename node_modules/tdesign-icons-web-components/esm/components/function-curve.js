...
var FunctionCurveIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(FunctionCurveIcon, _IconBase);
  var _super = _createSuper(FunctionCurveIcon);
  function FunctionCurveIcon() {
    var _this;
    _classCallCheck(this, FunctionCurveIcon);
  ...
  return _createClass(FunctionCurveIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
FunctionCurveIcon = __decorateClass([Q("t-icon-function-curve")], FunctionCurveIcon);
