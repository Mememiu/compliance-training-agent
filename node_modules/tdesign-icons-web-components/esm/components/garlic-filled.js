...
var GarlicFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GarlicFilledIcon, _IconBase);
  var _super = _createSuper(GarlicFilledIcon);
  function GarlicFilledIcon() {
    var _this;
    _classCallCheck(this, GarlicFilledIcon);
  ...
  return _createClass(GarlicFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GarlicFilledIcon = __decorateClass([Q("t-icon-garlic-filled")], GarlicFilledIcon);
