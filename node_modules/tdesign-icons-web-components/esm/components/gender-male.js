...
var GenderMaleIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GenderMaleIcon, _IconBase);
  var _super = _createSuper(GenderMaleIcon);
  function GenderMaleIcon() {
    var _this;
    _classCallCheck(this, GenderMaleIcon);
  ...
  return _createClass(GenderMaleIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GenderMaleIcon = __decorateClass([Q("t-icon-gender-male")], GenderMaleIcon);
