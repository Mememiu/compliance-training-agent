...
var GestureApplauseFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GestureApplauseFilledIcon, _IconBase);
  var _super = _createSuper(GestureApplauseFilledIcon);
  function GestureApplauseFilledIcon() {
    var _this;
    _classCallCheck(this, GestureApplauseFilledIcon);
  ...
  return _createClass(GestureApplauseFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GestureApplauseFilledIcon = __decorateClass([Q("t-icon-gesture-applause-filled")], GestureApplauseFilledIcon);
