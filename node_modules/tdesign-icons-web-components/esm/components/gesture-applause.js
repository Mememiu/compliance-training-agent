...
var GestureApplauseIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GestureApplauseIcon, _IconBase);
  var _super = _createSuper(GestureApplauseIcon);
  function GestureApplauseIcon() {
    var _this;
    _classCallCheck(this, GestureApplauseIcon);
  ...
  return _createClass(GestureApplauseIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GestureApplauseIcon = __decorateClass([Q("t-icon-gesture-applause")], GestureApplauseIcon);
