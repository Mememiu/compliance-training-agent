...
var GestureClickFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GestureClickFilledIcon, _IconBase);
  var _super = _createSuper(GestureClickFilledIcon);
  function GestureClickFilledIcon() {
    var _this;
    _classCallCheck(this, GestureClickFilledIcon);
  ...
  return _createClass(GestureClickFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GestureClickFilledIcon = __decorateClass([Q("t-icon-gesture-click-filled")], GestureClickFilledIcon);
