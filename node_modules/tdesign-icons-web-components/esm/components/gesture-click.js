...
var GestureClickIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GestureClickIcon, _IconBase);
  var _super = _createSuper(GestureClickIcon);
  function GestureClickIcon() {
    var _this;
    _classCallCheck(this, GestureClickIcon);
  ...
  return _createClass(GestureClickIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GestureClickIcon = __decorateClass([Q("t-icon-gesture-click")], GestureClickIcon);
