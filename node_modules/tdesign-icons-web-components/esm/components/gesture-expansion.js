...
var GestureExpansionIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GestureExpansionIcon, _IconBase);
  var _super = _createSuper(GestureExpansionIcon);
  function GestureExpansionIcon() {
    var _this;
    _classCallCheck(this, GestureExpansionIcon);
  ...
  return _createClass(GestureExpansionIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GestureExpansionIcon = __decorateClass([Q("t-icon-gesture-expansion")], GestureExpansionIcon);
