...
var GestureLeftSlipIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GestureLeftSlipIcon, _IconBase);
  var _super = _createSuper(GestureLeftSlipIcon);
  function GestureLeftSlipIcon() {
    var _this;
    _classCallCheck(this, GestureLeftSlipIcon);
  ...
  return _createClass(GestureLeftSlipIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GestureLeftSlipIcon = __decorateClass([Q("t-icon-gesture-left-slip")], GestureLeftSlipIcon);
