...
var GestureOpenFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GestureOpenFilledIcon, _IconBase);
  var _super = _createSuper(GestureOpenFilledIcon);
  function GestureOpenFilledIcon() {
    var _this;
    _classCallCheck(this, GestureOpenFilledIcon);
  ...
  return _createClass(GestureOpenFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GestureOpenFilledIcon = __decorateClass([Q("t-icon-gesture-open-filled")], GestureOpenFilledIcon);
