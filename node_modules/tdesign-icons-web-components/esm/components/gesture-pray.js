...
var GesturePrayIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GesturePrayIcon, _IconBase);
  var _super = _createSuper(GesturePrayIcon);
  function GesturePrayIcon() {
    var _this;
    _classCallCheck(this, GesturePrayIcon);
  ...
  return _createClass(GesturePrayIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GesturePrayIcon = __decorateClass([Q("t-icon-gesture-pray")], GesturePrayIcon);
