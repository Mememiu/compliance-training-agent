...
var GesturePressIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GesturePressIcon, _IconBase);
  var _super = _createSuper(GesturePressIcon);
  function GesturePressIcon() {
    var _this;
    _classCallCheck(this, GesturePressIcon);
  ...
  return _createClass(GesturePressIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GesturePressIcon = __decorateClass([Q("t-icon-gesture-press")], GesturePressIcon);
