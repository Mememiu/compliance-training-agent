...
var GestureRanslationIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GestureRanslationIcon, _IconBase);
  var _super = _createSuper(GestureRanslationIcon);
  function GestureRanslationIcon() {
    var _this;
    _classCallCheck(this, GestureRanslationIcon);
  ...
  return _createClass(GestureRanslationIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GestureRanslationIcon = __decorateClass([Q("t-icon-gesture-ranslation")], GestureRanslationIcon);
