...
var GestureRightIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GestureRightIcon, _IconBase);
  var _super = _createSuper(GestureRightIcon);
  function GestureRightIcon() {
    var _this;
    _classCallCheck(this, GestureRightIcon);
  ...
  return _createClass(GestureRightIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GestureRightIcon = __decorateClass([Q("t-icon-gesture-right")], GestureRightIcon);
