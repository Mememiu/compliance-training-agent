...
var GestureSlideUpFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GestureSlideUpFilledIcon, _IconBase);
  var _super = _createSuper(GestureSlideUpFilledIcon);
  function GestureSlideUpFilledIcon() {
    var _this;
    _classCallCheck(this, GestureSlideUpFilledIcon);
  ...
  return _createClass(GestureSlideUpFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GestureSlideUpFilledIcon = __decorateClass([Q("t-icon-gesture-slide-up-filled")], GestureSlideUpFilledIcon);
