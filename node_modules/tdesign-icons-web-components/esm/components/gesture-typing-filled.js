...
var GestureTypingFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GestureTypingFilledIcon, _IconBase);
  var _super = _createSuper(GestureTypingFilledIcon);
  function GestureTypingFilledIcon() {
    var _this;
    _classCallCheck(this, GestureTypingFilledIcon);
  ...
  return _createClass(GestureTypingFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GestureTypingFilledIcon = __decorateClass([Q("t-icon-gesture-typing-filled")], GestureTypingFilledIcon);
