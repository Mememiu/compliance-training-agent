...
var GestureTypingIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GestureTypingIcon, _IconBase);
  var _super = _createSuper(GestureTypingIcon);
  function GestureTypingIcon() {
    var _this;
    _classCallCheck(this, GestureTypingIcon);
  ...
  return _createClass(GestureTypingIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GestureTypingIcon = __decorateClass([Q("t-icon-gesture-typing")], GestureTypingIcon);
