...
var GestureUpAndDownFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GestureUpAndDownFilledIcon, _IconBase);
  var _super = _createSuper(GestureUpAndDownFilledIcon);
  function GestureUpAndDownFilledIcon() {
    var _this;
    _classCallCheck(this, GestureUpAndDownFilledIcon);
  ...
  return _createClass(GestureUpAndDownFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GestureUpAndDownFilledIcon = __decorateClass([Q("t-icon-gesture-up-and-down-filled")], GestureUpAndDownFilledIcon);
