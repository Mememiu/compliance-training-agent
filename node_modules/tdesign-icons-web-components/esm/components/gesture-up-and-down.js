...
var GestureUpAndDownIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GestureUpAndDownIcon, _IconBase);
  var _super = _createSuper(GestureUpAndDownIcon);
  function GestureUpAndDownIcon() {
    var _this;
    _classCallCheck(this, GestureUpAndDownIcon);
  ...
  return _createClass(GestureUpAndDownIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GestureUpAndDownIcon = __decorateClass([Q("t-icon-gesture-up-and-down")], GestureUpAndDownIcon);
