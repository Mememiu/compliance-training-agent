...
var GiftFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GiftFilledIcon, _IconBase);
  var _super = _createSuper(GiftFilledIcon);
  function GiftFilledIcon() {
    var _this;
    _classCallCheck(this, GiftFilledIcon);
  ...
  return _createClass(GiftFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GiftFilledIcon = __decorateClass([Q("t-icon-gift-filled")], GiftFilledIcon);
