...
var GiftIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GiftIcon, _IconBase);
  ...
  return _createClass(GiftIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GiftIcon = __decorateClass([Q("t-icon-gift")], GiftIcon);
