...
var GitBranchFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GitBranchFilledIcon, _IconBase);
  var _super = _createSuper(GitBranchFilledIcon);
  function GitBranchFilledIcon() {
    var _this;
    _classCallCheck(this, GitBranchFilledIcon);
  ...
  return _createClass(GitBranchFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GitBranchFilledIcon = __decorateClass([Q("t-icon-git-branch-filled")], GitBranchFilledIcon);
