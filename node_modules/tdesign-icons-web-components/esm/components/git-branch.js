...
var GitBranchIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GitBranchIcon, _IconBase);
  var _super = _createSuper(GitBranchIcon);
  function GitBranchIcon() {
    var _this;
    _classCallCheck(this, GitBranchIcon);
  ...
  return _createClass(GitBranchIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GitBranchIcon = __decorateClass([Q("t-icon-git-branch")], GitBranchIcon);
