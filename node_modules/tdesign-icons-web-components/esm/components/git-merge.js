...
var GitMergeIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GitMergeIcon, _IconBase);
  var _super = _createSuper(GitMergeIcon);
  ...
  return _createClass(GitMergeIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GitMergeIcon = __decorateClass([Q("t-icon-git-merge")], GitMergeIcon);
