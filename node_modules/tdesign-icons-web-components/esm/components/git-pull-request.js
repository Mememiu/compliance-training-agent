...
var GitPullRequestIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GitPullRequestIcon, _IconBase);
  var _super = _createSuper(GitPullRequestIcon);
  function GitPullRequestIcon() {
    var _this;
    _classCallCheck(this, GitPullRequestIcon);
  ...
  return _createClass(GitPullRequestIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GitPullRequestIcon = __decorateClass([Q("t-icon-git-pull-request")], GitPullRequestIcon);
