...
var GpsIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GpsIcon, _IconBase);
  var _super = _createSuper(GpsIcon);
  function GpsIcon() {
    var _this;
    _classCallCheck(this, GpsIcon);
  ...
  return _createClass(GpsIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GpsIcon = __decorateClass([Q("t-icon-gps")], GpsIcon);
