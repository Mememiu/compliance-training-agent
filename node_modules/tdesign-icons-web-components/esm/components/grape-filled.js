...
var GrapeFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GrapeFilledIcon, _IconBase);
  var _super = _createSuper(GrapeFilledIcon);
  function GrapeFilledIcon() {
    var _this;
    _classCallCheck(this, GrapeFilledIcon);
  ...
  return _createClass(GrapeFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GrapeFilledIcon = __decorateClass([Q("t-icon-grape-filled")], GrapeFilledIcon);
