...
var GrapeIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GrapeIcon, _IconBase);
  var _super = _createSuper(GrapeIcon);
  function GrapeIcon() {
    var _this;
    _classCallCheck(this, GrapeIcon);
  ...
  return _createClass(GrapeIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GrapeIcon = __decorateClass([Q("t-icon-grape")], GrapeIcon);
