...
var GuitarFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GuitarFilledIcon, _IconBase);
  var _super = _createSuper(GuitarFilledIcon);
  function GuitarFilledIcon() {
    var _this;
    _classCallCheck(this, GuitarFilledIcon);
  ...
  return _createClass(GuitarFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GuitarFilledIcon = __decorateClass([Q("t-icon-guitar-filled")], GuitarFilledIcon);
