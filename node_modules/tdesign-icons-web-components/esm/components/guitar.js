...
var GuitarIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(GuitarIcon, _IconBase);
  var _super = _createSuper(GuitarIcon);
  function GuitarIcon() {
    var _this;
    _classCallCheck(this, GuitarIcon);
  ...
  return _createClass(GuitarIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
GuitarIcon = __decorateClass([Q("t-icon-guitar")], GuitarIcon);
