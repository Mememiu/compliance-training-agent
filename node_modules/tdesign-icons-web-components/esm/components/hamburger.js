...
var HamburgerIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(HamburgerIcon, _IconBase);
  var _super = _createSuper(HamburgerIcon);
  function HamburgerIcon() {
    var _this;
    _classCallCheck(this, HamburgerIcon);
  ...
  return _createClass(HamburgerIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
HamburgerIcon = __decorateClass([Q("t-icon-hamburger")], HamburgerIcon);
