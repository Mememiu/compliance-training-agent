...
var HashtagIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(HashtagIcon, _IconBase);
  var _super = _createSuper(HashtagIcon);
  function HashtagIcon() {
    var _this;
    _classCallCheck(this, HashtagIcon);
  ...
  return _createClass(HashtagIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
HashtagIcon = __decorateClass([Q("t-icon-hashtag")], HashtagIcon);
