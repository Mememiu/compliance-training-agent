...
var HeartIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(HeartIcon, _IconBase);
  var _super = _createSuper(HeartIcon);
  function HeartIcon() {
    var _this;
    _classCallCheck(this, HeartIcon);
  ...
  return _createClass(HeartIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
HeartIcon = __decorateClass([Q("t-icon-heart")], HeartIcon);
