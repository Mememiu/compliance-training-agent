...
var HelpCircleIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(HelpCircleIcon, _IconBase);
  var _super = _createSuper(HelpCircleIcon);
  function HelpCircleIcon() {
    var _this;
    _classCallCheck(this, HelpCircleIcon);
  ...
  return _createClass(HelpCircleIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
HelpCircleIcon = __decorateClass([Q("t-icon-help-circle")], HelpCircleIcon);
