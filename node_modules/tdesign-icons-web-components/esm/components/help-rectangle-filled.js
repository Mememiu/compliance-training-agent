...
var HelpRectangleFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(HelpRectangleFilledIcon, _IconBase);
  var _super = _createSuper(HelpRectangleFilledIcon);
  function HelpRectangleFilledIcon() {
    var _this;
    _classCallCheck(this, HelpRectangleFilledIcon);
  ...
  return _createClass(HelpRectangleFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
HelpRectangleFilledIcon = __decorateClass([Q("t-icon-help-rectangle-filled")], HelpRectangleFilledIcon);
