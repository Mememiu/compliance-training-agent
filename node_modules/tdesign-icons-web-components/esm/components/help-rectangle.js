...
var HelpRectangleIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(HelpRectangleIcon, _IconBase);
  var _super = _createSuper(HelpRectangleIcon);
  function HelpRectangleIcon() {
    var _this;
    _classCallCheck(this, HelpRectangleIcon);
  ...
  return _createClass(HelpRectangleIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
HelpRectangleIcon = __decorateClass([Q("t-icon-help-rectangle")], HelpRectangleIcon);
