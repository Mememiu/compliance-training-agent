...
var HourglassFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(HourglassFilledIcon, _IconBase);
  var _super = _createSuper(HourglassFilledIcon);
  function HourglassFilledIcon() {
    var _this;
    _classCallCheck(this, HourglassFilledIcon);
  ...
  return _createClass(HourglassFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
HourglassFilledIcon = __decorateClass([Q("t-icon-hourglass-filled")], HourglassFilledIcon);
