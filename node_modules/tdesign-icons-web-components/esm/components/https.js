...
var HttpsIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(HttpsIcon, _IconBase);
  var _super = _createSuper(HttpsIcon);
  function HttpsIcon() {
    var _this;
    _classCallCheck(this, HttpsIcon);
  ...
  return _createClass(HttpsIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
HttpsIcon = __decorateClass([Q("t-icon-https")], HttpsIcon);
