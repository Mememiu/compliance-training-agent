...
var IceCreamFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(IceCreamFilledIcon, _IconBase);
  var _super = _createSuper(IceCreamFilledIcon);
  function IceCreamFilledIcon() {
    var _this;
    _classCallCheck(this, IceCreamFilledIcon);
  ...
  return _createClass(IceCreamFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
IceCreamFilledIcon = __decorateClass([Q("t-icon-ice-cream-filled")], IceCreamFilledIcon);
