...
var IceCreamIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(IceCreamIcon, _IconBase);
  var _super = _createSuper(IceCreamIcon);
  function IceCreamIcon() {
    var _this;
    _classCallCheck(this, IceCreamIcon);
  ...
  return _createClass(IceCreamIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
IceCreamIcon = __decorateClass([Q("t-icon-ice-cream")], IceCreamIcon);
