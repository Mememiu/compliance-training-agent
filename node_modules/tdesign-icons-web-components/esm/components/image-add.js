...
var ImageAddIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ImageAddIcon, _IconBase);
  var _super = _createSuper(ImageAddIcon);
  function ImageAddIcon() {
    var _this;
    _classCallCheck(this, ImageAddIcon);
  ...
  return _createClass(ImageAddIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ImageAddIcon = __decorateClass([Q("t-icon-image-add")], ImageAddIcon);
