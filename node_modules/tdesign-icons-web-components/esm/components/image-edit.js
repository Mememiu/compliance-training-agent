...
var ImageEditIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ImageEditIcon, _IconBase);
  var _super = _createSuper(ImageEditIcon);
  function ImageEditIcon() {
    var _this;
    _classCallCheck(this, ImageEditIcon);
  ...
  return _createClass(ImageEditIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ImageEditIcon = __decorateClass([Q("t-icon-image-edit")], ImageEditIcon);
