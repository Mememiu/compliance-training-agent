...
var ImageSearchIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ImageSearchIcon, _IconBase);
  var _super = _createSuper(ImageSearchIcon);
  function ImageSearchIcon() {
    var _this;
    _classCallCheck(this, ImageSearchIcon);
  ...
  return _createClass(ImageSearchIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ImageSearchIcon = __decorateClass([Q("t-icon-image-search")], ImageSearchIcon);
