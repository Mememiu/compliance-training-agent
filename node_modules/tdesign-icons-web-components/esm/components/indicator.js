...
var IndicatorIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(IndicatorIcon, _IconBase);
  var _super = _createSuper(IndicatorIcon);
  function IndicatorIcon() {
    var _this;
    _classCallCheck(this, IndicatorIcon);
  ...
  return _createClass(IndicatorIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
IndicatorIcon = __decorateClass([Q("t-icon-indicator")], IndicatorIcon);
