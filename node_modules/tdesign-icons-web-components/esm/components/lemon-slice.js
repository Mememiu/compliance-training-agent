...
var LemonSliceIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LemonSliceIcon, _IconBase);
  var _super = _createSuper(LemonSliceIcon);
  function LemonSliceIcon() {
    var _this;
    _classCallCheck(this, LemonSliceIcon);
  ...
  return _createClass(LemonSliceIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LemonSliceIcon = __decorateClass([Q("t-icon-lemon-slice")], LemonSliceIcon);
