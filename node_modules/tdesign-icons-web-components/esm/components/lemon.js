...
var LemonIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LemonIcon, _IconBase);
  var _super = _createSuper(LemonIcon);
  function LemonIcon() {
    var _this;
    _classCallCheck(this, LemonIcon);
  ...
  return _createClass(LemonIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LemonIcon = __decorateClass([Q("t-icon-lemon")], LemonIcon);
