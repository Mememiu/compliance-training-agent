...
var LightbulbCircleIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LightbulbCircleIcon, _IconBase);
  var _super = _createSuper(LightbulbCircleIcon);
  function LightbulbCircleIcon() {
    var _this;
    _classCallCheck(this, LightbulbCircleIcon);
  ...
  return _createClass(LightbulbCircleIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LightbulbCircleIcon = __decorateClass([Q("t-icon-lightbulb-circle")], LightbulbCircleIcon);
