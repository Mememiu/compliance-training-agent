...
var LightbulbIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LightbulbIcon, _IconBase);
  var _super = _createSuper(LightbulbIcon);
  function LightbulbIcon() {
    var _this;
    _classCallCheck(this, LightbulbIcon);
  ...
  return _createClass(LightbulbIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LightbulbIcon = __decorateClass([Q("t-icon-lightbulb")], LightbulbIcon);
