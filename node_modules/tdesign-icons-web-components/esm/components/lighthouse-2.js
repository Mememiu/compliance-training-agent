...
var Lighthouse2Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Lighthouse2Icon, _IconBase);
  var _super = _createSuper(Lighthouse2Icon);
  function Lighthouse2Icon() {
    var _this;
    _classCallCheck(this, Lighthouse2Icon);
  ...
  return _createClass(Lighthouse2Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Lighthouse2Icon = __decorateClass([Q("t-icon-lighthouse-2")], Lighthouse2Icon);
