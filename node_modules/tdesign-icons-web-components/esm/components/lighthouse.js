...
var LighthouseIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LighthouseIcon, _IconBase);
  var _super = _createSuper(LighthouseIcon);
  function LighthouseIcon() {
    var _this;
    _classCallCheck(this, LighthouseIcon);
  ...
  return _createClass(LighthouseIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LighthouseIcon = __decorateClass([Q("t-icon-lighthouse")], LighthouseIcon);
