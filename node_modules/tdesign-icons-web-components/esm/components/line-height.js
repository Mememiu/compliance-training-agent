...
var LineHeightIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LineHeightIcon, _IconBase);
  var _super = _createSuper(LineHeightIcon);
  function LineHeightIcon() {
    var _this;
    _classCallCheck(this, LineHeightIcon);
  ...
  return _createClass(LineHeightIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LineHeightIcon = __decorateClass([Q("t-icon-line-height")], LineHeightIcon);
