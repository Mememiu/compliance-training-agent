...
var LinkUnlinkIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LinkUnlinkIcon, _IconBase);
  var _super = _createSuper(LinkUnlinkIcon);
  function LinkUnlinkIcon() {
    var _this;
    _classCallCheck(this, LinkUnlinkIcon);
  ...
  return _createClass(LinkUnlinkIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LinkUnlinkIcon = __decorateClass([Q("t-icon-link-unlink")], LinkUnlinkIcon);
