...
var LinkIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LinkIcon, _IconBase);
  var _super = _createSuper(LinkIcon);
  function LinkIcon() {
    var _this;
  ...
  return _createClass(LinkIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LinkIcon = __decorateClass([Q("t-icon-link")], LinkIcon);
