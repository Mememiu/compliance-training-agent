...
var ListNumberedIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ListNumberedIcon, _IconBase);
  var _super = _createSuper(ListNumberedIcon);
  function ListNumberedIcon() {
    var _this;
    _classCallCheck(this, ListNumberedIcon);
  ...
  return _createClass(ListNumberedIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ListNumberedIcon = __decorateClass([Q("t-icon-list-numbered")], ListNumberedIcon);
