...
var Location1Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Location1Icon, _IconBase);
  var _super = _createSuper(Location1Icon);
  function Location1Icon() {
    var _this;
    _classCallCheck(this, Location1Icon);
  ...
  return _createClass(Location1Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Location1Icon = __decorateClass([Q("t-icon-location-1")], Location1Icon);
