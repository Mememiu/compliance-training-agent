...
var LocationEnlargementIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LocationEnlargementIcon, _IconBase);
  var _super = _createSuper(LocationEnlargementIcon);
  function LocationEnlargementIcon() {
    var _this;
    _classCallCheck(this, LocationEnlargementIcon);
  ...
  return _createClass(LocationEnlargementIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LocationEnlargementIcon = __decorateClass([Q("t-icon-location-enlargement")], LocationEnlargementIcon);
