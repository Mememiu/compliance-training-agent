...
var LocationErrorIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LocationErrorIcon, _IconBase);
  var _super = _createSuper(LocationErrorIcon);
  function LocationErrorIcon() {
    var _this;
    _classCallCheck(this, LocationErrorIcon);
  ...
  return _createClass(LocationErrorIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LocationErrorIcon = __decorateClass([Q("t-icon-location-error")], LocationErrorIcon);
