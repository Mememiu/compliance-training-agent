...
var LocationParkingPlaceFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LocationParkingPlaceFilledIcon, _IconBase);
  var _super = _createSuper(LocationParkingPlaceFilledIcon);
  function LocationParkingPlaceFilledIcon() {
    var _this;
    _classCallCheck(this, LocationParkingPlaceFilledIcon);
  ...
  return _createClass(LocationParkingPlaceFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LocationParkingPlaceFilledIcon = __decorateClass([Q("t-icon-location-parking-place-filled")], LocationParkingPlaceFilledIcon);
