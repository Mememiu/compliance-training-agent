...
var LocationReductionIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LocationReductionIcon, _IconBase);
  var _super = _createSuper(LocationReductionIcon);
  function LocationReductionIcon() {
    var _this;
    _classCallCheck(this, LocationReductionIcon);
  ...
  return _createClass(LocationReductionIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LocationReductionIcon = __decorateClass([Q("t-icon-location-reduction")], LocationReductionIcon);
