...
var LocationSettingIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LocationSettingIcon, _IconBase);
  var _super = _createSuper(LocationSettingIcon);
  function LocationSettingIcon() {
    var _this;
    _classCallCheck(this, LocationSettingIcon);
  ...
  return _createClass(LocationSettingIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LocationSettingIcon = __decorateClass([Q("t-icon-location-setting")], LocationSettingIcon);
