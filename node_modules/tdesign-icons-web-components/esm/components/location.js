...
var LocationIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LocationIcon, _IconBase);
  ...
  return _createClass(LocationIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LocationIcon = __decorateClass([Q("t-icon-location")], LocationIcon);
