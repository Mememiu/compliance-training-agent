...
var LogoAlipayFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LogoAlipayFilledIcon, _IconBase);
  var _super = _createSuper(LogoAlipayFilledIcon);
  function LogoAlipayFilledIcon() {
    var _this;
    _classCallCheck(this, LogoAlipayFilledIcon);
  ...
  return _createClass(LogoAlipayFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LogoAlipayFilledIcon = __decorateClass([Q("t-icon-logo-alipay-filled")], LogoAlipayFilledIcon);
