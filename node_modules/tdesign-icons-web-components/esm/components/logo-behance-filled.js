...
var LogoBehanceFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LogoBehanceFilledIcon, _IconBase);
  var _super = _createSuper(LogoBehanceFilledIcon);
  function LogoBehanceFilledIcon() {
    var _this;
    _classCallCheck(this, LogoBehanceFilledIcon);
  ...
  return _createClass(LogoBehanceFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LogoBehanceFilledIcon = __decorateClass([Q("t-icon-logo-behance-filled")], LogoBehanceFilledIcon);
