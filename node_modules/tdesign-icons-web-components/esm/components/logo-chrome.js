...
var LogoChromeIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LogoChromeIcon, _IconBase);
  var _super = _createSuper(LogoChromeIcon);
  function LogoChromeIcon() {
    var _this;
    _classCallCheck(this, LogoChromeIcon);
  ...
  return _createClass(LogoChromeIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LogoChromeIcon = __decorateClass([Q("t-icon-logo-chrome")], LogoChromeIcon);
