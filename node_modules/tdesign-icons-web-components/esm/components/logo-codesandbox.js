...
var LogoCodesandboxIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LogoCodesandboxIcon, _IconBase);
  var _super = _createSuper(LogoCodesandboxIcon);
  function LogoCodesandboxIcon() {
    var _this;
    _classCallCheck(this, LogoCodesandboxIcon);
  ...
  return _createClass(LogoCodesandboxIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LogoCodesandboxIcon = __decorateClass([Q("t-icon-logo-codesandbox")], LogoCodesandboxIcon);
