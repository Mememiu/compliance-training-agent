...
var LogoDribbbleIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LogoDribbbleIcon, _IconBase);
  var _super = _createSuper(LogoDribbbleIcon);
  function LogoDribbbleIcon() {
    var _this;
    _classCallCheck(this, LogoDribbbleIcon);
  ...
  return _createClass(LogoDribbbleIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LogoDribbbleIcon = __decorateClass([Q("t-icon-logo-dribbble")], LogoDribbbleIcon);
