...
var LogoFigmaIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LogoFigmaIcon, _IconBase);
  var _super = _createSuper(LogoFigmaIcon);
  function LogoFigmaIcon() {
    var _this;
    _classCallCheck(this, LogoFigmaIcon);
  ...
  return _createClass(LogoFigmaIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LogoFigmaIcon = __decorateClass([Q("t-icon-logo-figma")], LogoFigmaIcon);
