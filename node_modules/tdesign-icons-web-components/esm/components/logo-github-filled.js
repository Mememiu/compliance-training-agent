...
var LogoGithubFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LogoGithubFilledIcon, _IconBase);
  var _super = _createSuper(LogoGithubFilledIcon);
  function LogoGithubFilledIcon() {
    var _this;
    _classCallCheck(this, LogoGithubFilledIcon);
  ...
  return _createClass(LogoGithubFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LogoGithubFilledIcon = __decorateClass([Q("t-icon-logo-github-filled")], LogoGithubFilledIcon);
