...
var LogoGithubIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LogoGithubIcon, _IconBase);
  var _super = _createSuper(LogoGithubIcon);
  function LogoGithubIcon() {
    var _this;
    _classCallCheck(this, LogoGithubIcon);
  ...
  return _createClass(LogoGithubIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LogoGithubIcon = __decorateClass([Q("t-icon-logo-github")], LogoGithubIcon);
