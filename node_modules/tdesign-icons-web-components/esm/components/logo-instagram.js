...
var LogoInstagramIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LogoInstagramIcon, _IconBase);
  var _super = _createSuper(LogoInstagramIcon);
  function LogoInstagramIcon() {
    var _this;
    _classCallCheck(this, LogoInstagramIcon);
  ...
  return _createClass(LogoInstagramIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LogoInstagramIcon = __decorateClass([Q("t-icon-logo-instagram")], LogoInstagramIcon);
