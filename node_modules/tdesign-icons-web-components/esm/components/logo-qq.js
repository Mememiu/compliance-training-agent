...
var LogoQqIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LogoQqIcon, _IconBase);
  var _super = _createSuper(LogoQqIcon);
  function LogoQqIcon() {
    var _this;
    _classCallCheck(this, LogoQqIcon);
  ...
  return _createClass(LogoQqIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LogoQqIcon = __decorateClass([Q("t-icon-logo-qq")], LogoQqIcon);
