...
var LogoTwitterFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LogoTwitterFilledIcon, _IconBase);
  var _super = _createSuper(LogoTwitterFilledIcon);
  function LogoTwitterFilledIcon() {
    var _this;
    _classCallCheck(this, LogoTwitterFilledIcon);
  ...
  return _createClass(LogoTwitterFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LogoTwitterFilledIcon = __decorateClass([Q("t-icon-logo-twitter-filled")], LogoTwitterFilledIcon);
