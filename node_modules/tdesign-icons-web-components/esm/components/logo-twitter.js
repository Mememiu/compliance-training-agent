...
var LogoTwitterIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LogoTwitterIcon, _IconBase);
  var _super = _createSuper(LogoTwitterIcon);
  function LogoTwitterIcon() {
    var _this;
    _classCallCheck(this, LogoTwitterIcon);
  ...
  return _createClass(LogoTwitterIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LogoTwitterIcon = __decorateClass([Q("t-icon-logo-twitter")], LogoTwitterIcon);
