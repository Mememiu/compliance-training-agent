...
var LogoWechatStrokeFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LogoWechatStrokeFilledIcon, _IconBase);
  var _super = _createSuper(LogoWechatStrokeFilledIcon);
  function LogoWechatStrokeFilledIcon() {
    var _this;
    _classCallCheck(this, LogoWechatStrokeFilledIcon);
  ...
  return _createClass(LogoWechatStrokeFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LogoWechatStrokeFilledIcon = __decorateClass([Q("t-icon-logo-wechat-stroke-filled")], LogoWechatStrokeFilledIcon);
