...
var LogoWechatStrokeIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LogoWechatStrokeIcon, _IconBase);
  var _super = _createSuper(LogoWechatStrokeIcon);
  function LogoWechatStrokeIcon() {
    var _this;
    _classCallCheck(this, LogoWechatStrokeIcon);
  ...
  return _createClass(LogoWechatStrokeIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LogoWechatStrokeIcon = __decorateClass([Q("t-icon-logo-wechat-stroke")], LogoWechatStrokeIcon);
