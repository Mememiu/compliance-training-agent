...
var LogoWecomIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LogoWecomIcon, _IconBase);
  var _super = _createSuper(LogoWecomIcon);
  function LogoWecomIcon() {
    var _this;
    _classCallCheck(this, LogoWecomIcon);
  ...
  return _createClass(LogoWecomIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LogoWecomIcon = __decorateClass([Q("t-icon-logo-wecom")], LogoWecomIcon);
