...
var LogoYoutubeFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LogoYoutubeFilledIcon, _IconBase);
  var _super = _createSuper(LogoYoutubeFilledIcon);
  function LogoYoutubeFilledIcon() {
    var _this;
    _classCallCheck(this, LogoYoutubeFilledIcon);
  ...
  return _createClass(LogoYoutubeFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LogoYoutubeFilledIcon = __decorateClass([Q("t-icon-logo-youtube-filled")], LogoYoutubeFilledIcon);
