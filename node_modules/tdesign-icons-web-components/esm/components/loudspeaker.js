...
var LoudspeakerIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(LoudspeakerIcon, _IconBase);
  var _super = _createSuper(LoudspeakerIcon);
  function LoudspeakerIcon() {
    var _this;
    _classCallCheck(this, LoudspeakerIcon);
  ...
  return _createClass(LoudspeakerIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
LoudspeakerIcon = __decorateClass([Q("t-icon-loudspeaker")], LoudspeakerIcon);
