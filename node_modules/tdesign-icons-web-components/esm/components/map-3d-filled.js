...
var Map3DFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Map3DFilledIcon, _IconBase);
  var _super = _createSuper(Map3DFilledIcon);
  function Map3DFilledIcon() {
    var _this;
    _classCallCheck(this, Map3DFilledIcon);
  ...
  return _createClass(Map3DFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Map3DFilledIcon = __decorateClass([Q("t-icon-map-3d-filled")], Map3DFilledIcon);
