...
var Map3DIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Map3DIcon, _IconBase);
  var _super = _createSuper(Map3DIcon);
  function Map3DIcon() {
    var _this;
    _classCallCheck(this, Map3DIcon);
  ...
  return _createClass(Map3DIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Map3DIcon = __decorateClass([Q("t-icon-map-3d")], Map3DIcon);
