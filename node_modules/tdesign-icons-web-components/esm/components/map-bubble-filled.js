...
var MapBubbleFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MapBubbleFilledIcon, _IconBase);
  var _super = _createSuper(MapBubbleFilledIcon);
  function MapBubbleFilledIcon() {
    var _this;
    _classCallCheck(this, MapBubbleFilledIcon);
  ...
  return _createClass(MapBubbleFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MapBubbleFilledIcon = __decorateClass([Q("t-icon-map-bubble-filled")], MapBubbleFilledIcon);
