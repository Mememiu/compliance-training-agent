...
var MapBubbleIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MapBubbleIcon, _IconBase);
  var _super = _createSuper(MapBubbleIcon);
  function MapBubbleIcon() {
    var _this;
    _classCallCheck(this, MapBubbleIcon);
  ...
  return _createClass(MapBubbleIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MapBubbleIcon = __decorateClass([Q("t-icon-map-bubble")], MapBubbleIcon);
