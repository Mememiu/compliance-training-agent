...
var MapCheckedFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MapCheckedFilledIcon, _IconBase);
  var _super = _createSuper(MapCheckedFilledIcon);
  function MapCheckedFilledIcon() {
    var _this;
    _classCallCheck(this, MapCheckedFilledIcon);
  ...
  return _createClass(MapCheckedFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MapCheckedFilledIcon = __decorateClass([Q("t-icon-map-checked-filled")], MapCheckedFilledIcon);
