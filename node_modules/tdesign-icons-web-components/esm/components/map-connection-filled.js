...
var MapConnectionFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MapConnectionFilledIcon, _IconBase);
  var _super = _createSuper(MapConnectionFilledIcon);
  function MapConnectionFilledIcon() {
    var _this;
    _classCallCheck(this, MapConnectionFilledIcon);
  ...
  return _createClass(MapConnectionFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MapConnectionFilledIcon = __decorateClass([Q("t-icon-map-connection-filled")], MapConnectionFilledIcon);
