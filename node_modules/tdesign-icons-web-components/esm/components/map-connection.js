...
var MapConnectionIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MapConnectionIcon, _IconBase);
  var _super = _createSuper(MapConnectionIcon);
  function MapConnectionIcon() {
    var _this;
    _classCallCheck(this, MapConnectionIcon);
  ...
  return _createClass(MapConnectionIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MapConnectionIcon = __decorateClass([Q("t-icon-map-connection")], MapConnectionIcon);
