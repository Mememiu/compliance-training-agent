...
var MapDistanceFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MapDistanceFilledIcon, _IconBase);
  var _super = _createSuper(MapDistanceFilledIcon);
  function MapDistanceFilledIcon() {
    var _this;
    _classCallCheck(this, MapDistanceFilledIcon);
  ...
  return _createClass(MapDistanceFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MapDistanceFilledIcon = __decorateClass([Q("t-icon-map-distance-filled")], MapDistanceFilledIcon);
