...
var MapDistanceIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MapDistanceIcon, _IconBase);
  var _super = _createSuper(MapDistanceIcon);
  function MapDistanceIcon() {
    var _this;
    _classCallCheck(this, MapDistanceIcon);
  ...
  return _createClass(MapDistanceIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MapDistanceIcon = __decorateClass([Q("t-icon-map-distance")], MapDistanceIcon);
