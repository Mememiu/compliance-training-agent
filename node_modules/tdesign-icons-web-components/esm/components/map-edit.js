...
var MapEditIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MapEditIcon, _IconBase);
  var _super = _createSuper(MapEditIcon);
  function MapEditIcon() {
    var _this;
    _classCallCheck(this, MapEditIcon);
  ...
  return _createClass(MapEditIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MapEditIcon = __decorateClass([Q("t-icon-map-edit")], MapEditIcon);
