...
var MapInformation1Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MapInformation1Icon, _IconBase);
  var _super = _createSuper(MapInformation1Icon);
  function MapInformation1Icon() {
    var _this;
    _classCallCheck(this, MapInformation1Icon);
  ...
  return _createClass(MapInformation1Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MapInformation1Icon = __decorateClass([Q("t-icon-map-information-1")], MapInformation1Icon);
