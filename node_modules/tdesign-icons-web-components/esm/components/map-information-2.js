...
var MapInformation2Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MapInformation2Icon, _IconBase);
  var _super = _createSuper(MapInformation2Icon);
  function MapInformation2Icon() {
    var _this;
    _classCallCheck(this, MapInformation2Icon);
  ...
  return _createClass(MapInformation2Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MapInformation2Icon = __decorateClass([Q("t-icon-map-information-2")], MapInformation2Icon);
