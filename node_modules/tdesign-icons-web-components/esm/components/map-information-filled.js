...
var MapInformationFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MapInformationFilledIcon, _IconBase);
  var _super = _createSuper(MapInformationFilledIcon);
  function MapInformationFilledIcon() {
    var _this;
    _classCallCheck(this, MapInformationFilledIcon);
  ...
  return _createClass(MapInformationFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MapInformationFilledIcon = __decorateClass([Q("t-icon-map-information-filled")], MapInformationFilledIcon);
