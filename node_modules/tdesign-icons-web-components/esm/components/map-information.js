...
var MapInformationIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MapInformationIcon, _IconBase);
  var _super = _createSuper(MapInformationIcon);
  function MapInformationIcon() {
    var _this;
    _classCallCheck(this, MapInformationIcon);
  ...
  return _createClass(MapInformationIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MapInformationIcon = __decorateClass([Q("t-icon-map-information")], MapInformationIcon);
