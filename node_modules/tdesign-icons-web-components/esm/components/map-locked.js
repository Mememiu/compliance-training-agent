...
var MapLockedIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MapLockedIcon, _IconBase);
  var _super = _createSuper(MapLockedIcon);
  function MapLockedIcon() {
    var _this;
    _classCallCheck(this, MapLockedIcon);
  ...
  return _createClass(MapLockedIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MapLockedIcon = __decorateClass([Q("t-icon-map-locked")], MapLockedIcon);
