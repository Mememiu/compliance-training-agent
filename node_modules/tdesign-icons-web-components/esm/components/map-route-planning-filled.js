...
var MapRoutePlanningFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MapRoutePlanningFilledIcon, _IconBase);
  var _super = _createSuper(MapRoutePlanningFilledIcon);
  function MapRoutePlanningFilledIcon() {
    var _this;
    _classCallCheck(this, MapRoutePlanningFilledIcon);
  ...
  return _createClass(MapRoutePlanningFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MapRoutePlanningFilledIcon = __decorateClass([Q("t-icon-map-route-planning-filled")], MapRoutePlanningFilledIcon);
