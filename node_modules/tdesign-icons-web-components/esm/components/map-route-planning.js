...
var MapRoutePlanningIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MapRoutePlanningIcon, _IconBase);
  var _super = _createSuper(MapRoutePlanningIcon);
  function MapRoutePlanningIcon() {
    var _this;
    _classCallCheck(this, MapRoutePlanningIcon);
  ...
  return _createClass(MapRoutePlanningIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MapRoutePlanningIcon = __decorateClass([Q("t-icon-map-route-planning")], MapRoutePlanningIcon);
