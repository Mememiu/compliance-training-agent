...
var MapSearch1FilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MapSearch1FilledIcon, _IconBase);
  var _super = _createSuper(MapSearch1FilledIcon);
  function MapSearch1FilledIcon() {
    var _this;
    _classCallCheck(this, MapSearch1FilledIcon);
  ...
  return _createClass(MapSearch1FilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MapSearch1FilledIcon = __decorateClass([Q("t-icon-map-search-1-filled")], MapSearch1FilledIcon);
