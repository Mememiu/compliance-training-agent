...
var MapSearch1Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MapSearch1Icon, _IconBase);
  var _super = _createSuper(MapSearch1Icon);
  function MapSearch1Icon() {
    var _this;
    _classCallCheck(this, MapSearch1Icon);
  ...
  return _createClass(MapSearch1Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MapSearch1Icon = __decorateClass([Q("t-icon-map-search-1")], MapSearch1Icon);
