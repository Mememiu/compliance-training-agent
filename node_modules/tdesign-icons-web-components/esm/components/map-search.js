...
var MapSearchIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MapSearchIcon, _IconBase);
  var _super = _createSuper(MapSearchIcon);
  function MapSearchIcon() {
    var _this;
    _classCallCheck(this, MapSearchIcon);
  ...
  return _createClass(MapSearchIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MapSearchIcon = __decorateClass([Q("t-icon-map-search")], MapSearchIcon);
