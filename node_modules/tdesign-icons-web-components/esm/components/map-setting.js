...
var MapSettingIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MapSettingIcon, _IconBase);
  var _super = _createSuper(MapSettingIcon);
  function MapSettingIcon() {
    var _this;
    _classCallCheck(this, MapSettingIcon);
  ...
  return _createClass(MapSettingIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MapSettingIcon = __decorateClass([Q("t-icon-map-setting")], MapSettingIcon);
