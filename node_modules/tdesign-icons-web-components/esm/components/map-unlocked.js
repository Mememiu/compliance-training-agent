...
var MapUnlockedIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MapUnlockedIcon, _IconBase);
  var _super = _createSuper(MapUnlockedIcon);
  function MapUnlockedIcon() {
    var _this;
    _classCallCheck(this, MapUnlockedIcon);
  ...
  return _createClass(MapUnlockedIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MapUnlockedIcon = __decorateClass([Q("t-icon-map-unlocked")], MapUnlockedIcon);
