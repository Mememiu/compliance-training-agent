...
var MarkupFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MarkupFilledIcon, _IconBase);
  var _super = _createSuper(MarkupFilledIcon);
  function MarkupFilledIcon() {
    var _this;
    _classCallCheck(this, MarkupFilledIcon);
  ...
  return _createClass(MarkupFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MarkupFilledIcon = __decorateClass([Q("t-icon-markup-filled")], MarkupFilledIcon);
