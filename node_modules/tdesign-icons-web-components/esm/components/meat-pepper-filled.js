...
var MeatPepperFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MeatPepperFilledIcon, _IconBase);
  var _super = _createSuper(MeatPepperFilledIcon);
  function MeatPepperFilledIcon() {
    var _this;
    _classCallCheck(this, MeatPepperFilledIcon);
  ...
  return _createClass(MeatPepperFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MeatPepperFilledIcon = __decorateClass([Q("t-icon-meat-pepper-filled")], MeatPepperFilledIcon);
