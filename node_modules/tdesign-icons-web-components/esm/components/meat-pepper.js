...
var MeatPepperIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MeatPepperIcon, _IconBase);
  var _super = _createSuper(MeatPepperIcon);
  function MeatPepperIcon() {
    var _this;
    _classCallCheck(this, MeatPepperIcon);
  ...
  return _createClass(MeatPepperIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MeatPepperIcon = __decorateClass([Q("t-icon-meat-pepper")], MeatPepperIcon);
