...
var MemberIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MemberIcon, _IconBase);
  var _super = _createSuper(MemberIcon);
  function MemberIcon() {
    var _this;
    _classCallCheck(this, MemberIcon);
  ...
  return _createClass(MemberIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MemberIcon = __decorateClass([Q("t-icon-member")], MemberIcon);
