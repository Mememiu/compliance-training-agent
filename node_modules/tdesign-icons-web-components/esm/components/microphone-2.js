...
var Microphone2Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Microphone2Icon, _IconBase);
  var _super = _createSuper(Microphone2Icon);
  function Microphone2Icon() {
    var _this;
    _classCallCheck(this, Microphone2Icon);
  ...
  return _createClass(Microphone2Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Microphone2Icon = __decorateClass([Q("t-icon-microphone-2")], Microphone2Icon);
