...
var MicrophoneIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MicrophoneIcon, _IconBase);
  var _super = _createSuper(MicrophoneIcon);
  function MicrophoneIcon() {
    var _this;
    _classCallCheck(this, MicrophoneIcon);
  ...
  return _createClass(MicrophoneIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MicrophoneIcon = __decorateClass([Q("t-icon-microphone")], MicrophoneIcon);
