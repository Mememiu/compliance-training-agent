...
var MobileBlockedIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MobileBlockedIcon, _IconBase);
  var _super = _createSuper(MobileBlockedIcon);
  function MobileBlockedIcon() {
    var _this;
    _classCallCheck(this, MobileBlockedIcon);
  ...
  return _createClass(MobileBlockedIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MobileBlockedIcon = __decorateClass([Q("t-icon-mobile-blocked")], MobileBlockedIcon);
