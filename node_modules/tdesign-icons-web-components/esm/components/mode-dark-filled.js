...
var ModeDarkFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ModeDarkFilledIcon, _IconBase);
  var _super = _createSuper(ModeDarkFilledIcon);
  function ModeDarkFilledIcon() {
    var _this;
    _classCallCheck(this, ModeDarkFilledIcon);
  ...
  return _createClass(ModeDarkFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ModeDarkFilledIcon = __decorateClass([Q("t-icon-mode-dark-filled")], ModeDarkFilledIcon);
