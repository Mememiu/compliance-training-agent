...
var ModeDarkIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ModeDarkIcon, _IconBase);
  var _super = _createSuper(ModeDarkIcon);
  function ModeDarkIcon() {
    var _this;
    _classCallCheck(this, ModeDarkIcon);
  ...
  return _createClass(ModeDarkIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ModeDarkIcon = __decorateClass([Q("t-icon-mode-dark")], ModeDarkIcon);
