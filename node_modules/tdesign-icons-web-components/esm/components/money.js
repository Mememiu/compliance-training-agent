...
var MoneyIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MoneyIcon, _IconBase);
  var _super = _createSuper(MoneyIcon);
  function MoneyIcon() {
    var _this;
    _classCallCheck(this, MoneyIcon);
  ...
  return _createClass(MoneyIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MoneyIcon = __decorateClass([Q("t-icon-money")], MoneyIcon);
