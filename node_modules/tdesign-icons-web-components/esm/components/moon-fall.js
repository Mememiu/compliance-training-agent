...
var MoonFallIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MoonFallIcon, _IconBase);
  var _super = _createSuper(MoonFallIcon);
  function MoonFallIcon() {
    var _this;
    _classCallCheck(this, MoonFallIcon);
  ...
  return _createClass(MoonFallIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MoonFallIcon = __decorateClass([Q("t-icon-moon-fall")], MoonFallIcon);
