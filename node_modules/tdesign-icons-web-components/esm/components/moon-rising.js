...
var MoonRisingIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MoonRisingIcon, _IconBase);
  var _super = _createSuper(MoonRisingIcon);
  function MoonRisingIcon() {
    var _this;
    _classCallCheck(this, MoonRisingIcon);
  ...
  return _createClass(MoonRisingIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MoonRisingIcon = __decorateClass([Q("t-icon-moon-rising")], MoonRisingIcon);
