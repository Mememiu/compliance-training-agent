...
var MoonIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MoonIcon, _IconBase);
  var _super = _createSuper(MoonIcon);
  function MoonIcon() {
    var _this;
    _classCallCheck(this, MoonIcon);
  ...
  return _createClass(MoonIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MoonIcon = __decorateClass([Q("t-icon-moon")], MoonIcon);
