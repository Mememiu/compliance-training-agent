...
var MosqueIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MosqueIcon, _IconBase);
  var _super = _createSuper(MosqueIcon);
  function MosqueIcon() {
    var _this;
    _classCallCheck(this, MosqueIcon);
  ...
  return _createClass(MosqueIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MosqueIcon = __decorateClass([Q("t-icon-mosque")], MosqueIcon);
