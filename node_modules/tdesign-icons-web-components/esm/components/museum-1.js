...
var Museum1Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Museum1Icon, _IconBase);
  var _super = _createSuper(Museum1Icon);
  function Museum1Icon() {
    var _this;
    _classCallCheck(this, Museum1Icon);
  ...
  return _createClass(Museum1Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Museum1Icon = __decorateClass([Q("t-icon-museum-1")], Museum1Icon);
