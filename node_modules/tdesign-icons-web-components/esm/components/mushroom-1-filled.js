...
var Mushroom1FilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Mushroom1FilledIcon, _IconBase);
  var _super = _createSuper(Mushroom1FilledIcon);
  function Mushroom1FilledIcon() {
    var _this;
    _classCallCheck(this, Mushroom1FilledIcon);
  ...
  return _createClass(Mushroom1FilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Mushroom1FilledIcon = __decorateClass([Q("t-icon-mushroom-1-filled")], Mushroom1FilledIcon);
