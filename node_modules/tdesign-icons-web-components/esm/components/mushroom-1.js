...
var Mushroom1Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Mushroom1Icon, _IconBase);
  var _super = _createSuper(Mushroom1Icon);
  function Mushroom1Icon() {
    var _this;
    _classCallCheck(this, Mushroom1Icon);
  ...
  return _createClass(Mushroom1Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Mushroom1Icon = __decorateClass([Q("t-icon-mushroom-1")], Mushroom1Icon);
