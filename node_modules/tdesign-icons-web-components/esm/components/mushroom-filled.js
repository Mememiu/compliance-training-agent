...
var MushroomFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MushroomFilledIcon, _IconBase);
  var _super = _createSuper(MushroomFilledIcon);
  function MushroomFilledIcon() {
    var _this;
    _classCallCheck(this, MushroomFilledIcon);
  ...
  return _createClass(MushroomFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MushroomFilledIcon = __decorateClass([Q("t-icon-mushroom-filled")], MushroomFilledIcon);
