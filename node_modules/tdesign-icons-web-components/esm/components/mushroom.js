...
var MushroomIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(MushroomIcon, _IconBase);
  var _super = _createSuper(MushroomIcon);
  function MushroomIcon() {
    var _this;
    _classCallCheck(this, MushroomIcon);
  ...
  return _createClass(MushroomIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
MushroomIcon = __decorateClass([Q("t-icon-mushroom")], MushroomIcon);
