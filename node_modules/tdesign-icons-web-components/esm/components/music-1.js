...
var Music1Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Music1Icon, _IconBase);
  var _super = _createSuper(Music1Icon);
  function Music1Icon() {
    var _this;
    _classCallCheck(this, Music1Icon);
  ...
  return _createClass(Music1Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Music1Icon = __decorateClass([Q("t-icon-music-1")], Music1Icon);
