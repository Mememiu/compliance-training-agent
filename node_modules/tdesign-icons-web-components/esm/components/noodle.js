...
var NoodleIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(NoodleIcon, _IconBase);
  var _super = _createSuper(NoodleIcon);
  function NoodleIcon() {
    var _this;
    _classCallCheck(this, NoodleIcon);
  ...
  return _createClass(NoodleIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
NoodleIcon = __decorateClass([Q("t-icon-noodle")], NoodleIcon);
