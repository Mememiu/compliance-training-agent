...
var NotificationCircleIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(NotificationCircleIcon, _IconBase);
  var _super = _createSuper(NotificationCircleIcon);
  function NotificationCircleIcon() {
    var _this;
    _classCallCheck(this, NotificationCircleIcon);
  ...
  return _createClass(NotificationCircleIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
NotificationCircleIcon = __decorateClass([Q("t-icon-notification-circle")], NotificationCircleIcon);
