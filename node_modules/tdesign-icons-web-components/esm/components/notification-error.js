...
var NotificationErrorIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(NotificationErrorIcon, _IconBase);
  var _super = _createSuper(NotificationErrorIcon);
  function NotificationErrorIcon() {
    var _this;
    _classCallCheck(this, NotificationErrorIcon);
  ...
  return _createClass(NotificationErrorIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
NotificationErrorIcon = __decorateClass([Q("t-icon-notification-error")], NotificationErrorIcon);
