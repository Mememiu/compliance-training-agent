...
var Numbers91Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Numbers91Icon, _IconBase);
  var _super = _createSuper(Numbers91Icon);
  function Numbers91Icon() {
    var _this;
    _classCallCheck(this, Numbers91Icon);
  ...
  return _createClass(Numbers91Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Numbers91Icon = __decorateClass([Q("t-icon-numbers-9-1")], Numbers91Icon);
