...
var NutFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(NutFilledIcon, _IconBase);
  var _super = _createSuper(NutFilledIcon);
  function NutFilledIcon() {
    var _this;
    _classCallCheck(this, NutFilledIcon);
  ...
  return _createClass(NutFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
NutFilledIcon = __decorateClass([Q("t-icon-nut-filled")], NutFilledIcon);
