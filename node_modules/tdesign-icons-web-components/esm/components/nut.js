...
var NutIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(NutIcon, _IconBase);
  var _super = _createSuper(NutIcon);
  function NutIcon() {
    var _this;
    _classCallCheck(this, NutIcon);
  ...
  return _createClass(NutIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
NutIcon = __decorateClass([Q("t-icon-nut")], NutIcon);
