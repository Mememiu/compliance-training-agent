...
var ObjectStorageIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ObjectStorageIcon, _IconBase);
  var _super = _createSuper(ObjectStorageIcon);
  function ObjectStorageIcon() {
    var _this;
    _classCallCheck(this, ObjectStorageIcon);
  ...
  return _createClass(ObjectStorageIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ObjectStorageIcon = __decorateClass([Q("t-icon-object-storage")], ObjectStorageIcon);
