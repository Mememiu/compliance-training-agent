...
var OperaIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(OperaIcon, _IconBase);
  var _super = _createSuper(OperaIcon);
  function OperaIcon() {
    var _this;
    _classCallCheck(this, OperaIcon);
  ...
  return _createClass(OperaIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
OperaIcon = __decorateClass([Q("t-icon-opera")], OperaIcon);
