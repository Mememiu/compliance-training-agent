...
var Palace3FilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Palace3FilledIcon, _IconBase);
  var _super = _createSuper(Palace3FilledIcon);
  function Palace3FilledIcon() {
    var _this;
    _classCallCheck(this, Palace3FilledIcon);
  ...
  return _createClass(Palace3FilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Palace3FilledIcon = __decorateClass([Q("t-icon-palace-3-filled")], Palace3FilledIcon);
