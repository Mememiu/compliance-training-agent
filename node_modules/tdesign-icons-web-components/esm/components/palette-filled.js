...
var PaletteFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(PaletteFilledIcon, _IconBase);
  var _super = _createSuper(PaletteFilledIcon);
  function PaletteFilledIcon() {
    var _this;
    _classCallCheck(this, PaletteFilledIcon);
  ...
  return _createClass(PaletteFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
PaletteFilledIcon = __decorateClass([Q("t-icon-palette-filled")], PaletteFilledIcon);
