...
var PaletteIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(PaletteIcon, _IconBase);
  var _super = _createSuper(PaletteIcon);
  function PaletteIcon() {
    var _this;
    _classCallCheck(this, PaletteIcon);
  ...
  return _createClass(PaletteIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
PaletteIcon = __decorateClass([Q("t-icon-palette")], PaletteIcon);
