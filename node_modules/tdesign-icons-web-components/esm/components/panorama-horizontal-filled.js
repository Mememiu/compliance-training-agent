...
var PanoramaHorizontalFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(PanoramaHorizontalFilledIcon, _IconBase);
  var _super = _createSuper(PanoramaHorizontalFilledIcon);
  function PanoramaHorizontalFilledIcon() {
    var _this;
    _classCallCheck(this, PanoramaHorizontalFilledIcon);
  ...
  return _createClass(PanoramaHorizontalFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
PanoramaHorizontalFilledIcon = __decorateClass([Q("t-icon-panorama-horizontal-filled")], PanoramaHorizontalFilledIcon);
