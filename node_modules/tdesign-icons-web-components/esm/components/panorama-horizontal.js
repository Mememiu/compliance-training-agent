...
var PanoramaHorizontalIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(PanoramaHorizontalIcon, _IconBase);
  var _super = _createSuper(PanoramaHorizontalIcon);
  function PanoramaHorizontalIcon() {
    var _this;
    _classCallCheck(this, PanoramaHorizontalIcon);
  ...
  return _createClass(PanoramaHorizontalIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
PanoramaHorizontalIcon = __decorateClass([Q("t-icon-panorama-horizontal")], PanoramaHorizontalIcon);
