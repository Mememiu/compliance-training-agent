...
var PanoramaVerticalFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(PanoramaVerticalFilledIcon, _IconBase);
  var _super = _createSuper(PanoramaVerticalFilledIcon);
  function PanoramaVerticalFilledIcon() {
    var _this;
    _classCallCheck(this, PanoramaVerticalFilledIcon);
  ...
  return _createClass(PanoramaVerticalFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
PanoramaVerticalFilledIcon = __decorateClass([Q("t-icon-panorama-vertical-filled")], PanoramaVerticalFilledIcon);
