...
var ParabolaIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ParabolaIcon, _IconBase);
  var _super = _createSuper(ParabolaIcon);
  function ParabolaIcon() {
    var _this;
    _classCallCheck(this, ParabolaIcon);
  ...
  return _createClass(ParabolaIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ParabolaIcon = __decorateClass([Q("t-icon-parabola")], ParabolaIcon);
