...
var ParenthesesIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ParenthesesIcon, _IconBase);
  var _super = _createSuper(ParenthesesIcon);
  function ParenthesesIcon() {
    var _this;
    _classCallCheck(this, ParenthesesIcon);
  ...
  return _createClass(ParenthesesIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ParenthesesIcon = __decorateClass([Q("t-icon-parentheses")], ParenthesesIcon);
