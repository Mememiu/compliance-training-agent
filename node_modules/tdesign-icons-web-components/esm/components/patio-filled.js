...
var PatioFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(PatioFilledIcon, _IconBase);
  var _super = _createSuper(PatioFilledIcon);
  function PatioFilledIcon() {
    var _this;
    _classCallCheck(this, PatioFilledIcon);
  ...
  return _createClass(PatioFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
PatioFilledIcon = __decorateClass([Q("t-icon-patio-filled")], PatioFilledIcon);
