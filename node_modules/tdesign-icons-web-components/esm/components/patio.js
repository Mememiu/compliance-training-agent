...
var PatioIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(PatioIcon, _IconBase);
  var _super = _createSuper(PatioIcon);
  function PatioIcon() {
    var _this;
    _classCallCheck(this, PatioIcon);
  ...
  return _createClass(PatioIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
PatioIcon = __decorateClass([Q("t-icon-patio")], PatioIcon);
