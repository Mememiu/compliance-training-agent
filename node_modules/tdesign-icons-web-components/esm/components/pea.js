...
var PeaIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(PeaIcon, _IconBase);
  var _super = _createSuper(PeaIcon);
  function PeaIcon() {
    var _this;
    _classCallCheck(this, PeaIcon);
  ...
  return _createClass(PeaIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
PeaIcon = __decorateClass([Q("t-icon-pea")], PeaIcon);
