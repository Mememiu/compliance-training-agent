...
var PeachIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(PeachIcon, _IconBase);
  var _super = _createSuper(PeachIcon);
  function PeachIcon() {
    var _this;
    _classCallCheck(this, PeachIcon);
  ...
  return _createClass(PeachIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
PeachIcon = __decorateClass([Q("t-icon-peach")], PeachIcon);
