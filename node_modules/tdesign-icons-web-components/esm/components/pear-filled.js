...
var PearFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(PearFilledIcon, _IconBase);
  var _super = _createSuper(PearFilledIcon);
  function PearFilledIcon() {
    var _this;
    _classCallCheck(this, PearFilledIcon);
  ...
  return _createClass(PearFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
PearFilledIcon = __decorateClass([Q("t-icon-pear-filled")], PearFilledIcon);
