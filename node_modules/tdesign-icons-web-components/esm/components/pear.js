...
var PearIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(PearIcon, _IconBase);
  var _super = _createSuper(PearIcon);
  function PearIcon() {
    var _this;
    _classCallCheck(this, PearIcon);
  ...
  return _createClass(PearIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
PearIcon = __decorateClass([Q("t-icon-pear")], PearIcon);
