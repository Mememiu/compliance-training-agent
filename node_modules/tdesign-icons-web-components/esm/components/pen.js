...
var PenIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(PenIcon, _IconBase);
  var _super = _createSuper(PenIcon);
  function PenIcon() {
    var _this;
    _classCallCheck(this, PenIcon);
  ...
  return _createClass(PenIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
PenIcon = __decorateClass([Q("t-icon-pen")], PenIcon);
