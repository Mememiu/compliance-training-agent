...
var PinIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(PinIcon, _IconBase);
  var _super = _createSuper(PinIcon);
  function PinIcon() {
    var _this;
  ...
  return _createClass(PinIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
PinIcon = __decorateClass([Q("t-icon-pin")], PinIcon);
