...
var PopsicleFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(PopsicleFilledIcon, _IconBase);
  var _super = _createSuper(PopsicleFilledIcon);
  function PopsicleFilledIcon() {
    var _this;
    _classCallCheck(this, PopsicleFilledIcon);
  ...
  return _createClass(PopsicleFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
PopsicleFilledIcon = __decorateClass([Q("t-icon-popsicle-filled")], PopsicleFilledIcon);
