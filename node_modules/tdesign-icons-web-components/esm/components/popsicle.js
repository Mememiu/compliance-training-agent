...
var PopsicleIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(PopsicleIcon, _IconBase);
  var _super = _createSuper(PopsicleIcon);
  function PopsicleIcon() {
    var _this;
    _classCallCheck(this, PopsicleIcon);
  ...
  return _createClass(PopsicleIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
PopsicleIcon = __decorateClass([Q("t-icon-popsicle")], PopsicleIcon);
