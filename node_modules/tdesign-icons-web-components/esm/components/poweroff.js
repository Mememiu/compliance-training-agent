...
var PoweroffIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(PoweroffIcon, _IconBase);
  var _super = _createSuper(PoweroffIcon);
  function PoweroffIcon() {
    var _this;
    _classCallCheck(this, PoweroffIcon);
  ...
  return _createClass(PoweroffIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
PoweroffIcon = __decorateClass([Q("t-icon-poweroff")], PoweroffIcon);
