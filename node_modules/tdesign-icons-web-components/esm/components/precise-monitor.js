...
var PreciseMonitorIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(PreciseMonitorIcon, _IconBase);
  var _super = _createSuper(PreciseMonitorIcon);
  function PreciseMonitorIcon() {
    var _this;
    _classCallCheck(this, PreciseMonitorIcon);
  ...
  return _createClass(PreciseMonitorIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
PreciseMonitorIcon = __decorateClass([Q("t-icon-precise-monitor")], PreciseMonitorIcon);
