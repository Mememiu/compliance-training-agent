...
var PumpkinFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(PumpkinFilledIcon, _IconBase);
  var _super = _createSuper(PumpkinFilledIcon);
  function PumpkinFilledIcon() {
    var _this;
    _classCallCheck(this, PumpkinFilledIcon);
  ...
  return _createClass(PumpkinFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
PumpkinFilledIcon = __decorateClass([Q("t-icon-pumpkin-filled")], PumpkinFilledIcon);
