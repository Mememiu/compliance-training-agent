...
var PumpkinIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(PumpkinIcon, _IconBase);
  var _super = _createSuper(PumpkinIcon);
  function PumpkinIcon() {
    var _this;
    _classCallCheck(this, PumpkinIcon);
  ...
  return _createClass(PumpkinIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
PumpkinIcon = __decorateClass([Q("t-icon-pumpkin")], PumpkinIcon);
