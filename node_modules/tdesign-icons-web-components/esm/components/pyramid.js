...
var PyramidIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(PyramidIcon, _IconBase);
  var _super = _createSuper(PyramidIcon);
  function PyramidIcon() {
    var _this;
    _classCallCheck(this, PyramidIcon);
  ...
  return _createClass(PyramidIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
PyramidIcon = __decorateClass([Q("t-icon-pyramid")], PyramidIcon);
