...
var QrcodeIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(QrcodeIcon, _IconBase);
  ...
  return _createClass(QrcodeIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
QrcodeIcon = __decorateClass([Q("t-icon-qrcode")], QrcodeIcon);
