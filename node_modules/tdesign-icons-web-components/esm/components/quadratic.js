...
var QuadraticIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(QuadraticIcon, _IconBase);
  var _super = _createSuper(QuadraticIcon);
  function QuadraticIcon() {
    var _this;
    _classCallCheck(this, QuadraticIcon);
  ...
  return _createClass(QuadraticIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
QuadraticIcon = __decorateClass([Q("t-icon-quadratic")], QuadraticIcon);
