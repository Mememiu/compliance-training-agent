...
var RadarIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(RadarIcon, _IconBase);
  var _super = _createSuper(RadarIcon);
  function RadarIcon() {
    var _this;
    _classCallCheck(this, RadarIcon);
  ...
  return _createClass(RadarIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
RadarIcon = __decorateClass([Q("t-icon-radar")], RadarIcon);
