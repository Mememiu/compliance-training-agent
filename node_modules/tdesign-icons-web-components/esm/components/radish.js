...
var RadishIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(RadishIcon, _IconBase);
  var _super = _createSuper(RadishIcon);
  function RadishIcon() {
    var _this;
    _classCallCheck(this, RadishIcon);
  ...
  return _createClass(RadishIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
RadishIcon = __decorateClass([Q("t-icon-radish")], RadishIcon);
