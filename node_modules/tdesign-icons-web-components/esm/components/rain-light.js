...
var RainLightIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(RainLightIcon, _IconBase);
  var _super = _createSuper(RainLightIcon);
  function RainLightIcon() {
    var _this;
    _classCallCheck(this, RainLightIcon);
  ...
  return _createClass(RainLightIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
RainLightIcon = __decorateClass([Q("t-icon-rain-light")], RainLightIcon);
