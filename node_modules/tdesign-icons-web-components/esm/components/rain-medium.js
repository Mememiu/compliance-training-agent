...
var RainMediumIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(RainMediumIcon, _IconBase);
  var _super = _createSuper(RainMediumIcon);
  function RainMediumIcon() {
    var _this;
    _classCallCheck(this, RainMediumIcon);
  ...
  return _createClass(RainMediumIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
RainMediumIcon = __decorateClass([Q("t-icon-rain-medium")], RainMediumIcon);
