...
var RainbowIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(RainbowIcon, _IconBase);
  var _super = _createSuper(RainbowIcon);
  function RainbowIcon() {
    var _this;
    _classCallCheck(this, RainbowIcon);
  ...
  return _createClass(RainbowIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
RainbowIcon = __decorateClass([Q("t-icon-rainbow")], RainbowIcon);
