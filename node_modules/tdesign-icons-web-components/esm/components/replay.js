...
var ReplayIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ReplayIcon, _IconBase);
  var _super = _createSuper(ReplayIcon);
  function ReplayIcon() {
    var _this;
    _classCallCheck(this, ReplayIcon);
  ...
  return _createClass(ReplayIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ReplayIcon = __decorateClass([Q("t-icon-replay")], ReplayIcon);
