...
var RiceBallFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(RiceBallFilledIcon, _IconBase);
  var _super = _createSuper(RiceBallFilledIcon);
  function RiceBallFilledIcon() {
    var _this;
    _classCallCheck(this, RiceBallFilledIcon);
  ...
  return _createClass(RiceBallFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
RiceBallFilledIcon = __decorateClass([Q("t-icon-rice-ball-filled")], RiceBallFilledIcon);
