...
var RiceBallIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(RiceBallIcon, _IconBase);
  var _super = _createSuper(RiceBallIcon);
  function RiceBallIcon() {
    var _this;
    _classCallCheck(this, RiceBallIcon);
  ...
  return _createClass(RiceBallIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
RiceBallIcon = __decorateClass([Q("t-icon-rice-ball")], RiceBallIcon);
