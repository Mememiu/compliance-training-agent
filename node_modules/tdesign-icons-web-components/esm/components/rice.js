...
var RiceIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(RiceIcon, _IconBase);
  var _super = _createSuper(RiceIcon);
  function RiceIcon() {
    var _this;
    _classCallCheck(this, RiceIcon);
  ...
  return _createClass(RiceIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
RiceIcon = __decorateClass([Q("t-icon-rice")], RiceIcon);
