...
var RocketIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(RocketIcon, _IconBase);
  var _super = _createSuper(RocketIcon);
  function RocketIcon() {
    var _this;
    _classCallCheck(this, RocketIcon);
  ...
  return _createClass(RocketIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
RocketIcon = __decorateClass([Q("t-icon-rocket")], RocketIcon);
