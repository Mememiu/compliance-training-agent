...
var RotateLockedFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(RotateLockedFilledIcon, _IconBase);
  var _super = _createSuper(RotateLockedFilledIcon);
  function RotateLockedFilledIcon() {
    var _this;
    _classCallCheck(this, RotateLockedFilledIcon);
  ...
  return _createClass(RotateLockedFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
RotateLockedFilledIcon = __decorateClass([Q("t-icon-rotate-locked-filled")], RotateLockedFilledIcon);
