...
var SailingHotelIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SailingHotelIcon, _IconBase);
  var _super = _createSuper(SailingHotelIcon);
  function SailingHotelIcon() {
    var _this;
    _classCallCheck(this, SailingHotelIcon);
  ...
  return _createClass(SailingHotelIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SailingHotelIcon = __decorateClass([Q("t-icon-sailing-hotel")], SailingHotelIcon);
