...
var SavingPotIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SavingPotIcon, _IconBase);
  var _super = _createSuper(SavingPotIcon);
  function SavingPotIcon() {
    var _this;
    _classCallCheck(this, SavingPotIcon);
  ...
  return _createClass(SavingPotIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SavingPotIcon = __decorateClass([Q("t-icon-saving-pot")], SavingPotIcon);
