...
var ScreenshotIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ScreenshotIcon, _IconBase);
  ...
  return _createClass(ScreenshotIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ScreenshotIcon = __decorateClass([Q("t-icon-screenshot")], ScreenshotIcon);
