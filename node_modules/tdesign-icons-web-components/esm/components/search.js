...
var SearchIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SearchIcon, _IconBase);
  ...
  return _createClass(SearchIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SearchIcon = __decorateClass([Q("t-icon-search")], SearchIcon);
