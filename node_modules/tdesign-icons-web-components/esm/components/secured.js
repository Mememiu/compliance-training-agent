...
var SecuredIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SecuredIcon, _IconBase);
  var _super = _createSuper(SecuredIcon);
  function SecuredIcon() {
    var _this;
    _classCallCheck(this, SecuredIcon);
  ...
  return _createClass(SecuredIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SecuredIcon = __decorateClass([Q("t-icon-secured")], SecuredIcon);
