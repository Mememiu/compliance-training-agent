...
var SendCancelIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SendCancelIcon, _IconBase);
  var _super = _createSuper(SendCancelIcon);
  function SendCancelIcon() {
    var _this;
    _classCallCheck(this, SendCancelIcon);
  ...
  return _createClass(SendCancelIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SendCancelIcon = __decorateClass([Q("t-icon-send-cancel")], SendCancelIcon);
