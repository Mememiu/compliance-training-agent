...
var Sensors1Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Sensors1Icon, _IconBase);
  var _super = _createSuper(Sensors1Icon);
  function Sensors1Icon() {
    var _this;
    _classCallCheck(this, Sensors1Icon);
  ...
  return _createClass(Sensors1Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Sensors1Icon = __decorateClass([Q("t-icon-sensors-1")], Sensors1Icon);
