...
var SensorsOffIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SensorsOffIcon, _IconBase);
  var _super = _createSuper(SensorsOffIcon);
  function SensorsOffIcon() {
    var _this;
    _classCallCheck(this, SensorsOffIcon);
  ...
  return _createClass(SensorsOffIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SensorsOffIcon = __decorateClass([Q("t-icon-sensors-off")], SensorsOffIcon);
