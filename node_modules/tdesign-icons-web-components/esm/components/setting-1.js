...
var Setting1Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Setting1Icon, _IconBase);
  var _super = _createSuper(Setting1Icon);
  function Setting1Icon() {
    var _this;
    _classCallCheck(this, Setting1Icon);
  ...
  return _createClass(Setting1Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Setting1Icon = __decorateClass([Q("t-icon-setting-1")], Setting1Icon);
