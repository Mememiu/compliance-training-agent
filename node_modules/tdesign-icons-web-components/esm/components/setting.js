...
var SettingIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SettingIcon, _IconBase);
  var _super = _createSuper(SettingIcon);
  function SettingIcon() {
    var _this;
    _classCallCheck(this, SettingIcon);
  ...
  return _createClass(SettingIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SettingIcon = __decorateClass([Q("t-icon-setting")], SettingIcon);
