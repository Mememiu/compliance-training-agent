...
var ShareFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ShareFilledIcon, _IconBase);
  var _super = _createSuper(ShareFilledIcon);
  function ShareFilledIcon() {
    var _this;
    _classCallCheck(this, ShareFilledIcon);
  ...
  return _createClass(ShareFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ShareFilledIcon = __decorateClass([Q("t-icon-share-filled")], ShareFilledIcon);
