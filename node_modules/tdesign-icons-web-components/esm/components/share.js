...
var ShareIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ShareIcon, _IconBase);
  ...
  return _createClass(ShareIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ShareIcon = __decorateClass([Q("t-icon-share")], ShareIcon);
