...
var ShieldErrorFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ShieldErrorFilledIcon, _IconBase);
  var _super = _createSuper(ShieldErrorFilledIcon);
  function ShieldErrorFilledIcon() {
    var _this;
    _classCallCheck(this, ShieldErrorFilledIcon);
  ...
  return _createClass(ShieldErrorFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ShieldErrorFilledIcon = __decorateClass([Q("t-icon-shield-error-filled")], ShieldErrorFilledIcon);
