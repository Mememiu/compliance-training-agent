...
var ShieldErrorIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ShieldErrorIcon, _IconBase);
  var _super = _createSuper(ShieldErrorIcon);
  function ShieldErrorIcon() {
    var _this;
    _classCallCheck(this, ShieldErrorIcon);
  ...
  return _createClass(ShieldErrorIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ShieldErrorIcon = __decorateClass([Q("t-icon-shield-error")], ShieldErrorIcon);
