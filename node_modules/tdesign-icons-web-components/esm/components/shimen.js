...
var ShimenIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ShimenIcon, _IconBase);
  var _super = _createSuper(ShimenIcon);
  function ShimenIcon() {
    var _this;
    _classCallCheck(this, ShimenIcon);
  ...
  return _createClass(ShimenIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ShimenIcon = __decorateClass([Q("t-icon-shimen")], ShimenIcon);
