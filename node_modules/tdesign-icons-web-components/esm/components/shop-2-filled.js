...
var Shop2FilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Shop2FilledIcon, _IconBase);
  var _super = _createSuper(Shop2FilledIcon);
  function Shop2FilledIcon() {
    var _this;
    _classCallCheck(this, Shop2FilledIcon);
  ...
  return _createClass(Shop2FilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Shop2FilledIcon = __decorateClass([Q("t-icon-shop-2-filled")], Shop2FilledIcon);
