...
var Shop2Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Shop2Icon, _IconBase);
  var _super = _createSuper(Shop2Icon);
  function Shop2Icon() {
    var _this;
    _classCallCheck(this, Shop2Icon);
  ...
  return _createClass(Shop2Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Shop2Icon = __decorateClass([Q("t-icon-shop-2")], Shop2Icon);
