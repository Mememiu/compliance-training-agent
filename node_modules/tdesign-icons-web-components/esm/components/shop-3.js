...
var Shop3Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Shop3Icon, _IconBase);
  var _super = _createSuper(Shop3Icon);
  function Shop3Icon() {
    var _this;
    _classCallCheck(this, Shop3Icon);
  ...
  return _createClass(Shop3Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Shop3Icon = __decorateClass([Q("t-icon-shop-3")], Shop3Icon);
