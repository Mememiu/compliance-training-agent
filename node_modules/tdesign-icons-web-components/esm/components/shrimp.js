...
var ShrimpIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ShrimpIcon, _IconBase);
  var _super = _createSuper(ShrimpIcon);
  function ShrimpIcon() {
    var _this;
    _classCallCheck(this, ShrimpIcon);
  ...
  return _createClass(ShrimpIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ShrimpIcon = __decorateClass([Q("t-icon-shrimp")], ShrimpIcon);
