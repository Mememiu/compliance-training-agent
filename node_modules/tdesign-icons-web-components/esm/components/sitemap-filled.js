...
var SitemapFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SitemapFilledIcon, _IconBase);
  var _super = _createSuper(SitemapFilledIcon);
  function SitemapFilledIcon() {
    var _this;
    _classCallCheck(this, SitemapFilledIcon);
  ...
  return _createClass(SitemapFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SitemapFilledIcon = __decorateClass([Q("t-icon-sitemap-filled")], SitemapFilledIcon);
