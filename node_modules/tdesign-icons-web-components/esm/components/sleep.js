...
var SleepIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SleepIcon, _IconBase);
  var _super = _createSuper(SleepIcon);
  function SleepIcon() {
    var _this;
    _classCallCheck(this, SleepIcon);
  ...
  return _createClass(SleepIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SleepIcon = __decorateClass([Q("t-icon-sleep")], SleepIcon);
