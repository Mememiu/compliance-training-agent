...
var SnowflakeIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SnowflakeIcon, _IconBase);
  var _super = _createSuper(SnowflakeIcon);
  function SnowflakeIcon() {
    var _this;
    _classCallCheck(this, SnowflakeIcon);
  ...
  return _createClass(SnowflakeIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SnowflakeIcon = __decorateClass([Q("t-icon-snowflake")], SnowflakeIcon);
