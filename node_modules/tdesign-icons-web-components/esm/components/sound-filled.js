...
var SoundFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SoundFilledIcon, _IconBase);
  var _super = _createSuper(SoundFilledIcon);
  function SoundFilledIcon() {
    var _this;
    _classCallCheck(this, SoundFilledIcon);
  ...
  return _createClass(SoundFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SoundFilledIcon = __decorateClass([Q("t-icon-sound-filled")], SoundFilledIcon);
