...
var SoundHighFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SoundHighFilledIcon, _IconBase);
  var _super = _createSuper(SoundHighFilledIcon);
  function SoundHighFilledIcon() {
    var _this;
    _classCallCheck(this, SoundHighFilledIcon);
  ...
  return _createClass(SoundHighFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SoundHighFilledIcon = __decorateClass([Q("t-icon-sound-high-filled")], SoundHighFilledIcon);
