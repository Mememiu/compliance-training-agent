...
var SoundHighIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SoundHighIcon, _IconBase);
  var _super = _createSuper(SoundHighIcon);
  function SoundHighIcon() {
    var _this;
    _classCallCheck(this, SoundHighIcon);
  ...
  return _createClass(SoundHighIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SoundHighIcon = __decorateClass([Q("t-icon-sound-high")], SoundHighIcon);
