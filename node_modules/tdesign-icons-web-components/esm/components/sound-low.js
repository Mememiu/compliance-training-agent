...
var SoundLowIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SoundLowIcon, _IconBase);
  var _super = _createSuper(SoundLowIcon);
  function SoundLowIcon() {
    var _this;
    _classCallCheck(this, SoundLowIcon);
  ...
  return _createClass(SoundLowIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SoundLowIcon = __decorateClass([Q("t-icon-sound-low")], SoundLowIcon);
