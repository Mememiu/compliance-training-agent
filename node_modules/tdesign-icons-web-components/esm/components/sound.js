...
var SoundIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SoundIcon, _IconBase);
  var _super = _createSuper(SoundIcon);
  function SoundIcon() {
    var _this;
    _classCallCheck(this, SoundIcon);
  ...
  return _createClass(SoundIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SoundIcon = __decorateClass([Q("t-icon-sound")], SoundIcon);
