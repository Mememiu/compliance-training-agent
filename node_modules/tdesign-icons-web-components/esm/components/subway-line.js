...
var SubwayLineIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SubwayLineIcon, _IconBase);
  var _super = _createSuper(SubwayLineIcon);
  function SubwayLineIcon() {
    var _this;
    _classCallCheck(this, SubwayLineIcon);
  ...
  return _createClass(SubwayLineIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SubwayLineIcon = __decorateClass([Q("t-icon-subway-line")], SubwayLineIcon);
