...
var SunRisingIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SunRisingIcon, _IconBase);
  var _super = _createSuper(SunRisingIcon);
  function SunRisingIcon() {
    var _this;
    _classCallCheck(this, SunRisingIcon);
  ...
  return _createClass(SunRisingIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SunRisingIcon = __decorateClass([Q("t-icon-sun-rising")], SunRisingIcon);
