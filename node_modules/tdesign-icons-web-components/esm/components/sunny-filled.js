...
var SunnyFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SunnyFilledIcon, _IconBase);
  var _super = _createSuper(SunnyFilledIcon);
  function SunnyFilledIcon() {
    var _this;
    _classCallCheck(this, SunnyFilledIcon);
  ...
  return _createClass(SunnyFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SunnyFilledIcon = __decorateClass([Q("t-icon-sunny-filled")], SunnyFilledIcon);
