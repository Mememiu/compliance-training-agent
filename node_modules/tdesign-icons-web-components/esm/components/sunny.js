...
var SunnyIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SunnyIcon, _IconBase);
  var _super = _createSuper(SunnyIcon);
  function SunnyIcon() {
    var _this;
    _classCallCheck(this, SunnyIcon);
  ...
  return _createClass(SunnyIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SunnyIcon = __decorateClass([Q("t-icon-sunny")], SunnyIcon);
