...
var SupportIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SupportIcon, _IconBase);
  ...
  return _createClass(SupportIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SupportIcon = __decorateClass([Q("t-icon-support")], SupportIcon);
