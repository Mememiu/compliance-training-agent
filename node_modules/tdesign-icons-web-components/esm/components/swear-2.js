...
var Swear2Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Swear2Icon, _IconBase);
  var _super = _createSuper(Swear2Icon);
  function Swear2Icon() {
    var _this;
    _classCallCheck(this, Swear2Icon);
  ...
  return _createClass(Swear2Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Swear2Icon = __decorateClass([Q("t-icon-swear-2")], Swear2Icon);
