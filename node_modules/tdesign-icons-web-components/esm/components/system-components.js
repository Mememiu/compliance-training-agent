...
var SystemComponentsIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SystemComponentsIcon, _IconBase);
  var _super = _createSuper(SystemComponentsIcon);
  function SystemComponentsIcon() {
    var _this;
    _classCallCheck(this, SystemComponentsIcon);
  ...
  return _createClass(SystemComponentsIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SystemComponentsIcon = __decorateClass([Q("t-icon-system-components")], SystemComponentsIcon);
