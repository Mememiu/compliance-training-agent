...
var SystemCoordinateIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SystemCoordinateIcon, _IconBase);
  var _super = _createSuper(SystemCoordinateIcon);
  function SystemCoordinateIcon() {
    var _this;
    _classCallCheck(this, SystemCoordinateIcon);
  ...
  return _createClass(SystemCoordinateIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SystemCoordinateIcon = __decorateClass([Q("t-icon-system-coordinate")], SystemCoordinateIcon);
