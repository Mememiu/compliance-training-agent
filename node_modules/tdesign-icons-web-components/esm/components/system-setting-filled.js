...
var SystemSettingFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SystemSettingFilledIcon, _IconBase);
  var _super = _createSuper(SystemSettingFilledIcon);
  function SystemSettingFilledIcon() {
    var _this;
    _classCallCheck(this, SystemSettingFilledIcon);
  ...
  return _createClass(SystemSettingFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SystemSettingFilledIcon = __decorateClass([Q("t-icon-system-setting-filled")], SystemSettingFilledIcon);
