...
var SystemSettingIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SystemSettingIcon, _IconBase);
  var _super = _createSuper(SystemSettingIcon);
  function SystemSettingIcon() {
    var _this;
    _classCallCheck(this, SystemSettingIcon);
  ...
  return _createClass(SystemSettingIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SystemSettingIcon = __decorateClass([Q("t-icon-system-setting")], SystemSettingIcon);
