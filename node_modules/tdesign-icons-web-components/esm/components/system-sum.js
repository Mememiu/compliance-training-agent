...
var SystemSumIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(SystemSumIcon, _IconBase);
  var _super = _createSuper(SystemSumIcon);
  function SystemSumIcon() {
    var _this;
    _classCallCheck(this, SystemSumIcon);
  ...
  return _createClass(SystemSumIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
SystemSumIcon = __decorateClass([Q("t-icon-system-sum")], SystemSumIcon);
