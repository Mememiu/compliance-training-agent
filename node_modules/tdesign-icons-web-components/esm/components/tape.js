...
var TapeIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(TapeIcon, _IconBase);
  var _super = _createSuper(TapeIcon);
  function TapeIcon() {
    var _this;
    _classCallCheck(this, TapeIcon);
  ...
  return _createClass(TapeIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
TapeIcon = __decorateClass([Q("t-icon-tape")], TapeIcon);
