...
var TaskSettingFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(TaskSettingFilledIcon, _IconBase);
  var _super = _createSuper(TaskSettingFilledIcon);
  function TaskSettingFilledIcon() {
    var _this;
    _classCallCheck(this, TaskSettingFilledIcon);
  ...
  return _createClass(TaskSettingFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
TaskSettingFilledIcon = __decorateClass([Q("t-icon-task-setting-filled")], TaskSettingFilledIcon);
