...
var TextformatStrikethroughIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(TextformatStrikethroughIcon, _IconBase);
  var _super = _createSuper(TextformatStrikethroughIcon);
  function TextformatStrikethroughIcon() {
    var _this;
    _classCallCheck(this, TextformatStrikethroughIcon);
  ...
  return _createClass(TextformatStrikethroughIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
TextformatStrikethroughIcon = __decorateClass([Q("t-icon-textformat-strikethrough")], TextformatStrikethroughIcon);
