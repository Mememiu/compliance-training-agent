...
var TextformatWrapIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(TextformatWrapIcon, _IconBase);
  var _super = _createSuper(TextformatWrapIcon);
  function TextformatWrapIcon() {
    var _this;
    _classCallCheck(this, TextformatWrapIcon);
  ...
  return _createClass(TextformatWrapIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
TextformatWrapIcon = __decorateClass([Q("t-icon-textformat-wrap")], TextformatWrapIcon);
