...
var TheatersIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(TheatersIcon, _IconBase);
  var _super = _createSuper(TheatersIcon);
  function TheatersIcon() {
    var _this;
    _classCallCheck(this, TheatersIcon);
  ...
  return _createClass(TheatersIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
TheatersIcon = __decorateClass([Q("t-icon-theaters")], TheatersIcon);
