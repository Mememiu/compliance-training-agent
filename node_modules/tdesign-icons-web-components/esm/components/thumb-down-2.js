...
var ThumbDown2Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ThumbDown2Icon, _IconBase);
  var _super = _createSuper(ThumbDown2Icon);
  function ThumbDown2Icon() {
    var _this;
    _classCallCheck(this, ThumbDown2Icon);
  ...
  return _createClass(ThumbDown2Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ThumbDown2Icon = __decorateClass([Q("t-icon-thumb-down-2")], ThumbDown2Icon);
