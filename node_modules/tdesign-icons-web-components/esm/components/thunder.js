...
var ThunderIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ThunderIcon, _IconBase);
  var _super = _createSuper(ThunderIcon);
  function ThunderIcon() {
    var _this;
    _classCallCheck(this, ThunderIcon);
  ...
  return _createClass(ThunderIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ThunderIcon = __decorateClass([Q("t-icon-thunder")], ThunderIcon);
