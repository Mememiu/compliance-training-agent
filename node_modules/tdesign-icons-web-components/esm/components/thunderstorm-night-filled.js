...
var ThunderstormNightFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ThunderstormNightFilledIcon, _IconBase);
  var _super = _createSuper(ThunderstormNightFilledIcon);
  function ThunderstormNightFilledIcon() {
    var _this;
    _classCallCheck(this, ThunderstormNightFilledIcon);
  ...
  return _createClass(ThunderstormNightFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ThunderstormNightFilledIcon = __decorateClass([Q("t-icon-thunderstorm-night-filled")], ThunderstormNightFilledIcon);
