...
var ThunderstormNightIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ThunderstormNightIcon, _IconBase);
  var _super = _createSuper(ThunderstormNightIcon);
  function ThunderstormNightIcon() {
    var _this;
    _classCallCheck(this, ThunderstormNightIcon);
  ...
  return _createClass(ThunderstormNightIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ThunderstormNightIcon = __decorateClass([Q("t-icon-thunderstorm-night")], ThunderstormNightIcon);
