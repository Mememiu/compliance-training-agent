...
var ThunderstormSunnyFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ThunderstormSunnyFilledIcon, _IconBase);
  var _super = _createSuper(ThunderstormSunnyFilledIcon);
  function ThunderstormSunnyFilledIcon() {
    var _this;
    _classCallCheck(this, ThunderstormSunnyFilledIcon);
  ...
  return _createClass(ThunderstormSunnyFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ThunderstormSunnyFilledIcon = __decorateClass([Q("t-icon-thunderstorm-sunny-filled")], ThunderstormSunnyFilledIcon);
