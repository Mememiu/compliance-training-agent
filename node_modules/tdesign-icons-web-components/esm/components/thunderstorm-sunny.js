...
var ThunderstormSunnyIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ThunderstormSunnyIcon, _IconBase);
  var _super = _createSuper(ThunderstormSunnyIcon);
  function ThunderstormSunnyIcon() {
    var _this;
    _classCallCheck(this, ThunderstormSunnyIcon);
  ...
  return _createClass(ThunderstormSunnyIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ThunderstormSunnyIcon = __decorateClass([Q("t-icon-thunderstorm-sunny")], ThunderstormSunnyIcon);
