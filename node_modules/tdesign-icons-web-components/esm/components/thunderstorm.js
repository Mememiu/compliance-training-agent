...
var ThunderstormIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ThunderstormIcon, _IconBase);
  var _super = _createSuper(ThunderstormIcon);
  function ThunderstormIcon() {
    var _this;
    _classCallCheck(this, ThunderstormIcon);
  ...
  return _createClass(ThunderstormIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ThunderstormIcon = __decorateClass([Q("t-icon-thunderstorm")], ThunderstormIcon);
