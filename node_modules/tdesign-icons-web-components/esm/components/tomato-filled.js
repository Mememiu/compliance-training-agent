...
var TomatoFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(TomatoFilledIcon, _IconBase);
  var _super = _createSuper(TomatoFilledIcon);
  function TomatoFilledIcon() {
    var _this;
    _classCallCheck(this, TomatoFilledIcon);
  ...
  return _createClass(TomatoFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
TomatoFilledIcon = __decorateClass([Q("t-icon-tomato-filled")], TomatoFilledIcon);
