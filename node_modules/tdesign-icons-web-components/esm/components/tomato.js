...
var TomatoIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(TomatoIcon, _IconBase);
  var _super = _createSuper(TomatoIcon);
  function TomatoIcon() {
    var _this;
    _classCallCheck(this, TomatoIcon);
  ...
  return _createClass(TomatoIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
TomatoIcon = __decorateClass([Q("t-icon-tomato")], TomatoIcon);
