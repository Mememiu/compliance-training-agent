...
var ToolsCircleIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ToolsCircleIcon, _IconBase);
  var _super = _createSuper(ToolsCircleIcon);
  function ToolsCircleIcon() {
    var _this;
    _classCallCheck(this, ToolsCircleIcon);
  ...
  return _createClass(ToolsCircleIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ToolsCircleIcon = __decorateClass([Q("t-icon-tools-circle")], ToolsCircleIcon);
