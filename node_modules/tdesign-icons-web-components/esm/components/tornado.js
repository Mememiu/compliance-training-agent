...
var TornadoIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(TornadoIcon, _IconBase);
  var _super = _createSuper(TornadoIcon);
  function TornadoIcon() {
    var _this;
    _classCallCheck(this, TornadoIcon);
  ...
  return _createClass(TornadoIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
TornadoIcon = __decorateClass([Q("t-icon-tornado")], TornadoIcon);
