...
var Tower1FilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Tower1FilledIcon, _IconBase);
  var _super = _createSuper(Tower1FilledIcon);
  function Tower1FilledIcon() {
    var _this;
    _classCallCheck(this, Tower1FilledIcon);
  ...
  return _createClass(Tower1FilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Tower1FilledIcon = __decorateClass([Q("t-icon-tower-1-filled")], Tower1FilledIcon);
