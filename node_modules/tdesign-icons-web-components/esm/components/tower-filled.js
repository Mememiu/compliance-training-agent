...
var TowerFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(TowerFilledIcon, _IconBase);
  var _super = _createSuper(TowerFilledIcon);
  function TowerFilledIcon() {
    var _this;
    _classCallCheck(this, TowerFilledIcon);
  ...
  return _createClass(TowerFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
TowerFilledIcon = __decorateClass([Q("t-icon-tower-filled")], TowerFilledIcon);
