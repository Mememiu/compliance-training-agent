...
var Translate1Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Translate1Icon, _IconBase);
  var _super = _createSuper(Translate1Icon);
  function Translate1Icon() {
    var _this;
    _classCallCheck(this, Translate1Icon);
  ...
  return _createClass(Translate1Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Translate1Icon = __decorateClass([Q("t-icon-translate-1")], Translate1Icon);
