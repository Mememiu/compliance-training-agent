...
var TreeRoundDotVerticalIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(TreeRoundDotVerticalIcon, _IconBase);
  var _super = _createSuper(TreeRoundDotVerticalIcon);
  function TreeRoundDotVerticalIcon() {
    var _this;
    _classCallCheck(this, TreeRoundDotVerticalIcon);
  ...
  return _createClass(TreeRoundDotVerticalIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
TreeRoundDotVerticalIcon = __decorateClass([Q("t-icon-tree-round-dot-vertical")], TreeRoundDotVerticalIcon);
