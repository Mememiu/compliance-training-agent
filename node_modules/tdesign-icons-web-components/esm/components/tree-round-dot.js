...
var TreeRoundDotIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(TreeRoundDotIcon, _IconBase);
  var _super = _createSuper(TreeRoundDotIcon);
  function TreeRoundDotIcon() {
    var _this;
    _classCallCheck(this, TreeRoundDotIcon);
  ...
  return _createClass(TreeRoundDotIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
TreeRoundDotIcon = __decorateClass([Q("t-icon-tree-round-dot")], TreeRoundDotIcon);
