...
var Uncomfortable2FilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Uncomfortable2FilledIcon, _IconBase);
  var _super = _createSuper(Uncomfortable2FilledIcon);
  function Uncomfortable2FilledIcon() {
    var _this;
    _classCallCheck(this, Uncomfortable2FilledIcon);
  ...
  return _createClass(Uncomfortable2FilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Uncomfortable2FilledIcon = __decorateClass([Q("t-icon-uncomfortable-2-filled")], Uncomfortable2FilledIcon);
