...
var Uncomfortable2Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Uncomfortable2Icon, _IconBase);
  var _super = _createSuper(Uncomfortable2Icon);
  function Uncomfortable2Icon() {
    var _this;
    _classCallCheck(this, Uncomfortable2Icon);
  ...
  return _createClass(Uncomfortable2Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Uncomfortable2Icon = __decorateClass([Q("t-icon-uncomfortable-2")], Uncomfortable2Icon);
