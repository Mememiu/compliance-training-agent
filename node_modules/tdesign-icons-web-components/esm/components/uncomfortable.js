...
var UncomfortableIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UncomfortableIcon, _IconBase);
  var _super = _createSuper(UncomfortableIcon);
  function UncomfortableIcon() {
    var _this;
    _classCallCheck(this, UncomfortableIcon);
  ...
  return _createClass(UncomfortableIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UncomfortableIcon = __decorateClass([Q("t-icon-uncomfortable")], UncomfortableIcon);
