...
var UndertakeDeliveryFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UndertakeDeliveryFilledIcon, _IconBase);
  var _super = _createSuper(UndertakeDeliveryFilledIcon);
  function UndertakeDeliveryFilledIcon() {
    var _this;
    _classCallCheck(this, UndertakeDeliveryFilledIcon);
  ...
  return _createClass(UndertakeDeliveryFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UndertakeDeliveryFilledIcon = __decorateClass([Q("t-icon-undertake-delivery-filled")], UndertakeDeliveryFilledIcon);
