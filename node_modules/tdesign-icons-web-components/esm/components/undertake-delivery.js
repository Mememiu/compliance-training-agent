...
var UndertakeDeliveryIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UndertakeDeliveryIcon, _IconBase);
  var _super = _createSuper(UndertakeDeliveryIcon);
  function UndertakeDeliveryIcon() {
    var _this;
    _classCallCheck(this, UndertakeDeliveryIcon);
  ...
  return _createClass(UndertakeDeliveryIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UndertakeDeliveryIcon = __decorateClass([Q("t-icon-undertake-delivery")], UndertakeDeliveryIcon);
