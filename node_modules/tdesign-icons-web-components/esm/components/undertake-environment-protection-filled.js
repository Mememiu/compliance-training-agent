...
var UndertakeEnvironmentProtectionFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UndertakeEnvironmentProtectionFilledIcon, _IconBase);
  var _super = _createSuper(UndertakeEnvironmentProtectionFilledIcon);
  function UndertakeEnvironmentProtectionFilledIcon() {
    var _this;
    _classCallCheck(this, UndertakeEnvironmentProtectionFilledIcon);
  ...
  return _createClass(UndertakeEnvironmentProtectionFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UndertakeEnvironmentProtectionFilledIcon = __decorateClass([Q("t-icon-undertake-environment-protection-filled")], UndertakeEnvironmentProtectionFilledIcon);
