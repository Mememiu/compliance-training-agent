...
var UndertakeFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UndertakeFilledIcon, _IconBase);
  var _super = _createSuper(UndertakeFilledIcon);
  function UndertakeFilledIcon() {
    var _this;
    _classCallCheck(this, UndertakeFilledIcon);
  ...
  return _createClass(UndertakeFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UndertakeFilledIcon = __decorateClass([Q("t-icon-undertake-filled")], UndertakeFilledIcon);
