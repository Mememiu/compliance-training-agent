...
var UndertakeHoldUpFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UndertakeHoldUpFilledIcon, _IconBase);
  var _super = _createSuper(UndertakeHoldUpFilledIcon);
  function UndertakeHoldUpFilledIcon() {
    var _this;
    _classCallCheck(this, UndertakeHoldUpFilledIcon);
  ...
  return _createClass(UndertakeHoldUpFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UndertakeHoldUpFilledIcon = __decorateClass([Q("t-icon-undertake-hold-up-filled")], UndertakeHoldUpFilledIcon);
