...
var UndertakeHoldUpIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UndertakeHoldUpIcon, _IconBase);
  var _super = _createSuper(UndertakeHoldUpIcon);
  function UndertakeHoldUpIcon() {
    var _this;
    _classCallCheck(this, UndertakeHoldUpIcon);
  ...
  return _createClass(UndertakeHoldUpIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UndertakeHoldUpIcon = __decorateClass([Q("t-icon-undertake-hold-up")], UndertakeHoldUpIcon);
