...
var UndertakeTransactionIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UndertakeTransactionIcon, _IconBase);
  var _super = _createSuper(UndertakeTransactionIcon);
  function UndertakeTransactionIcon() {
    var _this;
    _classCallCheck(this, UndertakeTransactionIcon);
  ...
  return _createClass(UndertakeTransactionIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UndertakeTransactionIcon = __decorateClass([Q("t-icon-undertake-transaction")], UndertakeTransactionIcon);
