...
var UndertakeIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UndertakeIcon, _IconBase);
  var _super = _createSuper(UndertakeIcon);
  function UndertakeIcon() {
    var _this;
    _classCallCheck(this, UndertakeIcon);
  ...
  return _createClass(UndertakeIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UndertakeIcon = __decorateClass([Q("t-icon-undertake")], UndertakeIcon);
