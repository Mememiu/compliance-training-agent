...
var UpscaleIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UpscaleIcon, _IconBase);
  var _super = _createSuper(UpscaleIcon);
  function UpscaleIcon() {
    var _this;
    _classCallCheck(this, UpscaleIcon);
  ...
  return _createClass(UpscaleIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UpscaleIcon = __decorateClass([Q("t-icon-upscale")], UpscaleIcon);
