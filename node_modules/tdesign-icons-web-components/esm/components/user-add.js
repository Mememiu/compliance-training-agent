...
var UserAddIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserAddIcon, _IconBase);
  var _super = _createSuper(UserAddIcon);
  function UserAddIcon() {
    var _this;
    _classCallCheck(this, UserAddIcon);
  ...
  return _createClass(UserAddIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserAddIcon = __decorateClass([Q("t-icon-user-add")], UserAddIcon);
