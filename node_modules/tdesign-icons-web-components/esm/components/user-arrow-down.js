...
var UserArrowDownIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserArrowDownIcon, _IconBase);
  var _super = _createSuper(UserArrowDownIcon);
  function UserArrowDownIcon() {
    var _this;
    _classCallCheck(this, UserArrowDownIcon);
  ...
  return _createClass(UserArrowDownIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserArrowDownIcon = __decorateClass([Q("t-icon-user-arrow-down")], UserArrowDownIcon);
