...
var UserArrowLeftIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserArrowLeftIcon, _IconBase);
  var _super = _createSuper(UserArrowLeftIcon);
  function UserArrowLeftIcon() {
    var _this;
    _classCallCheck(this, UserArrowLeftIcon);
  ...
  return _createClass(UserArrowLeftIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserArrowLeftIcon = __decorateClass([Q("t-icon-user-arrow-left")], UserArrowLeftIcon);
