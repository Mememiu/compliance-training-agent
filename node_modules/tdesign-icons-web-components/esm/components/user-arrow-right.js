...
var UserArrowRightIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserArrowRightIcon, _IconBase);
  var _super = _createSuper(UserArrowRightIcon);
  function UserArrowRightIcon() {
    var _this;
    _classCallCheck(this, UserArrowRightIcon);
  ...
  return _createClass(UserArrowRightIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserArrowRightIcon = __decorateClass([Q("t-icon-user-arrow-right")], UserArrowRightIcon);
