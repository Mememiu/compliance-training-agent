...
var UserBlockedIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserBlockedIcon, _IconBase);
  var _super = _createSuper(UserBlockedIcon);
  function UserBlockedIcon() {
    var _this;
    _classCallCheck(this, UserBlockedIcon);
  ...
  return _createClass(UserBlockedIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserBlockedIcon = __decorateClass([Q("t-icon-user-blocked")], UserBlockedIcon);
