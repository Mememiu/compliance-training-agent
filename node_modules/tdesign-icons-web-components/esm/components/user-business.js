...
var UserBusinessIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserBusinessIcon, _IconBase);
  var _super = _createSuper(UserBusinessIcon);
  function UserBusinessIcon() {
    var _this;
    _classCallCheck(this, UserBusinessIcon);
  ...
  return _createClass(UserBusinessIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserBusinessIcon = __decorateClass([Q("t-icon-user-business")], UserBusinessIcon);
