...
var UserChecked1Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserChecked1Icon, _IconBase);
  var _super = _createSuper(UserChecked1Icon);
  function UserChecked1Icon() {
    var _this;
    _classCallCheck(this, UserChecked1Icon);
  ...
  return _createClass(UserChecked1Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserChecked1Icon = __decorateClass([Q("t-icon-user-checked-1")], UserChecked1Icon);
