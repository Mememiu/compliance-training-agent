...
var UserCheckedIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserCheckedIcon, _IconBase);
  var _super = _createSuper(UserCheckedIcon);
  function UserCheckedIcon() {
    var _this;
    _classCallCheck(this, UserCheckedIcon);
  ...
  return _createClass(UserCheckedIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserCheckedIcon = __decorateClass([Q("t-icon-user-checked")], UserCheckedIcon);
