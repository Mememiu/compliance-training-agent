...
var UserCircleFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserCircleFilledIcon, _IconBase);
  var _super = _createSuper(UserCircleFilledIcon);
  function UserCircleFilledIcon() {
    var _this;
    _classCallCheck(this, UserCircleFilledIcon);
  ...
  return _createClass(UserCircleFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserCircleFilledIcon = __decorateClass([Q("t-icon-user-circle-filled")], UserCircleFilledIcon);
