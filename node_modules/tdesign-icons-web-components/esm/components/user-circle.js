...
var UserCircleIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserCircleIcon, _IconBase);
  var _super = _createSuper(UserCircleIcon);
  function UserCircleIcon() {
    var _this;
    _classCallCheck(this, UserCircleIcon);
  ...
  return _createClass(UserCircleIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserCircleIcon = __decorateClass([Q("t-icon-user-circle")], UserCircleIcon);
