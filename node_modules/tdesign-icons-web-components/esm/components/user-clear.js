...
var UserClearIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserClearIcon, _IconBase);
  var _super = _createSuper(UserClearIcon);
  function UserClearIcon() {
    var _this;
    _classCallCheck(this, UserClearIcon);
  ...
  return _createClass(UserClearIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserClearIcon = __decorateClass([Q("t-icon-user-clear")], UserClearIcon);
