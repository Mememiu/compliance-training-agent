...
var UserInvisibleFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserInvisibleFilledIcon, _IconBase);
  var _super = _createSuper(UserInvisibleFilledIcon);
  function UserInvisibleFilledIcon() {
    var _this;
    _classCallCheck(this, UserInvisibleFilledIcon);
  ...
  return _createClass(UserInvisibleFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserInvisibleFilledIcon = __decorateClass([Q("t-icon-user-invisible-filled")], UserInvisibleFilledIcon);
