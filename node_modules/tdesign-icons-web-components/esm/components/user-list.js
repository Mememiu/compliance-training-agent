...
var UserListIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserListIcon, _IconBase);
  var _super = _createSuper(UserListIcon);
  function UserListIcon() {
    var _this;
    _classCallCheck(this, UserListIcon);
  ...
  return _createClass(UserListIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserListIcon = __decorateClass([Q("t-icon-user-list")], UserListIcon);
