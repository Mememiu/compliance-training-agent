...
var UserLockedIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserLockedIcon, _IconBase);
  var _super = _createSuper(UserLockedIcon);
  function UserLockedIcon() {
    var _this;
    _classCallCheck(this, UserLockedIcon);
  ...
  return _createClass(UserLockedIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserLockedIcon = __decorateClass([Q("t-icon-user-locked")], UserLockedIcon);
