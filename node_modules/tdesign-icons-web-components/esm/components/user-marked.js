...
var UserMarkedIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserMarkedIcon, _IconBase);
  var _super = _createSuper(UserMarkedIcon);
  function UserMarkedIcon() {
    var _this;
    _classCallCheck(this, UserMarkedIcon);
  ...
  return _createClass(UserMarkedIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserMarkedIcon = __decorateClass([Q("t-icon-user-marked")], UserMarkedIcon);
