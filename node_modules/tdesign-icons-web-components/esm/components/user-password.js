...
var UserPasswordIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserPasswordIcon, _IconBase);
  var _super = _createSuper(UserPasswordIcon);
  function UserPasswordIcon() {
    var _this;
    _classCallCheck(this, UserPasswordIcon);
  ...
  return _createClass(UserPasswordIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserPasswordIcon = __decorateClass([Q("t-icon-user-password")], UserPasswordIcon);
