...
var UserSafetyIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserSafetyIcon, _IconBase);
  var _super = _createSuper(UserSafetyIcon);
  function UserSafetyIcon() {
    var _this;
    _classCallCheck(this, UserSafetyIcon);
  ...
  return _createClass(UserSafetyIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserSafetyIcon = __decorateClass([Q("t-icon-user-safety")], UserSafetyIcon);
