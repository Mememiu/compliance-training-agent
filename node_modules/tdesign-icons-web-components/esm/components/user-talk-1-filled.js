...
var UserTalk1FilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserTalk1FilledIcon, _IconBase);
  var _super = _createSuper(UserTalk1FilledIcon);
  function UserTalk1FilledIcon() {
    var _this;
    _classCallCheck(this, UserTalk1FilledIcon);
  ...
  return _createClass(UserTalk1FilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserTalk1FilledIcon = __decorateClass([Q("t-icon-user-talk-1-filled")], UserTalk1FilledIcon);
