...
var UserTalkIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserTalkIcon, _IconBase);
  var _super = _createSuper(UserTalkIcon);
  function UserTalkIcon() {
    var _this;
    _classCallCheck(this, UserTalkIcon);
  ...
  return _createClass(UserTalkIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserTalkIcon = __decorateClass([Q("t-icon-user-talk")], UserTalkIcon);
