...
var UserTimeIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserTimeIcon, _IconBase);
  var _super = _createSuper(UserTimeIcon);
  function UserTimeIcon() {
    var _this;
    _classCallCheck(this, UserTimeIcon);
  ...
  return _createClass(UserTimeIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserTimeIcon = __decorateClass([Q("t-icon-user-time")], UserTimeIcon);
