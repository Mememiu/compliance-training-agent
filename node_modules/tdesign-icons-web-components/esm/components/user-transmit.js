...
var UserTransmitIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserTransmitIcon, _IconBase);
  var _super = _createSuper(UserTransmitIcon);
  function UserTransmitIcon() {
    var _this;
    _classCallCheck(this, UserTransmitIcon);
  ...
  return _createClass(UserTransmitIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserTransmitIcon = __decorateClass([Q("t-icon-user-transmit")], UserTransmitIcon);
