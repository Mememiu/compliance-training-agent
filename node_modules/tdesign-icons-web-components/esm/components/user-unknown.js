...
var UserUnknownIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserUnknownIcon, _IconBase);
  var _super = _createSuper(UserUnknownIcon);
  function UserUnknownIcon() {
    var _this;
    _classCallCheck(this, UserUnknownIcon);
  ...
  return _createClass(UserUnknownIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserUnknownIcon = __decorateClass([Q("t-icon-user-unknown")], UserUnknownIcon);
