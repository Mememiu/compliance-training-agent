...
var UserUnlockedIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserUnlockedIcon, _IconBase);
  var _super = _createSuper(UserUnlockedIcon);
  function UserUnlockedIcon() {
    var _this;
    _classCallCheck(this, UserUnlockedIcon);
  ...
  return _createClass(UserUnlockedIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserUnlockedIcon = __decorateClass([Q("t-icon-user-unlocked")], UserUnlockedIcon);
