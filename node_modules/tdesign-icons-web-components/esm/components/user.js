...
var UserIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UserIcon, _IconBase);
  ...
  return _createClass(UserIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UserIcon = __decorateClass([Q("t-icon-user")], UserIcon);
