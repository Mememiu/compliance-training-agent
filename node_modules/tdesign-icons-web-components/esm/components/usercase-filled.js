...
var UsercaseFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UsercaseFilledIcon, _IconBase);
  var _super = _createSuper(UsercaseFilledIcon);
  function UsercaseFilledIcon() {
    var _this;
    _classCallCheck(this, UsercaseFilledIcon);
  ...
  return _createClass(UsercaseFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UsercaseFilledIcon = __decorateClass([Q("t-icon-usercase-filled")], UsercaseFilledIcon);
