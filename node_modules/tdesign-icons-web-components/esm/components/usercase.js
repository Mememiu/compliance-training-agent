...
var UsercaseIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UsercaseIcon, _IconBase);
  var _super = _createSuper(UsercaseIcon);
  function UsercaseIcon() {
    var _this;
    _classCallCheck(this, UsercaseIcon);
  ...
  return _createClass(UsercaseIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UsercaseIcon = __decorateClass([Q("t-icon-usercase")], UsercaseIcon);
