...
var UsergroupAddIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UsergroupAddIcon, _IconBase);
  var _super = _createSuper(UsergroupAddIcon);
  function UsergroupAddIcon() {
    var _this;
    _classCallCheck(this, UsergroupAddIcon);
  ...
  return _createClass(UsergroupAddIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UsergroupAddIcon = __decorateClass([Q("t-icon-usergroup-add")], UsergroupAddIcon);
