...
var UsergroupClearIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UsergroupClearIcon, _IconBase);
  var _super = _createSuper(UsergroupClearIcon);
  function UsergroupClearIcon() {
    var _this;
    _classCallCheck(this, UsergroupClearIcon);
  ...
  return _createClass(UsergroupClearIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UsergroupClearIcon = __decorateClass([Q("t-icon-usergroup-clear")], UsergroupClearIcon);
