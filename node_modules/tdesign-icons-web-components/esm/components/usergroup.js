...
var UsergroupIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(UsergroupIcon, _IconBase);
  var _super = _createSuper(UsergroupIcon);
  function UsergroupIcon() {
    var _this;
    _classCallCheck(this, UsergroupIcon);
  ...
  return _createClass(UsergroupIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
UsergroupIcon = __decorateClass([Q("t-icon-usergroup")], UsergroupIcon);
