...
var VerifiedIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(VerifiedIcon, _IconBase);
  var _super = _createSuper(VerifiedIcon);
  function VerifiedIcon() {
    var _this;
    _classCallCheck(this, VerifiedIcon);
  ...
  return _createClass(VerifiedIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
VerifiedIcon = __decorateClass([Q("t-icon-verified")], VerifiedIcon);
