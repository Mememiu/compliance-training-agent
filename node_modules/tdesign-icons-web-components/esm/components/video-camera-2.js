...
var VideoCamera2Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(VideoCamera2Icon, _IconBase);
  var _super = _createSuper(VideoCamera2Icon);
  function VideoCamera2Icon() {
    var _this;
    _classCallCheck(this, VideoCamera2Icon);
  ...
  return _createClass(VideoCamera2Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
VideoCamera2Icon = __decorateClass([Q("t-icon-video-camera-2")], VideoCamera2Icon);
