...
var ViewInArIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ViewInArIcon, _IconBase);
  var _super = _createSuper(ViewInArIcon);
  function ViewInArIcon() {
    var _this;
    _classCallCheck(this, ViewInArIcon);
  ...
  return _createClass(ViewInArIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ViewInArIcon = __decorateClass([Q("t-icon-view-in-ar")], ViewInArIcon);
