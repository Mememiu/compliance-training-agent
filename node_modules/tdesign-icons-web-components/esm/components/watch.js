...
var WatchIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(WatchIcon, _IconBase);
  var _super = _createSuper(WatchIcon);
  function WatchIcon() {
    var _this;
    _classCallCheck(this, WatchIcon);
  ...
  return _createClass(WatchIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
WatchIcon = __decorateClass([Q("t-icon-watch")], WatchIcon);
