...
var WatermelonIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(WatermelonIcon, _IconBase);
  var _super = _createSuper(WatermelonIcon);
  function WatermelonIcon() {
    var _this;
    _classCallCheck(this, WatermelonIcon);
  ...
  return _createClass(WatermelonIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
WatermelonIcon = __decorateClass([Q("t-icon-watermelon")], WatermelonIcon);
