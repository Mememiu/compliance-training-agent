...
var WaveLeftFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(WaveLeftFilledIcon, _IconBase);
  var _super = _createSuper(WaveLeftFilledIcon);
  function WaveLeftFilledIcon() {
    var _this;
    _classCallCheck(this, WaveLeftFilledIcon);
  ...
  return _createClass(WaveLeftFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
WaveLeftFilledIcon = __decorateClass([Q("t-icon-wave-left-filled")], WaveLeftFilledIcon);
