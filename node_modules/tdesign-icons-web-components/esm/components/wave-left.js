...
var WaveLeftIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(WaveLeftIcon, _IconBase);
  var _super = _createSuper(WaveLeftIcon);
  function WaveLeftIcon() {
    var _this;
    _classCallCheck(this, WaveLeftIcon);
  ...
  return _createClass(WaveLeftIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
WaveLeftIcon = __decorateClass([Q("t-icon-wave-left")], WaveLeftIcon);
