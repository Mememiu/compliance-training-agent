...
var WaveRightFilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(WaveRightFilledIcon, _IconBase);
  var _super = _createSuper(WaveRightFilledIcon);
  function WaveRightFilledIcon() {
    var _this;
    _classCallCheck(this, WaveRightFilledIcon);
  ...
  return _createClass(WaveRightFilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
WaveRightFilledIcon = __decorateClass([Q("t-icon-wave-right-filled")], WaveRightFilledIcon);
