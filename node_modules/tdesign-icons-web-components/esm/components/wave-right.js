...
var WaveRightIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(WaveRightIcon, _IconBase);
  var _super = _createSuper(WaveRightIcon);
  function WaveRightIcon() {
    var _this;
    _classCallCheck(this, WaveRightIcon);
  ...
  return _createClass(WaveRightIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
WaveRightIcon = __decorateClass([Q("t-icon-wave-right")], WaveRightIcon);
