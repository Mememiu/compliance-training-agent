...
var Wealth1FilledIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Wealth1FilledIcon, _IconBase);
  var _super = _createSuper(Wealth1FilledIcon);
  function Wealth1FilledIcon() {
    var _this;
    _classCallCheck(this, Wealth1FilledIcon);
  ...
  return _createClass(Wealth1FilledIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Wealth1FilledIcon = __decorateClass([Q("t-icon-wealth-1-filled")], Wealth1FilledIcon);
