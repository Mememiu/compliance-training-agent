...
var Wealth1Icon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(Wealth1Icon, _IconBase);
  var _super = _createSuper(Wealth1Icon);
  function Wealth1Icon() {
    var _this;
    _classCallCheck(this, Wealth1Icon);
  ...
  return _createClass(Wealth1Icon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
Wealth1Icon = __decorateClass([Q("t-icon-wealth-1")], Wealth1Icon);
