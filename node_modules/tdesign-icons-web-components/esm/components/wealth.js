...
var WealthIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(WealthIcon, _IconBase);
  var _super = _createSuper(WealthIcon);
  function WealthIcon() {
    var _this;
    _classCallCheck(this, WealthIcon);
  ...
  return _createClass(WealthIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
WealthIcon = __decorateClass([Q("t-icon-wealth")], WealthIcon);
