...
var WifiIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(WifiIcon, _IconBase);
  var _super = _createSuper(WifiIcon);
  function WifiIcon() {
    var _this;
    _classCallCheck(this, WifiIcon);
  ...
  return _createClass(WifiIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
WifiIcon = __decorateClass([Q("t-icon-wifi")], WifiIcon);
