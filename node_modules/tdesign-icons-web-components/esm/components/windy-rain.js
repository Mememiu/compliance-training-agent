...
var WindyRainIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(WindyRainIcon, _IconBase);
  var _super = _createSuper(WindyRainIcon);
  function WindyRainIcon() {
    var _this;
    _classCallCheck(this, WindyRainIcon);
  ...
  return _createClass(WindyRainIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
WindyRainIcon = __decorateClass([Q("t-icon-windy-rain")], WindyRainIcon);
