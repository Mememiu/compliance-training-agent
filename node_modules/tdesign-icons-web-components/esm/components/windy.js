...
var WindyIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(WindyIcon, _IconBase);
  var _super = _createSuper(WindyIcon);
  function WindyIcon() {
    var _this;
    _classCallCheck(this, WindyIcon);
  ...
  return _createClass(WindyIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
WindyIcon = __decorateClass([Q("t-icon-windy")], WindyIcon);
