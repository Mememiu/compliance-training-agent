...
var WinkIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(WinkIcon, _IconBase);
  var _super = _createSuper(WinkIcon);
  function WinkIcon() {
    var _this;
    _classCallCheck(this, WinkIcon);
  ...
  return _createClass(WinkIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
WinkIcon = __decorateClass([Q("t-icon-wink")], WinkIcon);
