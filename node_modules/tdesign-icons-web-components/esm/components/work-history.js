...
var WorkHistoryIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(WorkHistoryIcon, _IconBase);
  var _super = _createSuper(WorkHistoryIcon);
  function WorkHistoryIcon() {
    var _this;
    _classCallCheck(this, WorkHistoryIcon);
  ...
  return _createClass(WorkHistoryIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
WorkHistoryIcon = __decorateClass([Q("t-icon-work-history")], WorkHistoryIcon);
