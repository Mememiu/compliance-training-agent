...
var ZoomInIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ZoomInIcon, _IconBase);
  ...
  return _createClass(ZoomInIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ZoomInIcon = __decorateClass([Q("t-icon-zoom-in")], ZoomInIcon);
