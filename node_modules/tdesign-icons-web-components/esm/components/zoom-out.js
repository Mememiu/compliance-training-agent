...
var ZoomOutIcon = (_class = /*#__PURE__*/function (_IconBase) {
  _inherits(ZoomOutIcon, _IconBase);
  var _super = _createSuper(ZoomOutIcon);
  function ZoomOutIcon() {
    var _this;
    _classCallCheck(this, ZoomOutIcon);
  ...
  return _createClass(ZoomOutIcon);
}(IconBase), _defineProperty(_class, "icon", element), _class);
ZoomOutIcon = __decorateClass([Q("t-icon-zoom-out")], ZoomOutIcon);
