...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(AlarmOffIcon, _IconBase);
  var _super = _createSuper(AlarmOffIcon);
  function AlarmOffIcon() {
    var _this;
    omi_module._classCallCheck(this, AlarmOffIcon);
  ...
  return omi_module._createClass(AlarmOffIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-alarm-off")], exports['default']);
