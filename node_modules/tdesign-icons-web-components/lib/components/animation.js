...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(AnimationIcon, _IconBase);
  var _super = _createSuper(AnimationIcon);
  function AnimationIcon() {
    var _this;
    omi_module._classCallCheck(this, AnimationIcon);
  ...
  return omi_module._createClass(AnimationIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-animation")], exports['default']);
