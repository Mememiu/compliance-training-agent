...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(AppleIcon, _IconBase);
  var _super = _createSuper(AppleIcon);
  function AppleIcon() {
    var _this;
    omi_module._classCallCheck(this, AppleIcon);
  ...
  return omi_module._createClass(AppleIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-apple")], exports['default']);
