...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ArchitectureHuiStyleIcon, _IconBase);
  var _super = _createSuper(ArchitectureHuiStyleIcon);
  function ArchitectureHuiStyleIcon() {
    var _this;
    omi_module._classCallCheck(this, ArchitectureHuiStyleIcon);
  ...
  return omi_module._createClass(ArchitectureHuiStyleIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-architecture-hui-style")], exports['default']);
