...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Attic1FilledIcon, _IconBase);
  var _super = _createSuper(Attic1FilledIcon);
  function Attic1FilledIcon() {
    var _this;
    omi_module._classCallCheck(this, Attic1FilledIcon);
  ...
  return omi_module._createClass(Attic1FilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-attic-1-filled")], exports['default']);
