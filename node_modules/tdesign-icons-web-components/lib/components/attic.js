...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(AtticIcon, _IconBase);
  var _super = _createSuper(AtticIcon);
  function AtticIcon() {
    var _this;
    omi_module._classCallCheck(this, AtticIcon);
  ...
  return omi_module._createClass(AtticIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-attic")], exports['default']);
