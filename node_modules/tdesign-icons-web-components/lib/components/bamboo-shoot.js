...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(BambooShootIcon, _IconBase);
  var _super = _createSuper(BambooShootIcon);
  function BambooShootIcon() {
    var _this;
    omi_module._classCallCheck(this, BambooShootIcon);
  ...
  return omi_module._createClass(BambooShootIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-bamboo-shoot")], exports['default']);
