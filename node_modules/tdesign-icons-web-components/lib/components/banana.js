...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(BananaIcon, _IconBase);
  var _super = _createSuper(BananaIcon);
  function BananaIcon() {
    var _this;
    omi_module._classCallCheck(this, BananaIcon);
  ...
  return omi_module._createClass(BananaIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-banana")], exports['default']);
