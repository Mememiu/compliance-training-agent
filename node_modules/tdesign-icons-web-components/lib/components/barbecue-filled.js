...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(BarbecueFilledIcon, _IconBase);
  var _super = _createSuper(BarbecueFilledIcon);
  function BarbecueFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, BarbecueFilledIcon);
  ...
  return omi_module._createClass(BarbecueFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-barbecue-filled")], exports['default']);
