...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(BarbecueIcon, _IconBase);
  var _super = _createSuper(BarbecueIcon);
  function BarbecueIcon() {
    var _this;
    omi_module._classCallCheck(this, BarbecueIcon);
  ...
  return omi_module._createClass(BarbecueIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-barbecue")], exports['default']);
