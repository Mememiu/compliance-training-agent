...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(BeanIcon, _IconBase);
  var _super = _createSuper(BeanIcon);
  function BeanIcon() {
    var _this;
    omi_module._classCallCheck(this, BeanIcon);
  ...
  return omi_module._createClass(BeanIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-bean")], exports['default']);
