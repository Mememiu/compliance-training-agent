...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(BeerIcon, _IconBase);
  var _super = _createSuper(BeerIcon);
  function BeerIcon() {
    var _this;
    omi_module._classCallCheck(this, BeerIcon);
  ...
  return omi_module._createClass(BeerIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-beer")], exports['default']);
