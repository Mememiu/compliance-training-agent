...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(BoneIcon, _IconBase);
  var _super = _createSuper(BoneIcon);
  function BoneIcon() {
    var _this;
    omi_module._classCallCheck(this, BoneIcon);
  ...
  return omi_module._createClass(BoneIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-bone")], exports['default']);
