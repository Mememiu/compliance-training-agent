...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(BookOpenFilledIcon, _IconBase);
  var _super = _createSuper(BookOpenFilledIcon);
  function BookOpenFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, BookOpenFilledIcon);
  ...
  return omi_module._createClass(BookOpenFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-book-open-filled")], exports['default']);
