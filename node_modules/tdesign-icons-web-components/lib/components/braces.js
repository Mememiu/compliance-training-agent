...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(BracesIcon, _IconBase);
  var _super = _createSuper(BracesIcon);
  function BracesIcon() {
    var _this;
    omi_module._classCallCheck(this, BracesIcon);
  ...
  return omi_module._createClass(BracesIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-braces")], exports['default']);
