...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(BreadIcon, _IconBase);
  var _super = _createSuper(BreadIcon);
  function BreadIcon() {
    var _this;
    omi_module._classCallCheck(this, BreadIcon);
  ...
  return omi_module._createClass(BreadIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-bread")], exports['default']);
