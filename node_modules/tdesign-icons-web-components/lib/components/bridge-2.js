...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Bridge2Icon, _IconBase);
  var _super = _createSuper(Bridge2Icon);
  function Bridge2Icon() {
    var _this;
    omi_module._classCallCheck(this, Bridge2Icon);
  ...
  return omi_module._createClass(Bridge2Icon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-bridge-2")], exports['default']);
