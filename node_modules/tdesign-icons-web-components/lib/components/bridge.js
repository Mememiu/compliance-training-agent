...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(BridgeIcon, _IconBase);
  var _super = _createSuper(BridgeIcon);
  function BridgeIcon() {
    var _this;
    omi_module._classCallCheck(this, BridgeIcon);
  ...
  return omi_module._createClass(BridgeIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-bridge")], exports['default']);
