...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Brightness1Icon, _IconBase);
  var _super = _createSuper(Brightness1Icon);
  function Brightness1Icon() {
    var _this;
    omi_module._classCallCheck(this, Brightness1Icon);
  ...
  return omi_module._createClass(Brightness1Icon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-brightness-1")], exports['default']);
