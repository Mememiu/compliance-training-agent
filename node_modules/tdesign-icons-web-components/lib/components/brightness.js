...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(BrightnessIcon, _IconBase);
  var _super = _createSuper(BrightnessIcon);
  function BrightnessIcon() {
    var _this;
    omi_module._classCallCheck(this, BrightnessIcon);
  ...
  return omi_module._createClass(BrightnessIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-brightness")], exports['default']);
