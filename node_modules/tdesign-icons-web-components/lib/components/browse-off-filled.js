...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(BrowseOffFilledIcon, _IconBase);
  var _super = _createSuper(BrowseOffFilledIcon);
  function BrowseOffFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, BrowseOffFilledIcon);
  ...
  return omi_module._createClass(BrowseOffFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-browse-off-filled")], exports['default']);
