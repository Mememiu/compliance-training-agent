...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(BrowseOffIcon, _IconBase);
  var _super = _createSuper(BrowseOffIcon);
  function BrowseOffIcon() {
    var _this;
    omi_module._classCallCheck(this, BrowseOffIcon);
  ...
  return omi_module._createClass(BrowseOffIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-browse-off")], exports['default']);
