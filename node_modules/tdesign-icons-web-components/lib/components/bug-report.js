...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(BugReportIcon, _IconBase);
  var _super = _createSuper(BugReportIcon);
  function BugReportIcon() {
    var _this;
    omi_module._classCallCheck(this, BugReportIcon);
  ...
  return omi_module._createClass(BugReportIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-bug-report")], exports['default']);
