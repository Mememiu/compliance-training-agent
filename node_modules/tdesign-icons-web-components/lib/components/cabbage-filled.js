...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(CabbageFilledIcon, _IconBase);
  var _super = _createSuper(CabbageFilledIcon);
  function CabbageFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, CabbageFilledIcon);
  ...
  return omi_module._createClass(CabbageFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-cabbage-filled")], exports['default']);
