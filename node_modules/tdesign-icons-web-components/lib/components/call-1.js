...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Call1Icon, _IconBase);
  var _super = _createSuper(Call1Icon);
  function Call1Icon() {
    var _this;
    omi_module._classCallCheck(this, Call1Icon);
  ...
  return omi_module._createClass(Call1Icon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-call-1")], exports['default']);
