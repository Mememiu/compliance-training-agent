...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(CatFilledIcon, _IconBase);
  var _super = _createSuper(CatFilledIcon);
  function CatFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, CatFilledIcon);
  ...
  return omi_module._createClass(CatFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-cat-filled")], exports['default']);
