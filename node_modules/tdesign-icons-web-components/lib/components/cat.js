...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(CatIcon, _IconBase);
  var _super = _createSuper(CatIcon);
  function CatIcon() {
    var _this;
    omi_module._classCallCheck(this, CatIcon);
  ...
  return omi_module._createClass(CatIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-cat")], exports['default']);
