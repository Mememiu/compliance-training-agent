...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ChartLineData1Icon, _IconBase);
  var _super = _createSuper(ChartLineData1Icon);
  function ChartLineData1Icon() {
    var _this;
    omi_module._classCallCheck(this, ChartLineData1Icon);
  ...
  return omi_module._createClass(ChartLineData1Icon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-chart-line-data-1")], exports['default']);
