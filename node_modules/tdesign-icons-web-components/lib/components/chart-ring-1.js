...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ChartRing1Icon, _IconBase);
  var _super = _createSuper(ChartRing1Icon);
  function ChartRing1Icon() {
    var _this;
    omi_module._classCallCheck(this, ChartRing1Icon);
  ...
  return omi_module._createClass(ChartRing1Icon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-chart-ring-1")], exports['default']);
