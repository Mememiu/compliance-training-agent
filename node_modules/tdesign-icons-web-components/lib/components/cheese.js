...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(CheeseIcon, _IconBase);
  var _super = _createSuper(CheeseIcon);
  function CheeseIcon() {
    var _this;
    omi_module._classCallCheck(this, CheeseIcon);
  ...
  return omi_module._createClass(CheeseIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-cheese")], exports['default']);
