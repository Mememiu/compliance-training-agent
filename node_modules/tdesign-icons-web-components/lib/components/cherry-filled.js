...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(CherryFilledIcon, _IconBase);
  var _super = _createSuper(CherryFilledIcon);
  function CherryFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, CherryFilledIcon);
  ...
  return omi_module._createClass(CherryFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-cherry-filled")], exports['default']);
