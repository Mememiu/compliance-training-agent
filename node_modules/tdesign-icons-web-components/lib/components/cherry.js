...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(CherryIcon, _IconBase);
  var _super = _createSuper(CherryIcon);
  function CherryIcon() {
    var _this;
    omi_module._classCallCheck(this, CherryIcon);
  ...
  return omi_module._createClass(CherryIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-cherry")], exports['default']);
