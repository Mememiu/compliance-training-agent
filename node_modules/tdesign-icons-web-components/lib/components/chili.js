...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ChiliIcon, _IconBase);
  var _super = _createSuper(ChiliIcon);
  function ChiliIcon() {
    var _this;
    omi_module._classCallCheck(this, ChiliIcon);
  ...
  return omi_module._createClass(ChiliIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-chili")], exports['default']);
