...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(CityAncient1Icon, _IconBase);
  var _super = _createSuper(CityAncient1Icon);
  function CityAncient1Icon() {
    var _this;
    omi_module._classCallCheck(this, CityAncient1Icon);
  ...
  return omi_module._createClass(CityAncient1Icon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-city-ancient-1")], exports['default']);
