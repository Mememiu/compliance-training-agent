...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(CloudyDayIcon, _IconBase);
  var _super = _createSuper(CloudyDayIcon);
  function CloudyDayIcon() {
    var _this;
    omi_module._classCallCheck(this, CloudyDayIcon);
  ...
  return omi_module._createClass(CloudyDayIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-cloudy-day")], exports['default']);
