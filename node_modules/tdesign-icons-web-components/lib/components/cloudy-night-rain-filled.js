...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(CloudyNightRainFilledIcon, _IconBase);
  var _super = _createSuper(CloudyNightRainFilledIcon);
  function CloudyNightRainFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, CloudyNightRainFilledIcon);
  ...
  return omi_module._createClass(CloudyNightRainFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-cloudy-night-rain-filled")], exports['default']);
