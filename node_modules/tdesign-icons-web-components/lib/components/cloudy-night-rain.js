...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(CloudyNightRainIcon, _IconBase);
  var _super = _createSuper(CloudyNightRainIcon);
  function CloudyNightRainIcon() {
    var _this;
    omi_module._classCallCheck(this, CloudyNightRainIcon);
  ...
  return omi_module._createClass(CloudyNightRainIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-cloudy-night-rain")], exports['default']);
