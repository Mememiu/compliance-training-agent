...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(CloudyNightIcon, _IconBase);
  var _super = _createSuper(CloudyNightIcon);
  function CloudyNightIcon() {
    var _this;
    omi_module._classCallCheck(this, CloudyNightIcon);
  ...
  return omi_module._createClass(CloudyNightIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-cloudy-night")], exports['default']);
