...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(CloudyRainIcon, _IconBase);
  var _super = _createSuper(CloudyRainIcon);
  function CloudyRainIcon() {
    var _this;
    omi_module._classCallCheck(this, CloudyRainIcon);
  ...
  return omi_module._createClass(CloudyRainIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-cloudy-rain")], exports['default']);
