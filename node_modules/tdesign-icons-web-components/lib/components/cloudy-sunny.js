...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(CloudySunnyIcon, _IconBase);
  var _super = _createSuper(CloudySunnyIcon);
  function CloudySunnyIcon() {
    var _this;
    omi_module._classCallCheck(this, CloudySunnyIcon);
  ...
  return omi_module._createClass(CloudySunnyIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-cloudy-sunny")], exports['default']);
