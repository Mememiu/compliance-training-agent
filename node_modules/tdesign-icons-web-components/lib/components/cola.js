...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ColaIcon, _IconBase);
  var _super = _createSuper(ColaIcon);
  function ColaIcon() {
    var _this;
    omi_module._classCallCheck(this, ColaIcon);
  ...
  return omi_module._createClass(ColaIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-cola")], exports['default']);
