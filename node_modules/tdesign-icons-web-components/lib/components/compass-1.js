...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Compass1Icon, _IconBase);
  var _super = _createSuper(Compass1Icon);
  function Compass1Icon() {
    var _this;
    omi_module._classCallCheck(this, Compass1Icon);
  ...
  return omi_module._createClass(Compass1Icon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-compass-1")], exports['default']);
