...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(CornIcon, _IconBase);
  var _super = _createSuper(CornIcon);
  function CornIcon() {
    var _this;
    omi_module._classCallCheck(this, CornIcon);
  ...
  return omi_module._createClass(CornIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-corn")], exports['default']);
