...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(CucumberIcon, _IconBase);
  var _super = _createSuper(CucumberIcon);
  function CucumberIcon() {
    var _this;
    omi_module._classCallCheck(this, CucumberIcon);
  ...
  return omi_module._createClass(CucumberIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-cucumber")], exports['default']);
