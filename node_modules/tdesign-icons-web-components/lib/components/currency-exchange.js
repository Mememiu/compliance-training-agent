...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(CurrencyExchangeIcon, _IconBase);
  var _super = _createSuper(CurrencyExchangeIcon);
  function CurrencyExchangeIcon() {
    var _this;
    omi_module._classCallCheck(this, CurrencyExchangeIcon);
  ...
  return omi_module._createClass(CurrencyExchangeIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-currency-exchange")], exports['default']);
