...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(CurtainIcon, _IconBase);
  var _super = _createSuper(CurtainIcon);
  function CurtainIcon() {
    var _this;
    omi_module._classCallCheck(this, CurtainIcon);
  ...
  return omi_module._createClass(CurtainIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-curtain")], exports['default']);
