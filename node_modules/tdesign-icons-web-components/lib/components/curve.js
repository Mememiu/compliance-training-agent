...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(CurveIcon, _IconBase);
  var _super = _createSuper(CurveIcon);
  function CurveIcon() {
    var _this;
    omi_module._classCallCheck(this, CurveIcon);
  ...
  return omi_module._createClass(CurveIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-curve")], exports['default']);
