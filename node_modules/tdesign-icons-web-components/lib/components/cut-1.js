...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Cut1Icon, _IconBase);
  var _super = _createSuper(Cut1Icon);
  function Cut1Icon() {
    var _this;
    omi_module._classCallCheck(this, Cut1Icon);
  ...
  return omi_module._createClass(Cut1Icon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-cut-1")], exports['default']);
