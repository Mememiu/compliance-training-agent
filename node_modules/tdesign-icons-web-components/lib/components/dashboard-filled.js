...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(DashboardFilledIcon, _IconBase);
  var _super = _createSuper(DashboardFilledIcon);
  function DashboardFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, DashboardFilledIcon);
  ...
  return omi_module._createClass(DashboardFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-dashboard-filled")], exports['default']);
