...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(DashboardIcon, _IconBase);
  var _super = _createSuper(DashboardIcon);
  function DashboardIcon() {
    var _this;
    omi_module._classCallCheck(this, DashboardIcon);
  ...
  return omi_module._createClass(DashboardIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-dashboard")], exports['default']);
