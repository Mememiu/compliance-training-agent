...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Dividers1Icon, _IconBase);
  var _super = _createSuper(Dividers1Icon);
  function Dividers1Icon() {
    var _this;
    omi_module._classCallCheck(this, Dividers1Icon);
  ...
  return omi_module._createClass(Dividers1Icon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-dividers-1")], exports['default']);
