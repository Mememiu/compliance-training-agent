...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(DividersIcon, _IconBase);
  var _super = _createSuper(DividersIcon);
  function DividersIcon() {
    var _this;
    omi_module._classCallCheck(this, DividersIcon);
  ...
  return omi_module._createClass(DividersIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-dividers")], exports['default']);
