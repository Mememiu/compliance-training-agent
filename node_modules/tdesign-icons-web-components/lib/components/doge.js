...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(DogeIcon, _IconBase);
  var _super = _createSuper(DogeIcon);
  function DogeIcon() {
    var _this;
    omi_module._classCallCheck(this, DogeIcon);
  ...
  return omi_module._createClass(DogeIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-doge")], exports['default']);
