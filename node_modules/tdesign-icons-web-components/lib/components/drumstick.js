...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(DrumstickIcon, _IconBase);
  var _super = _createSuper(DrumstickIcon);
  function DrumstickIcon() {
    var _this;
    omi_module._classCallCheck(this, DrumstickIcon);
  ...
  return omi_module._createClass(DrumstickIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-drumstick")], exports['default']);
