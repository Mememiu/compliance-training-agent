...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(EggplantIcon, _IconBase);
  var _super = _createSuper(EggplantIcon);
  function EggplantIcon() {
    var _this;
    omi_module._classCallCheck(this, EggplantIcon);
  ...
  return omi_module._createClass(EggplantIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-eggplant")], exports['default']);
