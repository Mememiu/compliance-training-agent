...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ExcitedIcon, _IconBase);
  var _super = _createSuper(ExcitedIcon);
  function ExcitedIcon() {
    var _this;
    omi_module._classCallCheck(this, ExcitedIcon);
  ...
  return omi_module._createClass(ExcitedIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-excited")], exports['default']);
