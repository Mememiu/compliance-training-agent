...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ExploreOffIcon, _IconBase);
  var _super = _createSuper(ExploreOffIcon);
  function ExploreOffIcon() {
    var _this;
    omi_module._classCallCheck(this, ExploreOffIcon);
  ...
  return omi_module._createClass(ExploreOffIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-explore-off")], exports['default']);
