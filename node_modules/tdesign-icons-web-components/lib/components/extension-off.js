...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ExtensionOffIcon, _IconBase);
  var _super = _createSuper(ExtensionOffIcon);
  function ExtensionOffIcon() {
    var _this;
    omi_module._classCallCheck(this, ExtensionOffIcon);
  ...
  return omi_module._createClass(ExtensionOffIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-extension-off")], exports['default']);
