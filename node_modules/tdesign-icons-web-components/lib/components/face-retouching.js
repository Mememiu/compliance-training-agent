...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(FaceRetouchingIcon, _IconBase);
  var _super = _createSuper(FaceRetouchingIcon);
  function FaceRetouchingIcon() {
    var _this;
    omi_module._classCallCheck(this, FaceRetouchingIcon);
  ...
  return omi_module._createClass(FaceRetouchingIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-face-retouching")], exports['default']);
