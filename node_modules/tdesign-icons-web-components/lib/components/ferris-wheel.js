...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(FerrisWheelIcon, _IconBase);
  var _super = _createSuper(FerrisWheelIcon);
  function FerrisWheelIcon() {
    var _this;
    omi_module._classCallCheck(this, FerrisWheelIcon);
  ...
  return omi_module._createClass(FerrisWheelIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-ferris-wheel")], exports['default']);
