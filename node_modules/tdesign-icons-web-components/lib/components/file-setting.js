...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(FileSettingIcon, _IconBase);
  var _super = _createSuper(FileSettingIcon);
  function FileSettingIcon() {
    var _this;
    omi_module._classCallCheck(this, FileSettingIcon);
  ...
  return omi_module._createClass(FileSettingIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-file-setting")], exports['default']);
