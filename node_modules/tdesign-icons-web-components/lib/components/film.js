...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(FilmIcon, _IconBase);
  var _super = _createSuper(FilmIcon);
  function FilmIcon() {
    var _this;
    omi_module._classCallCheck(this, FilmIcon);
  ...
  return omi_module._createClass(FilmIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-film")], exports['default']);
