...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Filter1FilledIcon, _IconBase);
  var _super = _createSuper(Filter1FilledIcon);
  function Filter1FilledIcon() {
    var _this;
    omi_module._classCallCheck(this, Filter1FilledIcon);
  ...
  return omi_module._createClass(Filter1FilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-filter-1-filled")], exports['default']);
