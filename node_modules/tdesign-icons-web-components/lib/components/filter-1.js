...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Filter1Icon, _IconBase);
  var _super = _createSuper(Filter1Icon);
  function Filter1Icon() {
    var _this;
    omi_module._classCallCheck(this, Filter1Icon);
  ...
  return omi_module._createClass(Filter1Icon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-filter-1")], exports['default']);
