...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Fingerprint3Icon, _IconBase);
  var _super = _createSuper(Fingerprint3Icon);
  function Fingerprint3Icon() {
    var _this;
    omi_module._classCallCheck(this, Fingerprint3Icon);
  ...
  return omi_module._createClass(Fingerprint3Icon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-fingerprint-3")], exports['default']);
