...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(FishFilledIcon, _IconBase);
  var _super = _createSuper(FishFilledIcon);
  function FishFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, FishFilledIcon);
  ...
  return omi_module._createClass(FishFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-fish-filled")], exports['default']);
