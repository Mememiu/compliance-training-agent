...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(FishIcon, _IconBase);
  var _super = _createSuper(FishIcon);
  function FishIcon() {
    var _this;
    omi_module._classCallCheck(this, FishIcon);
  ...
  return omi_module._createClass(FishIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-fish")], exports['default']);
