...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(FogNightIcon, _IconBase);
  var _super = _createSuper(FogNightIcon);
  function FogNightIcon() {
    var _this;
    omi_module._classCallCheck(this, FogNightIcon);
  ...
  return omi_module._createClass(FogNightIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-fog-night")], exports['default']);
