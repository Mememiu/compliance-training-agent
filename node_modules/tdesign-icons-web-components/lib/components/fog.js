...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(FogIcon, _IconBase);
  var _super = _createSuper(FogIcon);
  function FogIcon() {
    var _this;
    omi_module._classCallCheck(this, FogIcon);
  ...
  return omi_module._createClass(FogIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-fog")], exports['default']);
