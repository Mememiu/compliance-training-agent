...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(FolderSettingFilledIcon, _IconBase);
  var _super = _createSuper(FolderSettingFilledIcon);
  function FolderSettingFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, FolderSettingFilledIcon);
  ...
  return omi_module._createClass(FolderSettingFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-folder-setting-filled")], exports['default']);
