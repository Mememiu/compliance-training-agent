...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(FolderSettingIcon, _IconBase);
  var _super = _createSuper(FolderSettingIcon);
  function FolderSettingIcon() {
    var _this;
    omi_module._classCallCheck(this, FolderSettingIcon);
  ...
  return omi_module._createClass(FolderSettingIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-folder-setting")], exports['default']);
