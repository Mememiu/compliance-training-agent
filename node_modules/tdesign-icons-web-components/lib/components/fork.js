...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ForkIcon, _IconBase);
  var _super = _createSuper(ForkIcon);
  function ForkIcon() {
    var _this;
    omi_module._classCallCheck(this, ForkIcon);
  ...
  return omi_module._createClass(ForkIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-fork")], exports['default']);
