...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(GarlicFilledIcon, _IconBase);
  var _super = _createSuper(GarlicFilledIcon);
  function GarlicFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, GarlicFilledIcon);
  ...
  return omi_module._createClass(GarlicFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-garlic-filled")], exports['default']);
