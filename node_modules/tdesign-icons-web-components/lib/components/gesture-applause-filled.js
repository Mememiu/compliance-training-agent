...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(GestureApplauseFilledIcon, _IconBase);
  var _super = _createSuper(GestureApplauseFilledIcon);
  function GestureApplauseFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, GestureApplauseFilledIcon);
  ...
  return omi_module._createClass(GestureApplauseFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-gesture-applause-filled")], exports['default']);
