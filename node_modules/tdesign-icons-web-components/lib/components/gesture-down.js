...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(GestureDownIcon, _IconBase);
  var _super = _createSuper(GestureDownIcon);
  function GestureDownIcon() {
    var _this;
    omi_module._classCallCheck(this, GestureDownIcon);
  ...
  return omi_module._createClass(GestureDownIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-gesture-down")], exports['default']);
