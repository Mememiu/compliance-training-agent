...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(GestureExpansionIcon, _IconBase);
  var _super = _createSuper(GestureExpansionIcon);
  function GestureExpansionIcon() {
    var _this;
    omi_module._classCallCheck(this, GestureExpansionIcon);
  ...
  return omi_module._createClass(GestureExpansionIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-gesture-expansion")], exports['default']);
