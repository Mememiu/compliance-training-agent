...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(GestureLeftSlipIcon, _IconBase);
  var _super = _createSuper(GestureLeftSlipIcon);
  function GestureLeftSlipIcon() {
    var _this;
    omi_module._classCallCheck(this, GestureLeftSlipIcon);
  ...
  return omi_module._createClass(GestureLeftSlipIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-gesture-left-slip")], exports['default']);
