...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(GestureOpenFilledIcon, _IconBase);
  var _super = _createSuper(GestureOpenFilledIcon);
  function GestureOpenFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, GestureOpenFilledIcon);
  ...
  return omi_module._createClass(GestureOpenFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-gesture-open-filled")], exports['default']);
