...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(GesturePrayFilledIcon, _IconBase);
  var _super = _createSuper(GesturePrayFilledIcon);
  function GesturePrayFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, GesturePrayFilledIcon);
  ...
  return omi_module._createClass(GesturePrayFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-gesture-pray-filled")], exports['default']);
