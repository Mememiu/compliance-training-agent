...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(GesturePrayIcon, _IconBase);
  var _super = _createSuper(GesturePrayIcon);
  function GesturePrayIcon() {
    var _this;
    omi_module._classCallCheck(this, GesturePrayIcon);
  ...
  return omi_module._createClass(GesturePrayIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-gesture-pray")], exports['default']);
