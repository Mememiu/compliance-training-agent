...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(GesturePressIcon, _IconBase);
  var _super = _createSuper(GesturePressIcon);
  function GesturePressIcon() {
    var _this;
    omi_module._classCallCheck(this, GesturePressIcon);
  ...
  return omi_module._createClass(GesturePressIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-gesture-press")], exports['default']);
