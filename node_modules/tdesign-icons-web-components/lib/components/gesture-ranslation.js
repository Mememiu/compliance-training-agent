...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(GestureRanslationIcon, _IconBase);
  var _super = _createSuper(GestureRanslationIcon);
  function GestureRanslationIcon() {
    var _this;
    omi_module._classCallCheck(this, GestureRanslationIcon);
  ...
  return omi_module._createClass(GestureRanslationIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-gesture-ranslation")], exports['default']);
