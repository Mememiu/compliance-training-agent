...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(GestureUpIcon, _IconBase);
  var _super = _createSuper(GestureUpIcon);
  function GestureUpIcon() {
    var _this;
    omi_module._classCallCheck(this, GestureUpIcon);
  ...
  return omi_module._createClass(GestureUpIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-gesture-up")], exports['default']);
