...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(GitPullRequestIcon, _IconBase);
  var _super = _createSuper(GitPullRequestIcon);
  function GitPullRequestIcon() {
    var _this;
    omi_module._classCallCheck(this, GitPullRequestIcon);
  ...
  return omi_module._createClass(GitPullRequestIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-git-pull-request")], exports['default']);
