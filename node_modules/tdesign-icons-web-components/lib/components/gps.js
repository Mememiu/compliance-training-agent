...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(GpsIcon, _IconBase);
  var _super = _createSuper(GpsIcon);
  function GpsIcon() {
    var _this;
    omi_module._classCallCheck(this, GpsIcon);
  ...
  return omi_module._createClass(GpsIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-gps")], exports['default']);
