...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(GrapeFilledIcon, _IconBase);
  var _super = _createSuper(GrapeFilledIcon);
  function GrapeFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, GrapeFilledIcon);
  ...
  return omi_module._createClass(GrapeFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-grape-filled")], exports['default']);
