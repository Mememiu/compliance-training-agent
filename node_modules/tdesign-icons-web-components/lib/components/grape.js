...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(GrapeIcon, _IconBase);
  var _super = _createSuper(GrapeIcon);
  function GrapeIcon() {
    var _this;
    omi_module._classCallCheck(this, GrapeIcon);
  ...
  return omi_module._createClass(GrapeIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-grape")], exports['default']);
