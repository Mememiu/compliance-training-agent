...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(GuitarIcon, _IconBase);
  var _super = _createSuper(GuitarIcon);
  function GuitarIcon() {
    var _this;
    omi_module._classCallCheck(this, GuitarIcon);
  ...
  return omi_module._createClass(GuitarIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-guitar")], exports['default']);
