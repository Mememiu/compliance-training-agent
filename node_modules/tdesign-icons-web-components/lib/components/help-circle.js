...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(HelpCircleIcon, _IconBase);
  var _super = _createSuper(HelpCircleIcon);
  function HelpCircleIcon() {
    var _this;
    omi_module._classCallCheck(this, HelpCircleIcon);
  ...
  return omi_module._createClass(HelpCircleIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-help-circle")], exports['default']);
