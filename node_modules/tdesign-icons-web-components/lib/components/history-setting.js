...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(HistorySettingIcon, _IconBase);
  var _super = _createSuper(HistorySettingIcon);
  function HistorySettingIcon() {
    var _this;
    omi_module._classCallCheck(this, HistorySettingIcon);
  ...
  return omi_module._createClass(HistorySettingIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-history-setting")], exports['default']);
