...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(IceCreamFilledIcon, _IconBase);
  var _super = _createSuper(IceCreamFilledIcon);
  function IceCreamFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, IceCreamFilledIcon);
  ...
  return omi_module._createClass(IceCreamFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-ice-cream-filled")], exports['default']);
