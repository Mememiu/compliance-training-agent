...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(IceCreamIcon, _IconBase);
  var _super = _createSuper(IceCreamIcon);
  function IceCreamIcon() {
    var _this;
    omi_module._classCallCheck(this, IceCreamIcon);
  ...
  return omi_module._createClass(IceCreamIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-ice-cream")], exports['default']);
