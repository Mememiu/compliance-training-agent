...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(InternetIcon, _IconBase);
  var _super = _createSuper(InternetIcon);
  function InternetIcon() {
    var _this;
    omi_module._classCallCheck(this, InternetIcon);
  ...
  return omi_module._createClass(InternetIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-internet")], exports['default']);
