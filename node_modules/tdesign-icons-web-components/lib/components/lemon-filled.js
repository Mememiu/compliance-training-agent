...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(LemonFilledIcon, _IconBase);
  var _super = _createSuper(LemonFilledIcon);
  function LemonFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, LemonFilledIcon);
  ...
  return omi_module._createClass(LemonFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-lemon-filled")], exports['default']);
