...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Lighthouse1Icon, _IconBase);
  var _super = _createSuper(Lighthouse1Icon);
  function Lighthouse1Icon() {
    var _this;
    omi_module._classCallCheck(this, Lighthouse1Icon);
  ...
  return omi_module._createClass(Lighthouse1Icon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-lighthouse-1")], exports['default']);
