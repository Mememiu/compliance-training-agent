...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Lighthouse2FilledIcon, _IconBase);
  var _super = _createSuper(Lighthouse2FilledIcon);
  function Lighthouse2FilledIcon() {
    var _this;
    omi_module._classCallCheck(this, Lighthouse2FilledIcon);
  ...
  return omi_module._createClass(Lighthouse2FilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-lighthouse-2-filled")], exports['default']);
