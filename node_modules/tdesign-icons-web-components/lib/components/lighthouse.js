...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(LighthouseIcon, _IconBase);
  var _super = _createSuper(LighthouseIcon);
  function LighthouseIcon() {
    var _this;
    omi_module._classCallCheck(this, LighthouseIcon);
  ...
  return omi_module._createClass(LighthouseIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-lighthouse")], exports['default']);
