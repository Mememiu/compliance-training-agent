...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Link1Icon, _IconBase);
  var _super = _createSuper(Link1Icon);
  function Link1Icon() {
    var _this;
    omi_module._classCallCheck(this, Link1Icon);
  ...
  return omi_module._createClass(Link1Icon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-link-1")], exports['default']);
