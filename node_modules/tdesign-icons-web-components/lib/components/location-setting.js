...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(LocationSettingIcon, _IconBase);
  var _super = _createSuper(LocationSettingIcon);
  function LocationSettingIcon() {
    var _this;
    omi_module._classCallCheck(this, LocationSettingIcon);
  ...
  return omi_module._createClass(LocationSettingIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-location-setting")], exports['default']);
