...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(LocationIcon, _IconBase);
  var _super = _createSuper(LocationIcon);
  function LocationIcon() {
    var _this;
    omi_module._classCallCheck(this, LocationIcon);
  ...
  return omi_module._createClass(LocationIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-location")], exports['default']);
