...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(LogoAlipayFilledIcon, _IconBase);
  var _super = _createSuper(LogoAlipayFilledIcon);
  function LogoAlipayFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, LogoAlipayFilledIcon);
  ...
  return omi_module._createClass(LogoAlipayFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-logo-alipay-filled")], exports['default']);
