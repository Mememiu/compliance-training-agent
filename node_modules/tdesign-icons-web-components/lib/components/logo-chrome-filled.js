...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(LogoChromeFilledIcon, _IconBase);
  var _super = _createSuper(LogoChromeFilledIcon);
  function LogoChromeFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, LogoChromeFilledIcon);
  ...
  return omi_module._createClass(LogoChromeFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-logo-chrome-filled")], exports['default']);
