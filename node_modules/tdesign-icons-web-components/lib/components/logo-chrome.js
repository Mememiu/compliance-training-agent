...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(LogoChromeIcon, _IconBase);
  var _super = _createSuper(LogoChromeIcon);
  function LogoChromeIcon() {
    var _this;
    omi_module._classCallCheck(this, LogoChromeIcon);
  ...
  return omi_module._createClass(LogoChromeIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-logo-chrome")], exports['default']);
