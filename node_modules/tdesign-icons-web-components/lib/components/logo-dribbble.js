...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(LogoDribbbleIcon, _IconBase);
  var _super = _createSuper(LogoDribbbleIcon);
  function LogoDribbbleIcon() {
    var _this;
    omi_module._classCallCheck(this, LogoDribbbleIcon);
  ...
  return omi_module._createClass(LogoDribbbleIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-logo-dribbble")], exports['default']);
