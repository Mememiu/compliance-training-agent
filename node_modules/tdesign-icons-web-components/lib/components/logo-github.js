...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(LogoGithubIcon, _IconBase);
  var _super = _createSuper(LogoGithubIcon);
  function LogoGithubIcon() {
    var _this;
    omi_module._classCallCheck(this, LogoGithubIcon);
  ...
  return omi_module._createClass(LogoGithubIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-logo-github")], exports['default']);
