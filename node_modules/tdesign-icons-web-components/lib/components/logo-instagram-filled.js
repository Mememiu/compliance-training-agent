...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(LogoInstagramFilledIcon, _IconBase);
  var _super = _createSuper(LogoInstagramFilledIcon);
  function LogoInstagramFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, LogoInstagramFilledIcon);
  ...
  return omi_module._createClass(LogoInstagramFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-logo-instagram-filled")], exports['default']);
