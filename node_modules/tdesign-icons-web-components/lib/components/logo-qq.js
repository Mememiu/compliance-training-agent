...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(LogoQqIcon, _IconBase);
  var _super = _createSuper(LogoQqIcon);
  function LogoQqIcon() {
    var _this;
    omi_module._classCallCheck(this, LogoQqIcon);
  ...
  return omi_module._createClass(LogoQqIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-logo-qq")], exports['default']);
