...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(LogoTwitterIcon, _IconBase);
  var _super = _createSuper(LogoTwitterIcon);
  function LogoTwitterIcon() {
    var _this;
    omi_module._classCallCheck(this, LogoTwitterIcon);
  ...
  return omi_module._createClass(LogoTwitterIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-logo-twitter")], exports['default']);
