...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(LogoWechatStrokeFilledIcon, _IconBase);
  var _super = _createSuper(LogoWechatStrokeFilledIcon);
  function LogoWechatStrokeFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, LogoWechatStrokeFilledIcon);
  ...
  return omi_module._createClass(LogoWechatStrokeFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-logo-wechat-stroke-filled")], exports['default']);
