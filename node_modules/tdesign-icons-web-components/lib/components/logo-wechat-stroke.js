...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(LogoWechatStrokeIcon, _IconBase);
  var _super = _createSuper(LogoWechatStrokeIcon);
  function LogoWechatStrokeIcon() {
    var _this;
    omi_module._classCallCheck(this, LogoWechatStrokeIcon);
  ...
  return omi_module._createClass(LogoWechatStrokeIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-logo-wechat-stroke")], exports['default']);
