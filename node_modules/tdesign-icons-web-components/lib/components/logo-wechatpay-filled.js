...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(LogoWechatpayFilledIcon, _IconBase);
  var _super = _createSuper(LogoWechatpayFilledIcon);
  function LogoWechatpayFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, LogoWechatpayFilledIcon);
  ...
  return omi_module._createClass(LogoWechatpayFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-logo-wechatpay-filled")], exports['default']);
