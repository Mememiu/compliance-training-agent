...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(LogoWecomIcon, _IconBase);
  var _super = _createSuper(LogoWecomIcon);
  function LogoWecomIcon() {
    var _this;
    omi_module._classCallCheck(this, LogoWecomIcon);
  ...
  return omi_module._createClass(LogoWecomIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-logo-wecom")], exports['default']);
