...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(LogoYoutubeFilledIcon, _IconBase);
  var _super = _createSuper(LogoYoutubeFilledIcon);
  function LogoYoutubeFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, LogoYoutubeFilledIcon);
  ...
  return omi_module._createClass(LogoYoutubeFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-logo-youtube-filled")], exports['default']);
