...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(LogoYoutubeIcon, _IconBase);
  var _super = _createSuper(LogoYoutubeIcon);
  function LogoYoutubeIcon() {
    var _this;
    omi_module._classCallCheck(this, LogoYoutubeIcon);
  ...
  return omi_module._createClass(LogoYoutubeIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-logo-youtube")], exports['default']);
