...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Map3DIcon, _IconBase);
  var _super = _createSuper(Map3DIcon);
  function Map3DIcon() {
    var _this;
    omi_module._classCallCheck(this, Map3DIcon);
  ...
  return omi_module._createClass(Map3DIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-map-3d")], exports['default']);
