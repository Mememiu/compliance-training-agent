...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(MapAimingIcon, _IconBase);
  var _super = _createSuper(MapAimingIcon);
  function MapAimingIcon() {
    var _this;
    omi_module._classCallCheck(this, MapAimingIcon);
  ...
  return omi_module._createClass(MapAimingIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-map-aiming")], exports['default']);
