...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(MapBubbleIcon, _IconBase);
  var _super = _createSuper(MapBubbleIcon);
  function MapBubbleIcon() {
    var _this;
    omi_module._classCallCheck(this, MapBubbleIcon);
  ...
  return omi_module._createClass(MapBubbleIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-map-bubble")], exports['default']);
