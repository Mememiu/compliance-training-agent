...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(MapConnectionFilledIcon, _IconBase);
  var _super = _createSuper(MapConnectionFilledIcon);
  function MapConnectionFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, MapConnectionFilledIcon);
  ...
  return omi_module._createClass(MapConnectionFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-map-connection-filled")], exports['default']);
