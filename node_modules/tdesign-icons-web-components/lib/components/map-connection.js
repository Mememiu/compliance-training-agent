...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(MapConnectionIcon, _IconBase);
  var _super = _createSuper(MapConnectionIcon);
  function MapConnectionIcon() {
    var _this;
    omi_module._classCallCheck(this, MapConnectionIcon);
  ...
  return omi_module._createClass(MapConnectionIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-map-connection")], exports['default']);
