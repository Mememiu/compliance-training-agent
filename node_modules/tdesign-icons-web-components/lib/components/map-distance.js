...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(MapDistanceIcon, _IconBase);
  var _super = _createSuper(MapDistanceIcon);
  function MapDistanceIcon() {
    var _this;
    omi_module._classCallCheck(this, MapDistanceIcon);
  ...
  return omi_module._createClass(MapDistanceIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-map-distance")], exports['default']);
