...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(MapInformation1Icon, _IconBase);
  var _super = _createSuper(MapInformation1Icon);
  function MapInformation1Icon() {
    var _this;
    omi_module._classCallCheck(this, MapInformation1Icon);
  ...
  return omi_module._createClass(MapInformation1Icon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-map-information-1")], exports['default']);
