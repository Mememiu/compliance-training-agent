...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(MapInformationFilledIcon, _IconBase);
  var _super = _createSuper(MapInformationFilledIcon);
  function MapInformationFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, MapInformationFilledIcon);
  ...
  return omi_module._createClass(MapInformationFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-map-information-filled")], exports['default']);
