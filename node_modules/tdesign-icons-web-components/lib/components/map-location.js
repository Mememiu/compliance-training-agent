...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(MapLocationIcon, _IconBase);
  var _super = _createSuper(MapLocationIcon);
  function MapLocationIcon() {
    var _this;
    omi_module._classCallCheck(this, MapLocationIcon);
  ...
  return omi_module._createClass(MapLocationIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-map-location")], exports['default']);
