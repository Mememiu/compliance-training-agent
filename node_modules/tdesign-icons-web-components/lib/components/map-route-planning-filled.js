...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(MapRoutePlanningFilledIcon, _IconBase);
  var _super = _createSuper(MapRoutePlanningFilledIcon);
  function MapRoutePlanningFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, MapRoutePlanningFilledIcon);
  ...
  return omi_module._createClass(MapRoutePlanningFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-map-route-planning-filled")], exports['default']);
