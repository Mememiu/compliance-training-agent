...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(MapRoutePlanningIcon, _IconBase);
  var _super = _createSuper(MapRoutePlanningIcon);
  function MapRoutePlanningIcon() {
    var _this;
    omi_module._classCallCheck(this, MapRoutePlanningIcon);
  ...
  return omi_module._createClass(MapRoutePlanningIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-map-route-planning")], exports['default']);
