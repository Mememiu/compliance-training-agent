...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(MeatPepperFilledIcon, _IconBase);
  var _super = _createSuper(MeatPepperFilledIcon);
  function MeatPepperFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, MeatPepperFilledIcon);
  ...
  return omi_module._createClass(MeatPepperFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-meat-pepper-filled")], exports['default']);
