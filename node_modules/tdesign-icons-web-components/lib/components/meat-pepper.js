...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(MeatPepperIcon, _IconBase);
  var _super = _createSuper(MeatPepperIcon);
  function MeatPepperIcon() {
    var _this;
    omi_module._classCallCheck(this, MeatPepperIcon);
  ...
  return omi_module._createClass(MeatPepperIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-meat-pepper")], exports['default']);
