...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(MoonFallIcon, _IconBase);
  var _super = _createSuper(MoonFallIcon);
  function MoonFallIcon() {
    var _this;
    omi_module._classCallCheck(this, MoonFallIcon);
  ...
  return omi_module._createClass(MoonFallIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-moon-fall")], exports['default']);
