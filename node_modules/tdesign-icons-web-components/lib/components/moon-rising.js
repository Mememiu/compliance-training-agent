...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(MoonRisingIcon, _IconBase);
  var _super = _createSuper(MoonRisingIcon);
  function MoonRisingIcon() {
    var _this;
    omi_module._classCallCheck(this, MoonRisingIcon);
  ...
  return omi_module._createClass(MoonRisingIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-moon-rising")], exports['default']);
