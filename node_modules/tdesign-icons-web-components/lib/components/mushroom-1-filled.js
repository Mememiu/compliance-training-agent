...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Mushroom1FilledIcon, _IconBase);
  var _super = _createSuper(Mushroom1FilledIcon);
  function Mushroom1FilledIcon() {
    var _this;
    omi_module._classCallCheck(this, Mushroom1FilledIcon);
  ...
  return omi_module._createClass(Mushroom1FilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-mushroom-1-filled")], exports['default']);
