...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(MushroomFilledIcon, _IconBase);
  var _super = _createSuper(MushroomFilledIcon);
  function MushroomFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, MushroomFilledIcon);
  ...
  return omi_module._createClass(MushroomFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-mushroom-filled")], exports['default']);
