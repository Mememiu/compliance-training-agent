...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(MushroomIcon, _IconBase);
  var _super = _createSuper(MushroomIcon);
  function MushroomIcon() {
    var _this;
    omi_module._classCallCheck(this, MushroomIcon);
  ...
  return omi_module._createClass(MushroomIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-mushroom")], exports['default']);
