...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(NutIcon, _IconBase);
  var _super = _createSuper(NutIcon);
  function NutIcon() {
    var _this;
    omi_module._classCallCheck(this, NutIcon);
  ...
  return omi_module._createClass(NutIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-nut")], exports['default']);
