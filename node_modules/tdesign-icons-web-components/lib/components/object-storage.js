...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ObjectStorageIcon, _IconBase);
  var _super = _createSuper(ObjectStorageIcon);
  function ObjectStorageIcon() {
    var _this;
    omi_module._classCallCheck(this, ObjectStorageIcon);
  ...
  return omi_module._createClass(ObjectStorageIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-object-storage")], exports['default']);
