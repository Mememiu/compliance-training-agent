...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(OperaFilledIcon, _IconBase);
  var _super = _createSuper(OperaFilledIcon);
  function OperaFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, OperaFilledIcon);
  ...
  return omi_module._createClass(OperaFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-opera-filled")], exports['default']);
