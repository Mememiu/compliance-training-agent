...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(OperaIcon, _IconBase);
  var _super = _createSuper(OperaIcon);
  function OperaIcon() {
    var _this;
    omi_module._classCallCheck(this, OperaIcon);
  ...
  return omi_module._createClass(OperaIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-opera")], exports['default']);
