...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(PaletteIcon, _IconBase);
  var _super = _createSuper(PaletteIcon);
  function PaletteIcon() {
    var _this;
    omi_module._classCallCheck(this, PaletteIcon);
  ...
  return omi_module._createClass(PaletteIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-palette")], exports['default']);
