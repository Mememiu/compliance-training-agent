...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(PanoramaHorizontalFilledIcon, _IconBase);
  var _super = _createSuper(PanoramaHorizontalFilledIcon);
  function PanoramaHorizontalFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, PanoramaHorizontalFilledIcon);
  ...
  return omi_module._createClass(PanoramaHorizontalFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-panorama-horizontal-filled")], exports['default']);
