...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(PanoramaHorizontalIcon, _IconBase);
  var _super = _createSuper(PanoramaHorizontalIcon);
  function PanoramaHorizontalIcon() {
    var _this;
    omi_module._classCallCheck(this, PanoramaHorizontalIcon);
  ...
  return omi_module._createClass(PanoramaHorizontalIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-panorama-horizontal")], exports['default']);
