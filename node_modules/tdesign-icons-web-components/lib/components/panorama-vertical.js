...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(PanoramaVerticalIcon, _IconBase);
  var _super = _createSuper(PanoramaVerticalIcon);
  function PanoramaVerticalIcon() {
    var _this;
    omi_module._classCallCheck(this, PanoramaVerticalIcon);
  ...
  return omi_module._createClass(PanoramaVerticalIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-panorama-vertical")], exports['default']);
