...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ParabolaIcon, _IconBase);
  var _super = _createSuper(ParabolaIcon);
  function ParabolaIcon() {
    var _this;
    omi_module._classCallCheck(this, ParabolaIcon);
  ...
  return omi_module._createClass(ParabolaIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-parabola")], exports['default']);
