...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(PeaFilledIcon, _IconBase);
  var _super = _createSuper(PeaFilledIcon);
  function PeaFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, PeaFilledIcon);
  ...
  return omi_module._createClass(PeaFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-pea-filled")], exports['default']);
