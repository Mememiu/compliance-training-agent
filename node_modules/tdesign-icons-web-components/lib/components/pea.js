...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(PeaIcon, _IconBase);
  var _super = _createSuper(PeaIcon);
  function PeaIcon() {
    var _this;
    omi_module._classCallCheck(this, PeaIcon);
  ...
  return omi_module._createClass(PeaIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-pea")], exports['default']);
