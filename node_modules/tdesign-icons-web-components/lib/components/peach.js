...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(PeachIcon, _IconBase);
  var _super = _createSuper(PeachIcon);
  function PeachIcon() {
    var _this;
    omi_module._classCallCheck(this, PeachIcon);
  ...
  return omi_module._createClass(PeachIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-peach")], exports['default']);
