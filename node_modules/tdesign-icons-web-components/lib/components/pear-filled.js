...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(PearFilledIcon, _IconBase);
  var _super = _createSuper(PearFilledIcon);
  function PearFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, PearFilledIcon);
  ...
  return omi_module._createClass(PearFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-pear-filled")], exports['default']);
