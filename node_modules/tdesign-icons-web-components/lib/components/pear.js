...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(PearIcon, _IconBase);
  var _super = _createSuper(PearIcon);
  function PearIcon() {
    var _this;
    omi_module._classCallCheck(this, PearIcon);
  ...
  return omi_module._createClass(PearIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-pear")], exports['default']);
