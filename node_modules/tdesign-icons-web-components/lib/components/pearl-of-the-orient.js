...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(PearlOfTheOrientIcon, _IconBase);
  var _super = _createSuper(PearlOfTheOrientIcon);
  function PearlOfTheOrientIcon() {
    var _this;
    omi_module._classCallCheck(this, PearlOfTheOrientIcon);
  ...
  return omi_module._createClass(PearlOfTheOrientIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-pearl-of-the-orient")], exports['default']);
