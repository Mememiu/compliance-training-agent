...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(PiIcon, _IconBase);
  var _super = _createSuper(PiIcon);
  function PiIcon() {
    var _this;
    omi_module._classCallCheck(this, PiIcon);
  ...
  return omi_module._createClass(PiIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-pi")], exports['default']);
