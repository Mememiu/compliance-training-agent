...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(PopsicleIcon, _IconBase);
  var _super = _createSuper(PopsicleIcon);
  function PopsicleIcon() {
    var _this;
    omi_module._classCallCheck(this, PopsicleIcon);
  ...
  return omi_module._createClass(PopsicleIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-popsicle")], exports['default']);
