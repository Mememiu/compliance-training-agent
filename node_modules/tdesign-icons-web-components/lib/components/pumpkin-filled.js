...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(PumpkinFilledIcon, _IconBase);
  var _super = _createSuper(PumpkinFilledIcon);
  function PumpkinFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, PumpkinFilledIcon);
  ...
  return omi_module._createClass(PumpkinFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-pumpkin-filled")], exports['default']);
