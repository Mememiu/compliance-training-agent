...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(PumpkinIcon, _IconBase);
  var _super = _createSuper(PumpkinIcon);
  function PumpkinIcon() {
    var _this;
    omi_module._classCallCheck(this, PumpkinIcon);
  ...
  return omi_module._createClass(PumpkinIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-pumpkin")], exports['default']);
