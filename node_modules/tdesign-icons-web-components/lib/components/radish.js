...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(RadishIcon, _IconBase);
  var _super = _createSuper(RadishIcon);
  function RadishIcon() {
    var _this;
    omi_module._classCallCheck(this, RadishIcon);
  ...
  return omi_module._createClass(RadishIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-radish")], exports['default']);
