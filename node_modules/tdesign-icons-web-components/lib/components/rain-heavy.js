...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(RainHeavyIcon, _IconBase);
  var _super = _createSuper(RainHeavyIcon);
  function RainHeavyIcon() {
    var _this;
    omi_module._classCallCheck(this, RainHeavyIcon);
  ...
  return omi_module._createClass(RainHeavyIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-rain-heavy")], exports['default']);
