...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(RainLightIcon, _IconBase);
  var _super = _createSuper(RainLightIcon);
  function RainLightIcon() {
    var _this;
    omi_module._classCallCheck(this, RainLightIcon);
  ...
  return omi_module._createClass(RainLightIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-rain-light")], exports['default']);
