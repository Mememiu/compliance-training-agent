...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(RiceBallIcon, _IconBase);
  var _super = _createSuper(RiceBallIcon);
  function RiceBallIcon() {
    var _this;
    omi_module._classCallCheck(this, RiceBallIcon);
  ...
  return omi_module._createClass(RiceBallIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-rice-ball")], exports['default']);
