...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(SavingPotFilledIcon, _IconBase);
  var _super = _createSuper(SavingPotFilledIcon);
  function SavingPotFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, SavingPotFilledIcon);
  ...
  return omi_module._createClass(SavingPotFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-saving-pot-filled")], exports['default']);
