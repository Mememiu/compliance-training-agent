...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(SavingPotIcon, _IconBase);
  var _super = _createSuper(SavingPotIcon);
  function SavingPotIcon() {
    var _this;
    omi_module._classCallCheck(this, SavingPotIcon);
  ...
  return omi_module._createClass(SavingPotIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-saving-pot")], exports['default']);
