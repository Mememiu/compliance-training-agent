...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ScreenshotIcon, _IconBase);
  var _super = _createSuper(ScreenshotIcon);
  function ScreenshotIcon() {
    var _this;
    omi_module._classCallCheck(this, ScreenshotIcon);
  ...
  return omi_module._createClass(ScreenshotIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-screenshot")], exports['default']);
