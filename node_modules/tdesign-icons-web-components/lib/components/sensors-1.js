...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Sensors1Icon, _IconBase);
  var _super = _createSuper(Sensors1Icon);
  function Sensors1Icon() {
    var _this;
    omi_module._classCallCheck(this, Sensors1Icon);
  ...
  return omi_module._createClass(Sensors1Icon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-sensors-1")], exports['default']);
