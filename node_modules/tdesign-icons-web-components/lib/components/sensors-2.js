...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Sensors2Icon, _IconBase);
  var _super = _createSuper(Sensors2Icon);
  function Sensors2Icon() {
    var _this;
    omi_module._classCallCheck(this, Sensors2Icon);
  ...
  return omi_module._createClass(Sensors2Icon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-sensors-2")], exports['default']);
