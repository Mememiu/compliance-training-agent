...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(SensorsIcon, _IconBase);
  var _super = _createSuper(SensorsIcon);
  function SensorsIcon() {
    var _this;
    omi_module._classCallCheck(this, SensorsIcon);
  ...
  return omi_module._createClass(SensorsIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-sensors")], exports['default']);
