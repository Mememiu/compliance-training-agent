...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Setting1Icon, _IconBase);
  var _super = _createSuper(Setting1Icon);
  function Setting1Icon() {
    var _this;
    omi_module._classCallCheck(this, Setting1Icon);
  ...
  return omi_module._createClass(Setting1Icon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-setting-1")], exports['default']);
