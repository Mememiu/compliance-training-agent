...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ShareIcon, _IconBase);
  var _super = _createSuper(ShareIcon);
  function ShareIcon() {
    var _this;
    omi_module._classCallCheck(this, ShareIcon);
  ...
  return omi_module._createClass(ShareIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-share")], exports['default']);
