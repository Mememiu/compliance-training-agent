...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ShieldErrorIcon, _IconBase);
  var _super = _createSuper(ShieldErrorIcon);
  function ShieldErrorIcon() {
    var _this;
    omi_module._classCallCheck(this, ShieldErrorIcon);
  ...
  return omi_module._createClass(ShieldErrorIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-shield-error")], exports['default']);
