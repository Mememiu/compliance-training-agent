...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Shop2FilledIcon, _IconBase);
  var _super = _createSuper(Shop2FilledIcon);
  function Shop2FilledIcon() {
    var _this;
    omi_module._classCallCheck(this, Shop2FilledIcon);
  ...
  return omi_module._createClass(Shop2FilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-shop-2-filled")], exports['default']);
