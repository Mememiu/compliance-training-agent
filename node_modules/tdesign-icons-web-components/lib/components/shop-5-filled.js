...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Shop5FilledIcon, _IconBase);
  var _super = _createSuper(Shop5FilledIcon);
  function Shop5FilledIcon() {
    var _this;
    omi_module._classCallCheck(this, Shop5FilledIcon);
  ...
  return omi_module._createClass(Shop5FilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-shop-5-filled")], exports['default']);
