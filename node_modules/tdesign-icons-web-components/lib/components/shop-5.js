...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Shop5Icon, _IconBase);
  var _super = _createSuper(Shop5Icon);
  function Shop5Icon() {
    var _this;
    omi_module._classCallCheck(this, Shop5Icon);
  ...
  return omi_module._createClass(Shop5Icon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-shop-5")], exports['default']);
