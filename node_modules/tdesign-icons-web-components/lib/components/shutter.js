...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ShutterIcon, _IconBase);
  var _super = _createSuper(ShutterIcon);
  function ShutterIcon() {
    var _this;
    omi_module._classCallCheck(this, ShutterIcon);
  ...
  return omi_module._createClass(ShutterIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-shutter")], exports['default']);
