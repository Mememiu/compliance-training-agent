...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(SitemapFilledIcon, _IconBase);
  var _super = _createSuper(SitemapFilledIcon);
  function SitemapFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, SitemapFilledIcon);
  ...
  return omi_module._createClass(SitemapFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-sitemap-filled")], exports['default']);
