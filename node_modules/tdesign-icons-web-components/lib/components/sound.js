...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(SoundIcon, _IconBase);
  var _super = _createSuper(SoundIcon);
  function SoundIcon() {
    var _this;
    omi_module._classCallCheck(this, SoundIcon);
  ...
  return omi_module._createClass(SoundIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-sound")], exports['default']);
