...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(SupportIcon, _IconBase);
  var _super = _createSuper(SupportIcon);
  function SupportIcon() {
    var _this;
    omi_module._classCallCheck(this, SupportIcon);
  ...
  return omi_module._createClass(SupportIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-support")], exports['default']);
