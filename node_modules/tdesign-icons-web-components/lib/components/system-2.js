...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(System2Icon, _IconBase);
  var _super = _createSuper(System2Icon);
  function System2Icon() {
    var _this;
    omi_module._classCallCheck(this, System2Icon);
  ...
  return omi_module._createClass(System2Icon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-system-2")], exports['default']);
