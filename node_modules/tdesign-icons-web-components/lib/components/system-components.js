...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(SystemComponentsIcon, _IconBase);
  var _super = _createSuper(SystemComponentsIcon);
  function SystemComponentsIcon() {
    var _this;
    omi_module._classCallCheck(this, SystemComponentsIcon);
  ...
  return omi_module._createClass(SystemComponentsIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-system-components")], exports['default']);
