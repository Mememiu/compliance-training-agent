...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(SystemLocationIcon, _IconBase);
  var _super = _createSuper(SystemLocationIcon);
  function SystemLocationIcon() {
    var _this;
    omi_module._classCallCheck(this, SystemLocationIcon);
  ...
  return omi_module._createClass(SystemLocationIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-system-location")], exports['default']);
