...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(SystemSettingIcon, _IconBase);
  var _super = _createSuper(SystemSettingIcon);
  function SystemSettingIcon() {
    var _this;
    omi_module._classCallCheck(this, SystemSettingIcon);
  ...
  return omi_module._createClass(SystemSettingIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-system-setting")], exports['default']);
