...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(SystemSumIcon, _IconBase);
  var _super = _createSuper(SystemSumIcon);
  function SystemSumIcon() {
    var _this;
    omi_module._classCallCheck(this, SystemSumIcon);
  ...
  return omi_module._createClass(SystemSumIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-system-sum")], exports['default']);
