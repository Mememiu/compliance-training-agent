...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(TaskSettingIcon, _IconBase);
  var _super = _createSuper(TaskSettingIcon);
  function TaskSettingIcon() {
    var _this;
    omi_module._classCallCheck(this, TaskSettingIcon);
  ...
  return omi_module._createClass(TaskSettingIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-task-setting")], exports['default']);
