...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(TextformatStrikethroughIcon, _IconBase);
  var _super = _createSuper(TextformatStrikethroughIcon);
  function TextformatStrikethroughIcon() {
    var _this;
    omi_module._classCallCheck(this, TextformatStrikethroughIcon);
  ...
  return omi_module._createClass(TextformatStrikethroughIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-textformat-strikethrough")], exports['default']);
