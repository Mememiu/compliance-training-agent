...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ThunderIcon, _IconBase);
  var _super = _createSuper(ThunderIcon);
  function ThunderIcon() {
    var _this;
    omi_module._classCallCheck(this, ThunderIcon);
  ...
  return omi_module._createClass(ThunderIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-thunder")], exports['default']);
