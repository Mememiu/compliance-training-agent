...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ThunderstormNightFilledIcon, _IconBase);
  var _super = _createSuper(ThunderstormNightFilledIcon);
  function ThunderstormNightFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, ThunderstormNightFilledIcon);
  ...
  return omi_module._createClass(ThunderstormNightFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-thunderstorm-night-filled")], exports['default']);
