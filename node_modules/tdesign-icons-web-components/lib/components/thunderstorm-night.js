...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ThunderstormNightIcon, _IconBase);
  var _super = _createSuper(ThunderstormNightIcon);
  function ThunderstormNightIcon() {
    var _this;
    omi_module._classCallCheck(this, ThunderstormNightIcon);
  ...
  return omi_module._createClass(ThunderstormNightIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-thunderstorm-night")], exports['default']);
