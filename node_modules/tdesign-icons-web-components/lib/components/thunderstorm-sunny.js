...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ThunderstormSunnyIcon, _IconBase);
  var _super = _createSuper(ThunderstormSunnyIcon);
  function ThunderstormSunnyIcon() {
    var _this;
    omi_module._classCallCheck(this, ThunderstormSunnyIcon);
  ...
  return omi_module._createClass(ThunderstormSunnyIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-thunderstorm-sunny")], exports['default']);
