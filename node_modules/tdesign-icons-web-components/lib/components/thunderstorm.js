...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ThunderstormIcon, _IconBase);
  var _super = _createSuper(ThunderstormIcon);
  function ThunderstormIcon() {
    var _this;
    omi_module._classCallCheck(this, ThunderstormIcon);
  ...
  return omi_module._createClass(ThunderstormIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-thunderstorm")], exports['default']);
