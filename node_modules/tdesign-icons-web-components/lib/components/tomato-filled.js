...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(TomatoFilledIcon, _IconBase);
  var _super = _createSuper(TomatoFilledIcon);
  function TomatoFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, TomatoFilledIcon);
  ...
  return omi_module._createClass(TomatoFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-tomato-filled")], exports['default']);
