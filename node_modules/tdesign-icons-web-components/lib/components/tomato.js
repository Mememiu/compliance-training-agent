...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(TomatoIcon, _IconBase);
  var _super = _createSuper(TomatoIcon);
  function TomatoIcon() {
    var _this;
    omi_module._classCallCheck(this, TomatoIcon);
  ...
  return omi_module._createClass(TomatoIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-tomato")], exports['default']);
