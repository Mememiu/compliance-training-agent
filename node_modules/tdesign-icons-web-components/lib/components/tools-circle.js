...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(ToolsCircleIcon, _IconBase);
  var _super = _createSuper(ToolsCircleIcon);
  function ToolsCircleIcon() {
    var _this;
    omi_module._classCallCheck(this, ToolsCircleIcon);
  ...
  return omi_module._createClass(ToolsCircleIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-tools-circle")], exports['default']);
