...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Tower1FilledIcon, _IconBase);
  var _super = _createSuper(Tower1FilledIcon);
  function Tower1FilledIcon() {
    var _this;
    omi_module._classCallCheck(this, Tower1FilledIcon);
  ...
  return omi_module._createClass(Tower1FilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-tower-1-filled")], exports['default']);
