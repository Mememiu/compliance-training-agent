...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Tower1Icon, _IconBase);
  var _super = _createSuper(Tower1Icon);
  function Tower1Icon() {
    var _this;
    omi_module._classCallCheck(this, Tower1Icon);
  ...
  return omi_module._createClass(Tower1Icon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-tower-1")], exports['default']);
