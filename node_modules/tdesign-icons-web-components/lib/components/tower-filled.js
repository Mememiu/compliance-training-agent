...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(TowerFilledIcon, _IconBase);
  var _super = _createSuper(TowerFilledIcon);
  function TowerFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, TowerFilledIcon);
  ...
  return omi_module._createClass(TowerFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-tower-filled")], exports['default']);
