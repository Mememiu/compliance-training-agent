...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(TowerIcon, _IconBase);
  var _super = _createSuper(TowerIcon);
  function TowerIcon() {
    var _this;
    omi_module._classCallCheck(this, TowerIcon);
  ...
  return omi_module._createClass(TowerIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-tower")], exports['default']);
