...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(TransformIcon, _IconBase);
  var _super = _createSuper(TransformIcon);
  function TransformIcon() {
    var _this;
    omi_module._classCallCheck(this, TransformIcon);
  ...
  return omi_module._createClass(TransformIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-transform")], exports['default']);
