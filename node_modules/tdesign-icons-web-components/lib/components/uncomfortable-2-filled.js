...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Uncomfortable2FilledIcon, _IconBase);
  var _super = _createSuper(Uncomfortable2FilledIcon);
  function Uncomfortable2FilledIcon() {
    var _this;
    omi_module._classCallCheck(this, Uncomfortable2FilledIcon);
  ...
  return omi_module._createClass(Uncomfortable2FilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-uncomfortable-2-filled")], exports['default']);
