...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(UncomfortableIcon, _IconBase);
  var _super = _createSuper(UncomfortableIcon);
  function UncomfortableIcon() {
    var _this;
    omi_module._classCallCheck(this, UncomfortableIcon);
  ...
  return omi_module._createClass(UncomfortableIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-uncomfortable")], exports['default']);
