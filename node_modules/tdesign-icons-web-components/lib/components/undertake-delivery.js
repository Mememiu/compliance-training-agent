...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(UndertakeDeliveryIcon, _IconBase);
  var _super = _createSuper(UndertakeDeliveryIcon);
  function UndertakeDeliveryIcon() {
    var _this;
    omi_module._classCallCheck(this, UndertakeDeliveryIcon);
  ...
  return omi_module._createClass(UndertakeDeliveryIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-undertake-delivery")], exports['default']);
