...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(UndertakeEnvironmentProtectionFilledIcon, _IconBase);
  var _super = _createSuper(UndertakeEnvironmentProtectionFilledIcon);
  function UndertakeEnvironmentProtectionFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, UndertakeEnvironmentProtectionFilledIcon);
  ...
  return omi_module._createClass(UndertakeEnvironmentProtectionFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-undertake-environment-protection-filled")], exports['default']);
