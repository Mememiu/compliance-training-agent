...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(UndertakeFilledIcon, _IconBase);
  var _super = _createSuper(UndertakeFilledIcon);
  function UndertakeFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, UndertakeFilledIcon);
  ...
  return omi_module._createClass(UndertakeFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-undertake-filled")], exports['default']);
