...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(UndertakeHoldUpFilledIcon, _IconBase);
  var _super = _createSuper(UndertakeHoldUpFilledIcon);
  function UndertakeHoldUpFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, UndertakeHoldUpFilledIcon);
  ...
  return omi_module._createClass(UndertakeHoldUpFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-undertake-hold-up-filled")], exports['default']);
