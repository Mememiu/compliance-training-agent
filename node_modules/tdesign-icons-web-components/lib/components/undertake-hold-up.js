...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(UndertakeHoldUpIcon, _IconBase);
  var _super = _createSuper(UndertakeHoldUpIcon);
  function UndertakeHoldUpIcon() {
    var _this;
    omi_module._classCallCheck(this, UndertakeHoldUpIcon);
  ...
  return omi_module._createClass(UndertakeHoldUpIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-undertake-hold-up")], exports['default']);
