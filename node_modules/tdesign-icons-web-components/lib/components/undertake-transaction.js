...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(UndertakeTransactionIcon, _IconBase);
  var _super = _createSuper(UndertakeTransactionIcon);
  function UndertakeTransactionIcon() {
    var _this;
    omi_module._classCallCheck(this, UndertakeTransactionIcon);
  ...
  return omi_module._createClass(UndertakeTransactionIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-undertake-transaction")], exports['default']);
