...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(UndertakeIcon, _IconBase);
  var _super = _createSuper(UndertakeIcon);
  function UndertakeIcon() {
    var _this;
    omi_module._classCallCheck(this, UndertakeIcon);
  ...
  return omi_module._createClass(UndertakeIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-undertake")], exports['default']);
