...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(UserCircleIcon, _IconBase);
  var _super = _createSuper(UserCircleIcon);
  function UserCircleIcon() {
    var _this;
    omi_module._classCallCheck(this, UserCircleIcon);
  ...
  return omi_module._createClass(UserCircleIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-user-circle")], exports['default']);
