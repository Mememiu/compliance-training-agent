...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(UserTalk1FilledIcon, _IconBase);
  var _super = _createSuper(UserTalk1FilledIcon);
  function UserTalk1FilledIcon() {
    var _this;
    omi_module._classCallCheck(this, UserTalk1FilledIcon);
  ...
  return omi_module._createClass(UserTalk1FilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-user-talk-1-filled")], exports['default']);
