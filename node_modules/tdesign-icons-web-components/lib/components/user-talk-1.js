...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(UserTalk1Icon, _IconBase);
  var _super = _createSuper(UserTalk1Icon);
  function UserTalk1Icon() {
    var _this;
    omi_module._classCallCheck(this, UserTalk1Icon);
  ...
  return omi_module._createClass(UserTalk1Icon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-user-talk-1")], exports['default']);
