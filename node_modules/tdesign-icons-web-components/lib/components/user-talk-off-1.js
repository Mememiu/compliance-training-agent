...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(UserTalkOff1Icon, _IconBase);
  var _super = _createSuper(UserTalkOff1Icon);
  function UserTalkOff1Icon() {
    var _this;
    omi_module._classCallCheck(this, UserTalkOff1Icon);
  ...
  return omi_module._createClass(UserTalkOff1Icon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-user-talk-off-1")], exports['default']);
