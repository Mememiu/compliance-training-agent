...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(UsercaseFilledIcon, _IconBase);
  var _super = _createSuper(UsercaseFilledIcon);
  function UsercaseFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, UsercaseFilledIcon);
  ...
  return omi_module._createClass(UsercaseFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-usercase-filled")], exports['default']);
