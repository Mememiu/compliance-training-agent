...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(UsercaseIcon, _IconBase);
  var _super = _createSuper(UsercaseIcon);
  function UsercaseIcon() {
    var _this;
    omi_module._classCallCheck(this, UsercaseIcon);
  ...
  return omi_module._createClass(UsercaseIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-usercase")], exports['default']);
