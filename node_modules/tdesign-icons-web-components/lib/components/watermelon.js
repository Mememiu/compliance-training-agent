...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(WatermelonIcon, _IconBase);
  var _super = _createSuper(WatermelonIcon);
  function WatermelonIcon() {
    var _this;
    omi_module._classCallCheck(this, WatermelonIcon);
  ...
  return omi_module._createClass(WatermelonIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-watermelon")], exports['default']);
