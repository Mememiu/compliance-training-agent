...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(WaveLeftFilledIcon, _IconBase);
  var _super = _createSuper(WaveLeftFilledIcon);
  function WaveLeftFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, WaveLeftFilledIcon);
  ...
  return omi_module._createClass(WaveLeftFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-wave-left-filled")], exports['default']);
