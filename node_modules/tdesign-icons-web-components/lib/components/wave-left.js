...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(WaveLeftIcon, _IconBase);
  var _super = _createSuper(WaveLeftIcon);
  function WaveLeftIcon() {
    var _this;
    omi_module._classCallCheck(this, WaveLeftIcon);
  ...
  return omi_module._createClass(WaveLeftIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-wave-left")], exports['default']);
