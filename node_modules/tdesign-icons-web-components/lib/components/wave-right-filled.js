...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(WaveRightFilledIcon, _IconBase);
  var _super = _createSuper(WaveRightFilledIcon);
  function WaveRightFilledIcon() {
    var _this;
    omi_module._classCallCheck(this, WaveRightFilledIcon);
  ...
  return omi_module._createClass(WaveRightFilledIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-wave-right-filled")], exports['default']);
