...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(WaveRightIcon, _IconBase);
  var _super = _createSuper(WaveRightIcon);
  function WaveRightIcon() {
    var _this;
    omi_module._classCallCheck(this, WaveRightIcon);
  ...
  return omi_module._createClass(WaveRightIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-wave-right")], exports['default']);
