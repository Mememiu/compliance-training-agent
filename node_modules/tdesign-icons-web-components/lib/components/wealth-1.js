...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(Wealth1Icon, _IconBase);
  var _super = _createSuper(Wealth1Icon);
  function Wealth1Icon() {
    var _this;
    omi_module._classCallCheck(this, Wealth1Icon);
  ...
  return omi_module._createClass(Wealth1Icon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-wealth-1")], exports['default']);
