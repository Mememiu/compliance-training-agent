...
exports['default'] = (_class = /*#__PURE__*/function (_IconBase) {
  omi_module._inherits(WifiOffIcon, _IconBase);
  var _super = _createSuper(WifiOffIcon);
  function WifiOffIcon() {
    var _this;
    omi_module._classCallCheck(this, WifiOffIcon);
  ...
  return omi_module._createClass(WifiOffIcon);
}(icon.IconBase), omi_module._defineProperty(_class, "icon", element), _class);
exports['default'] = __decorateClass([omi_module.Q("t-icon-wifi-off")], exports['default']);
