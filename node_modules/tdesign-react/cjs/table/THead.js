...
var _typeof = require('../_chunks/dep-7a62e6e1.js');
...
function THead(props) {
  ...
  var theadClasses = [tableHeaderClasses.header, defineProperty._defineProperty(defineProperty._defineProperty(defineProperty._defineProperty({}, tableHeaderClasses.fixed, Boolean(props.maxHeight || props.height)), tableBaseClass.bordered, props.bordered && props.isMultipleHeader), tableHeaderClasses.multipleHeader, props.isMultipleHeader)];
  ...
  var renderThNodeList = function renderThNodeList(rowAndColFixedPosition, thWidthList) {
    ...
    return props.thList.map(function (row, rowIndex) {
      var thRow = row.map(function (col, index) {
        ...
        var thStyles = table_hooks_useFixed.getColumnFixedStyles(col, index, rowAndColFixedPosition, classnames.tableColFixedClasses);
        var colParams = {
          col: col,
          colIndex: index,
          row: {},
        ...
        var thCustomClasses = table_utils.formatClassNames(col.thClassName, colParams);
        var thClasses = [thStyles.classes, customClasses, thCustomClasses, defineProperty._defineProperty(defineProperty._defineProperty(defineProperty._defineProperty(defineProperty._defineProperty({}, tableHeaderClasses.thBordered, thBorderMap.get(col)), "".concat(classPrefix, "-table__th-").concat(col.colKey), col.colKey), classnames.tdAlignClasses[col.align], col.align && col.align !== "left"), classnames.tableDraggableClasses.dragSortTh, canDragSort)];
        ...
        var innerTh = table_hooks_useTableHeader.renderTitle(col, index);
        ...
        var content = isFunction.isFunction(col.ellipsisTitle) ? col.ellipsisTitle({
          col: col,
          colIndex: index
        }) : void 0;
        ...
        return /* @__PURE__ */React__default["default"].createElement("th", _objectSpread(_objectSpread(_objectSpread({
          key: col.colKey,
          "data-colkey": col.colKey,
          className: classNames__default["default"](thClasses),
          style: styles
        }, {
        ...
        }, isEllipsis ? /* @__PURE__ */React__default["default"].createElement(table_Ellipsis["default"], {
          placement: "bottom",
          attach: theadRef.current ? function () {
            return getTableNode(theadRef.current);
          } : void 0,
          popupContent: content,
          tooltipProps: _typeof._typeof(col.ellipsisTitle) === "object" ? col.ellipsisTitle : void 0,
  ...
  return /* @__PURE__ */React__default["default"].createElement("thead", {
    ref: theadRef,
    className: classNames__default["default"](theadClasses)
