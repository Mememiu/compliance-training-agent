...
function getExposedProps(node) {
  var props = lodashEs.pick(node, ["value", "label", "data", "actived", "expanded", "checked", "indeterminate", "loading"]);
  return props;
}
function createNodeModel(node) {
  ...
  var model = _objectSpread(_objectSpread({}, props), {}, {
    ...
    setData: function setData(data) {
      var _data = lodashEs.omit(data, ["children", "value", "label"]);
      ...
      if (!lodashEs.isUndefined(dataValue)) _data.value = dataValue;
      if (!lodashEs.isUndefined(dataLabel)) _data.label = dataLabel;
