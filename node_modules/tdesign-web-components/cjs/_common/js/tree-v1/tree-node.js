...
var TreeNode = /*#__PURE__*/function () {
  ...
  function TreeNode(tree, data, parent) {
    ...
    this.draggable = null;
    this[privateKey] = lodashEs.uniqueId(prefix);
    this.value = lodashEs.isNil(lodashEs.get(data, propValue)) ? this[privateKey] : lodashEs.get(data, propValue);
    ...
    this.label = lodashEs.get(data, propLabel) || "";
    this.disabled = lodashEs.get(data, propsDisabled);
  ...
  return createClass._createClass(TreeNode, [{
    ...
    value: function initExpanded() {
      ...
      var config = tree.config;
      if (lodashEs.isNumber(config.expandLevel) && this.getLevel() < config.expandLevel) {
    ...
    key: "loadChildren",
    value: (function () {
      var _loadChildren = index._asyncToGenerator( /*#__PURE__*/index._regeneratorRuntime.mark(function _callee() {
        var config, list;
        return index._regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              config = lodashEs.get(this, "tree.config") || {};
              if (!(this.children === true && !this.loading)) {
                _context.next = 13;
                break;
              }
              if (!("load" in config && lodashEs.isFunction(config.load))) {
                _context.next = 13;
                break;
              }
              this.loading = true;
    ...
    value: function isDraggable() {
      var state = !!lodashEs.get(this, "tree.config.draggable");
    ...
    value: function isExpandMutex() {
      var state = !!lodashEs.get(this, "tree.config.expandMutex");
    ...
    value: function isActivable() {
      var state = !!lodashEs.get(this, "tree.config.activable");
    ...
    value: function isCheckable() {
      var state = !!lodashEs.get(this, "tree.config.checkable");
    ...
    value: function isChecked(map) {
      ...
      valueMode !== "onlyLeaf" || this.isLeaf())) {
        return true;
      }
    ...
    value: function isIndeterminate() {
      ...
      var indeterminate = children.some(function (node) {
        ...
        if (lodashEs.isNull(childChecked)) {
