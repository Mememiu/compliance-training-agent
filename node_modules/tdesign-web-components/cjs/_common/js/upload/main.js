...
var unsupportedIterableToArray = require('../../../_chunks/dep-f27d91b2.js');
...
function _toArray(r) {
  return slicedToArray._arrayWithHoles(r) || toConsumableArray._iterableToArray(r) || unsupportedIterableToArray._unsupportedIterableToArray(r) || slicedToArray._nonIterableRest();
}
...
function handleBeforeUpload(file, params) {
  ...
  var sizePromise = new Promise(function (resolve) {
    var result = null;
    if (sizeLimit) {
      var sizeLimitObj = lodashEs.isNumber(sizeLimit) ? {
        size: sizeLimit,
        unit: "KB"
      } : sizeLimit;
  ...
  if (lodashEs.isFunction(beforeUpload)) {
...
function handleError(options) {
  ...
  var res = response;
  if (lodashEs.isFunction(formatResponse)) {
  ...
  return new Promise(function (resolve) {
    ...
    if (requestMethod) {
      requestMethod(params.multiple ? toUploadFiles : toUploadFiles[0]).then(function (res) {
        ...
        if (lodashEs.isFunction(params.formatResponse)) {
