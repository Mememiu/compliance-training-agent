...
var ReactiveState = /*#__PURE__*/function () {
  function ReactiveState() {
    createClass._classCallCheck(this, ReactiveState);
    // 当前状态（始终为冻结对象）
    defineProperty._defineProperty(this, "subscribers", /* @__PURE__ */new Set());
    // 订阅者集合（包含路径过滤条件）
    defineProperty._defineProperty(this, "pendingChanges", []);
    // 待处理的变更路径（自动去重）
    defineProperty._defineProperty(this, "notificationScheduled", false);
    // 通知调度锁（防止重复调度）
    defineProperty._defineProperty(this, "pathSubscribers", /* @__PURE__ */new Map());
  }
  return createClass._createClass(ReactiveState, [{
    key: "initialize",
    value:
    // 增加订阅者分组缓存
    /**
    ...
    value: function setState(updater, paths) {
      var _produceWithPatches = immer.produceWithPatches(this.currentState, updater),
        _produceWithPatches2 = slicedToArray._slicedToArray(_produceWithPatches, 2),
      ...
      if (changes.length > 0) {
        ...
        (_this$pendingChanges = this.pendingChanges).push.apply(_this$pendingChanges, toConsumableArray._toConsumableArray(changes));
    ...
    value: function scheduleNotification() {
      ...
      queueMicrotask(function () {
        var changedPaths = toConsumableArray._toConsumableArray(new Set(_this2.pendingChanges));
