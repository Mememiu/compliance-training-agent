...
import type { AIMessageContent, ChatContentType, ChatMessagesData, ChatMessageSetterMode, ChatRequestParams, ChatServiceConfigSetter, ChatStatus } from './core/type';
...
export interface TdChatMessageProps {
     ...
     * 操作
     */
    actions?: TdChatMessageActionName[] | boolean;
